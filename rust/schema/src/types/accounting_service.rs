...
/// * COMMENT: Accountancy business.<br/><br/>  As a <a class="localLink" href="/LocalBusiness">LocalBusiness</a> it can be described as a <a class="localLink" href="/provider">provider</a> of one or more <a class="localLink" href="/Service">Service</a>(s). * EXTEND FROM: https://schema.org/FinancialService
...
pub struct AccountingService {
    ...
    #[serde(flatten)]
    pub options: Box<AccountingServiceOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AccountingServiceOptions {
