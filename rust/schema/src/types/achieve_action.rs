...
/// * COMMENT: The act of accomplishing something via previous efforts. It is an instantaneous action rather than an ongoing process. * EXTEND FROM: https://schema.org/Action * LOOK ALSO: https://schema.org/LoseAction, https://schema.org/TieAction, https://schema.org/WinAction
...
pub struct AchieveAction {
    ...
    #[serde(flatten)]
    pub options: Box<AchieveActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AchieveActionOptions {
