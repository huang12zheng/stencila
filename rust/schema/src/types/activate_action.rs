...
/// * COMMENT: The act of starting or activating a device or application (e.g. starting a timer or turning on a flashlight). * EXTEND FROM: https://schema.org/ControlAction
...
pub struct ActivateAction {
    ...
    #[serde(flatten)]
    pub options: Box<ActivateActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ActivateActionOptions {
