...
/// * COMMENT: The act of editing by adding an object to a collection. * EXTEND FROM: https://schema.org/UpdateAction * LOOK ALSO: https://schema.org/InsertAction
...
pub struct AddAction {
    ...
    #[serde(flatten)]
    pub options: Box<AddActionOptions>,
}
