...
/// * COMMENT: A geographical region, typically under the jurisdiction of a particular government. * EXTEND FROM: https://schema.org/Place * LOOK ALSO: https://schema.org/City, https://schema.org/Country, https://schema.org/SchoolDistrict, https://schema.org/State
...
pub struct AdministrativeArea {
    ...
    #[serde(flatten)]
    pub options: Box<AdministrativeAreaOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AdministrativeAreaOptions {
