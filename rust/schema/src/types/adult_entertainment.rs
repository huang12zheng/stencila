...
/// * COMMENT: An adult entertainment establishment. * EXTEND FROM: https://schema.org/EntertainmentBusiness
...
pub struct AdultEntertainment {
    ...
    #[serde(flatten)]
    pub options: Box<AdultEntertainmentOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AdultEntertainmentOptions {
