...
/// * MOD OF: https://pending.schema.org * COMMENT: An <a class="localLink" href="/Article">Article</a> that an external entity has paid to place or to produce to its specifications. Includes <a href="https://en.wikipedia.org/wiki/Advertorial">advertorials</a>, sponsored content, native advertising and other paid content. * EXTEND FROM: https://schema.org/Article
...
pub struct AdvertiserContentArticle {
    ...
    #[serde(flatten)]
    pub options: Box<AdvertiserContentArticleOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AdvertiserContentArticleOptions {
