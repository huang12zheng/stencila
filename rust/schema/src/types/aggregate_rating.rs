...
/// * COMMENT: The average rating based on multiple ratings or reviews. * EXTEND FROM: https://schema.org/Rating * LOOK ALSO: https://schema.org/EmployerAggregateRating
...
pub struct AggregateRating {
    ...
    #[serde(flatten)]
    pub options: Box<AggregateRatingOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AggregateRatingOptions {
