...
/// * COMMENT: The act of expressing a consistency of opinion with the object. An agent agrees to/about an object (a proposition, topic or theme) with participants. * EXTEND FROM: https://schema.org/ReactAction
...
pub struct AgreeAction {
    ...
    #[serde(flatten)]
    pub options: Box<AgreeActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AgreeActionOptions {
