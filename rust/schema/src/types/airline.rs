...
/// * COMMENT: An organization that provides flights for passengers. * EXTEND FROM: https://schema.org/Organization
...
pub struct Airline {
    ...
    #[serde(flatten)]
    pub options: Box<AirlineOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AirlineOptions {
