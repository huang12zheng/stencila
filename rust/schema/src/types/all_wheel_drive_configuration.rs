...
/// * COMMENT: All-wheel Drive is a transmission layout where the engine drives all four wheels. * EXTEND FROM: https://schema.org/DriveWheelConfigurationValue * ENUMERATION FROM: https://schema.org/DriveWheelConfigurationValue
...
pub struct AllWheelDriveConfiguration {
    ...
    #[serde(flatten)]
    pub options: Box<AllWheelDriveConfigurationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AllWheelDriveConfigurationOptions {
