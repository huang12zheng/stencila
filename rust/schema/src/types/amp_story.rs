...
/// * MOD OF: https://pending.schema.org * COMMENT: A creative work with a visual storytelling format intended to be viewed online, particularly on mobile devices. * EXTEND FROM: https://schema.org/CreativeWork, https://schema.org/MediaObject
...
pub struct AmpStory {
    ...
    #[serde(flatten)]
    pub options: Box<AmpStoryOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AmpStoryOptions {
