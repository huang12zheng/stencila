...
/// * MOD OF: https://pending.schema.org * COMMENT: An AnalysisNewsArticle is a <a class="localLink" href="/NewsArticle">NewsArticle</a> that, while based on factual reporting, incorporates the expertise of the author/producer, offering interpretations and conclusions. * EXTEND FROM: https://schema.org/NewsArticle
...
pub struct AnalysisNewsArticle {
    ...
    #[serde(flatten)]
    pub options: Box<AnalysisNewsArticleOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AnalysisNewsArticleOptions {
