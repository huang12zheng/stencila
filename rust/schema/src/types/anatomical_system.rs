...
use super::comprised_of_prop_enum::ComprisedOfPropEnum;
...
pub struct AnatomicalSystem {
    ...
    pub comprised_of_prop_enum: Option<ComprisedOfPropEnum>,

    /// A medical condition associated with this anatomy.
    pub related_condition_prop_enum: Option<MedicalCondition>,

    /// Related anatomical structure(s) that are not part of the system but relate or connect to it, such as vascular bundles associated with an organ system.
    pub related_structure_prop_enum: Option<AnatomicalStructure>,
