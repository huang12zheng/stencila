...
/// * COMMENT: An answer offered to a question; perhaps correct, perhaps opinionated or wrong. * EXTEND FROM: https://schema.org/Comment
...
pub struct AnswerOptions {
    ...
    pub answer_explanation: Option<Answer>,
}
