...
/// * COMMENT: Residence type: Apartment complex. * EXTEND FROM: https://schema.org/Residence
...
pub struct ApartmentComplex {
    ...
    #[serde(flatten)]
    pub options: Box<ApartmentComplexOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ApartmentComplexOptions {
    ...
    pub number_of_accommodation_units: Option<QuantitativeValue>,
    ...
    pub number_of_available_accommodation_units: Option<QuantitativeValue>,
