...
/// * COMMENT: Reference documentation for application programming interfaces (APIs). * EXTEND FROM: https://schema.org/TechArticle
...
pub struct APIReference {
    ...
    #[serde(flatten)]
    pub options: Box<APIReferenceOptions>,
}
...
pub struct APIReferenceOptions {
    ...
    pub dependencies: Option<TechArticle>,

    /// Proficiency needed for this content; expected values: 'Beginner', 'Expert'.
    pub proficiency_level: Option<TechArticle>,

    /// Associated product/technology version. E.g., .NET Framework 4.5.
    pub assembly_version: Option<APIReference>,

    /// Library file name, e.g., mscorlib.dll, system.web.dll.
    pub executable_library_name: Option<APIReference>,

    /// Indicates whether API is managed or unmanaged.
    pub programming_model: Option<APIReference>,

    /// Type of app development: phone, Metro style, desktop, XBox, etc.
    pub target_platform: Option<APIReference>,
}
