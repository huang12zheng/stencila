...
/// * COMMENT: Appearance assessment with clinical examination. * EXTEND FROM: https://schema.org/PhysicalExam * ENUMERATION FROM: https://schema.org/PhysicalExam
...
pub struct Appearance {
    ...
    #[serde(flatten)]
    pub options: Box<AppearanceOptions>,
}
