...
/// * COMMENT: The act of inserting at the end if an ordered collection. * EXTEND FROM: https://schema.org/InsertAction
...
pub struct AppendAction {
    ...
    #[serde(flatten)]
    pub options: Box<AppendActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AppendActionOptions {
