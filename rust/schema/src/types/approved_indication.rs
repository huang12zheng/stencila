...
/// * COMMENT: An indication for a medical therapy that has been formally specified or approved by a regulatory body that regulates use of the therapy; for example, the US FDA approves indications for most drugs in the US. * EXTEND FROM: https://schema.org/MedicalIndication
...
pub struct ApprovedIndication {
    ...
    #[serde(flatten)]
    pub options: Box<ApprovedIndicationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ApprovedIndicationOptions {
