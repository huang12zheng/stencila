...
/// * MOD OF: https://pending.schema.org * COMMENT: An intangible type to be applied to any archive content, carrying with it a set of properties required to describe archival items and collections. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct ArchiveComponent {
    ...
    #[serde(flatten)]
    pub options: Box<ArchiveComponentOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ArchiveComponentOptions {
    ...
    pub holding_archive: Option<ArchiveComponent>,

    /// Current location of the item.
    pub item_location: Option<ArchiveComponent>,
}
