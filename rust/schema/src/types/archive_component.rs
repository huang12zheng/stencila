...
use super::item_location_prop_enum::ItemLocationPropEnum;
...
pub struct ArchiveComponent {
    ...
    pub holding_archive_prop_enum: Option<ArchiveOrganization>,

    /// Current location of the item.
    pub item_location_prop_enum: Option<ItemLocationPropEnum>,
}
