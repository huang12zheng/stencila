...
/// * MOD OF: https://pending.schema.org * COMMENT: An organization with archival holdings. An organization which keeps and preserves archival material and typically makes it accessible to the public. * EXTEND FROM: https://schema.org/LocalBusiness
...
pub struct ArchiveOrganization {
    ...
    #[serde(flatten)]
    pub options: Box<ArchiveOrganizationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ArchiveOrganizationOptions {
    ...
    pub archive_held: Option<ArchiveOrganization>,
}

impl ArchiveOrganization {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
