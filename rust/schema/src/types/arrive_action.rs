...
/// * COMMENT: The act of arriving at a place. An agent arrives at a destination from a fromLocation, optionally with participants. * EXTEND FROM: https://schema.org/MoveAction
...
pub struct ArriveAction {
    ...
    #[serde(flatten)]
    pub options: Box<ArriveActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ArriveActionOptions {
