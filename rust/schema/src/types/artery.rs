...
/// * COMMENT: A type of blood vessel that specifically carries blood away from the heart. * EXTEND FROM: https://schema.org/Vessel
...
pub struct Artery {
    ...
    #[serde(flatten)]
    pub options: Box<ArteryOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ArteryOptions {
    ...
    pub arterial_branch: Option<AnatomicalStructure>,

    /// The area to which the artery supplies blood.
    pub supply_to: Option<AnatomicalStructure>,
}
