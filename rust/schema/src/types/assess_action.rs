...
/// * COMMENT: The act of forming one's opinion, reaction or sentiment. * EXTEND FROM: https://schema.org/Action * LOOK ALSO: https://schema.org/ChooseAction, https://schema.org/IgnoreAction, https://schema.org/ReactAction, https://schema.org/ReviewAction
...
pub struct AssessAction {
    ...
    #[serde(flatten)]
    pub options: Box<AssessActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AssessActionOptions {
