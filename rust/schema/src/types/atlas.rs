...
/// * MOD OF: https://bib.schema.org * COMMENT: A collection or bound volume of maps, charts, plates or tables, physical or in media form illustrating any subject. * EXTEND FROM: https://schema.org/CreativeWork
