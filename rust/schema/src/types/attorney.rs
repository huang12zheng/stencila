...
/// * COMMENT: Professional service: Attorney. <br/><br/>  This type is deprecated - <a class="localLink" href="/LegalService">LegalService</a> is more inclusive and less ambiguous. * EXTEND FROM: https://schema.org/LegalService
...
pub struct Attorney {
    ...
    #[serde(flatten)]
    pub options: Box<AttorneyOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AttorneyOptions {
