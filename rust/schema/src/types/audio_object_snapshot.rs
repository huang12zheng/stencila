...
/// * MOD OF: https://pending.schema.org * COMMENT: A specific and exact (byte-for-byte) version of an <a class="localLink" href="/AudioObject">AudioObject</a>. Two byte-for-byte identical files, for the purposes of this type, considered identical. If they have different embedded metadata the files will differ. Different external facts about the files, e.g. creator or dateCreated that aren't represented in their actual content, do not affect this notion of identity. * EXTEND FROM: https://schema.org/AudioObject
...
pub struct AudioObjectSnapshot {
    ...
    #[serde(flatten)]
    pub options: Box<AudioObjectSnapshotOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AudioObjectSnapshotOptions {
