...
/// An audiobook.
/// * EXTEND FROM:
/// https://schema.org/AudioObject, https://schema.org/Book
...
pub struct Audiobook {
    ...
    pub abridged_prop_enum: Option<Boolean>,

    /// The edition of the book.
    pub book_edition_prop_enum: Option<Text>,

    /// The format of the book.
    pub book_format_prop_enum: Option<BookFormatType>,

    /// The illustrator of the book.
    pub illustrator_prop_enum: Option<Person>,

    /// The ISBN of the book.
    pub isbn_prop_enum: Option<Text>,

    /// The number of pages in the book.
    pub number_of_pages_prop_enum: Option<Integer>,

    /// A person who reads (performs) the audiobook.
    pub read_by_prop_enum: Option<Person>,
}
