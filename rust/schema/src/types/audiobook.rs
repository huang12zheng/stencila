...
pub struct AudiobookOptions {
    ...
    pub abridged: Option<Boolean>,

    /// The edition of the book.
    pub book_edition: Option<Text>,

    /// The format of the book.
    pub book_format: Option<BookFormatType>,

    /// The illustrator of the book.
    pub illustrator: Option<Person>,

    /// The ISBN of the book.
    pub isbn: Option<Text>,

    /// The number of pages in the book.
    pub number_of_pages: Option<Integer>,

    /// A person who reads (performs) the audiobook.
    pub read_by: Option<Person>,
}
