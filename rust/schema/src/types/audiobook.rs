...
/// * MOD OF: https://bib.schema.org * COMMENT: An audiobook. * EXTEND FROM: https://schema.org/AudioObject, https://schema.org/Book
...
pub struct Audiobook {
    ...
    #[serde(flatten)]
    pub options: Box<AudiobookOptions>,
}
...
pub struct AudiobookOptions {
    ...
    pub abridged: Option<Book>,

    /// The edition of the book.
    pub book_edition: Option<Book>,

    /// The format of the book.
    pub book_format: Option<Book>,

    /// The illustrator of the book.
    pub illustrator: Option<Book>,

    /// The ISBN of the book.
    pub isbn: Option<Book>,

    /// The number of pages in the book.
    pub number_of_pages: Option<Book>,

    /// A person who reads (performs) the audiobook.
    pub read_by: Option<Audiobook>,
}
