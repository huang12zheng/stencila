...
/// * COMMENT: The act of granting permission to an object. * EXTEND FROM: https://schema.org/AllocateAction
...
pub struct AuthorizeAction {
    ...
    #[serde(flatten)]
    pub options: Box<AuthorizeActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AuthorizeActionOptions {
