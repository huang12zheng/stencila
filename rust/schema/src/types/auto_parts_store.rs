...
/// * COMMENT: An auto parts store. * EXTEND FROM: https://schema.org/AutomotiveBusiness, https://schema.org/Store
...
pub struct AutoPartsStore {
    ...
    #[serde(flatten)]
    pub options: Box<AutoPartsStoreOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct AutoPartsStoreOptions {
