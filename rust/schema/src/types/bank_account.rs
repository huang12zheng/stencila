...
use super::bank_account_type::bankAccountType;
...
/// * COMMENT: A product or service offered by a bank whereby one may deposit, withdraw or transfer money and in some cases be paid interest. * EXTEND FROM: https://schema.org/FinancialProduct * LOOK ALSO: https://schema.org/DepositAccount
...
pub struct BankAccount {
    ...
    #[serde(flatten)]
    pub options: Box<BankAccountOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct BankAccountOptions {
    ...
    pub account_minimum_inflow: Option<MonetaryAmount>,

    /// An overdraft is an extension of credit from a lending institution when an account reaches zero. An overdraft allows the individual to continue withdrawing money even if the account has no funds in it. Basically the bank allows people to borrow a set amount of money.
    pub account_overdraft_limit: Option<MonetaryAmount>,
