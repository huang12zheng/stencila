...
/// * COMMENT: An image of a visual machine-readable code such as a barcode or QR code. * EXTEND FROM: https://schema.org/ImageObject
...
pub struct Barcode {
    ...
    #[serde(flatten)]
    pub options: Box<BarcodeOptions>,
}
