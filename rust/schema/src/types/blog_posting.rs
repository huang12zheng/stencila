...
/// * COMMENT: A blog post. * EXTEND FROM: https://schema.org/SocialMediaPosting * LOOK ALSO: https://schema.org/LiveBlogPosting
...
pub struct BlogPosting {
    ...
    #[serde(flatten)]
    pub options: Box<BlogPostingOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct BlogPostingOptions {
