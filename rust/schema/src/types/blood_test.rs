...
/// * COMMENT: A medical test performed on a sample of a patient's blood. * EXTEND FROM: https://schema.org/MedicalTest
...
pub struct BloodTest {
    ...
    #[serde(flatten)]
    pub options: Box<BloodTestOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct BloodTestOptions {
