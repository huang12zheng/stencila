...
/// * MOD OF: https://pending.schema.org * COMMENT: A terminal for boats, ships, and other water vessels. * EXTEND FROM: https://schema.org/CivicStructure
...
pub struct BoatTerminal {
    ...
    #[serde(flatten)]
    pub options: Box<BoatTerminalOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct BoatTerminalOptions {
