...
/// * MOD OF: https://pending.schema.org * COMMENT: A trip on a commercial ferry line. * EXTEND FROM: https://schema.org/Trip
...
pub struct BoatTrip {
    ...
    #[serde(flatten)]
    pub options: Box<BoatTripOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct BoatTripOptions {
    ...
    pub arrival_boat_terminal: Option<BoatTerminal>,

    /// The terminal or port from which the boat departs.
    pub departure_boat_terminal: Option<BoatTerminal>,
}
