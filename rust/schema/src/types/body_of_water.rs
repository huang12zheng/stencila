...
/// * COMMENT: A body of water, such as a sea, ocean, or lake. * EXTEND FROM: https://schema.org/Landform * LOOK ALSO: https://schema.org/Canal, https://schema.org/LakeBodyOfWater, https://schema.org/OceanBodyOfWater, https://schema.org/Pond, https://schema.org/Reservoir, https://schema.org/RiverBodyOfWater, https://schema.org/SeaBodyOfWater, https://schema.org/Waterfall
...
pub struct BodyOfWater {
    ...
    #[serde(flatten)]
    pub options: Box<BodyOfWaterOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct BodyOfWaterOptions {
