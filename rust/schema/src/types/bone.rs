...
/// * COMMENT: Rigid connective tissue that comprises up the skeletal structure of the human body. * EXTEND FROM: https://schema.org/AnatomicalStructure
...
pub struct Bone {
    ...
    #[serde(flatten)]
    pub options: Box<BoneOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct BoneOptions {
