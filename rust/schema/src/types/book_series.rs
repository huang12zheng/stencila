...
/// * COMMENT: A series of books. Included books can be indicated with the hasPart property. * EXTEND FROM: https://schema.org/CreativeWorkSeries
...
pub struct BookSeries {
    ...
    #[serde(flatten)]
    pub options: Box<BookSeriesOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct BookSeriesOptions {
