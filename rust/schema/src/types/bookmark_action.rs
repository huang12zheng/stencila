...
/// * COMMENT: An agent bookmarks/flags/labels/tags/marks an object. * EXTEND FROM: https://schema.org/OrganizeAction
...
pub struct BookmarkAction {
    ...
    #[serde(flatten)]
    pub options: Box<BookmarkActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct BookmarkActionOptions {
