...
/// * COMMENT: The act of obtaining an object under an agreement to return it at a later date. Reciprocal of LendAction.<br/><br/>  Related actions:<br/><br/>  <ul> <li><a class="localLink" href="/LendAction">LendAction</a>: Reciprocal of BorrowAction.</li> </ul> * EXTEND FROM: https://schema.org/TransferAction
...
pub struct BorrowAction {
    ...
    #[serde(flatten)]
    pub options: Box<BorrowActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct BorrowActionOptions {
    ...
    pub lender: Option<BorrowAction>,
}
