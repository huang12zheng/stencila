...
/// * COMMENT: Any anatomical structure which pertains to the soft nervous tissue functioning as the coordinating center of sensation and intellectual and nervous activity. * EXTEND FROM: https://schema.org/AnatomicalStructure
...
pub struct BrainStructure {
    ...
    #[serde(flatten)]
    pub options: Box<BrainStructureOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct BrainStructureOptions {
