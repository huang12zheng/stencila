...
/// * COMMENT: An over the air or online broadcast event. * EXTEND FROM: https://schema.org/PublicationEvent
...
pub struct BroadcastEvent {
    ...
    #[serde(flatten)]
    pub options: Box<BroadcastEventOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct BroadcastEventOptions {
    ...
    pub published_by: Option<PublicationEvent>,

    /// A broadcast service associated with the publication event.
    pub published_on: Option<PublicationEvent>,

    /// The event being broadcast such as a sporting event or awards ceremony.
    pub broadcast_of_event: Option<BroadcastEvent>,

    /// True if the broadcast is of a live event.
    pub is_live_broadcast: Option<BroadcastEvent>,
