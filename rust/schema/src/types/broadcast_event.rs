...
use super::published_by_prop_enum::PublishedByPropEnum;
...
pub struct BroadcastEvent {
    ...
    pub published_by_prop_enum: Option<PublishedByPropEnum>,

    /// A broadcast service associated with the publication event.
    pub published_on_prop_enum: Option<BroadcastService>,

    /// The event being broadcast such as a sporting event or awards ceremony.
    pub broadcast_of_event_prop_enum: Option<Event>,

    /// True if the broadcast is of a live event.
    pub is_live_broadcast_prop_enum: Option<Boolean>,
