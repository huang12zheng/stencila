...
use super::video_format::videoFormat;

/// * COMMENT: A delivery service through which content is provided via broadcast over the air or online. * EXTEND FROM: https://schema.org/Service * LOOK ALSO: https://schema.org/RadioBroadcastService
...
pub struct BroadcastService {
    ...
    #[serde(flatten)]
    pub options: Box<BroadcastServiceOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct BroadcastServiceOptions {
    ...
    pub broadcast_affiliate_of: Option<BroadcastService>,

    /// The name displayed in the channel guide. For many US affiliates, it is the network name.
    pub broadcast_display_name: Option<BroadcastService>,
    ...
    pub broadcast_timezone: Option<BroadcastService>,

    /// The organization owning or operating the broadcast service.
    pub broadcaster: Option<BroadcastService>,
    ...
    pub has_broadcast_channel: Option<BroadcastService>,
