...
/// * MOD OF: https://pending.schema.org * COMMENT: An account that allows an investor to deposit funds and place investment orders with a licensed broker or brokerage firm. * EXTEND FROM: https://schema.org/InvestmentOrDeposit
...
pub struct BrokerageAccount {
    ...
    #[serde(flatten)]
    pub options: Box<BrokerageAccountOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct BrokerageAccountOptions {
