...
use super::drive_wheel_configuration::driveWheelConfiguration;
...
use super::meets_emission_standard::meetsEmissionStandard;
use super::model::model;
use super::negative_notes::negativeNotes;
use super::number_of_airbags::numberOfAirbags;
use super::number_of_axles::numberOfAxles;
use super::number_of_doors::numberOfDoors;
use super::number_of_forward_gears::numberOfForwardGears;
use super::number_of_previous_owners::numberOfPreviousOwners;
use super::offers::offers;
use super::pattern::pattern;
use super::positive_notes::positiveNotes;
use super::seating_capacity::seatingCapacity;
use super::size::size;
use super::subject_of::subjectOf;
use super::vehicle_seating_capacity::vehicleSeatingCapacity;
use super::vehicle_special_usage::vehicleSpecialUsage;
use super::vehicle_transmission::vehicleTransmission;
use super::width::width;

/// * MOD OF: https://auto.schema.org * COMMENT: A bus (also omnibus or autobus) is a road vehicle designed to carry passengers. Coaches are luxury busses, usually in service for long distance travel. * EXTEND FROM: https://schema.org/Vehicle
...
pub struct BusOrCoach {
    ...
    #[serde(flatten)]
    pub options: Box<BusOrCoachOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct BusOrCoachOptions {
    ...
    pub acceleration_time: Option<QuantitativeValue>,
    ...
    pub cargo_volume: Option<QuantitativeValue>,

    /// The date of the first registration of the vehicle with the respective public authorities.
    pub date_vehicle_first_registered: Option<Date>,

    /// The drive wheel configuration, i.e. which roadwheels will receive torque from the vehicle's engine via the drivetrain.
    pub drive_wheel_configuration: Option<driveWheelConfiguration>,

    /// The CO2 emissions in g/km. When used in combination with a QuantitativeValue, put "g/km" into the unitText property of that value, since there is no UN/CEFACT Common Code for "g/km".
    pub emissions_co2: Option<Number>,
    ...
    pub fuel_capacity: Option<QuantitativeValue>,
    ...
    pub fuel_consumption: Option<QuantitativeValue>,
    ...
    pub fuel_efficiency: Option<QuantitativeValue>,

    /// The type of fuel suitable for the engine or engines of the vehicle. If the vehicle has only one engine, this property can be attached directly to the vehicle.
    pub fuel_type: Option<fuelType>,

    /// A textual description of known damages, both repaired and unrepaired.
    pub known_vehicle_damages: Option<Text>,

    /// Indicates that the vehicle meets the respective emission standard.
    pub meets_emission_standard: Option<meetsEmissionStandard>,
    ...
    pub payload: Option<QuantitativeValue>,
    ...
    pub seating_capacity: Option<seatingCapacity>,
    ...
    pub speed: Option<QuantitativeValue>,

    /// The position of the steering wheel or similar device (mostly for cars).
    pub steering_position: Option<SteeringPositionValue>,
    ...
    pub tongue_weight: Option<QuantitativeValue>,
    ...
    pub trailer_weight: Option<QuantitativeValue>,

    /// A short text indicating the configuration of the vehicle, e.g. '5dr hatchback ST 2.5 MT 225 hp' or 'limited edition'.
    pub vehicle_configuration: Option<Text>,

    /// Information about the engine or engines of the vehicle.
    pub vehicle_engine: Option<EngineSpecification>,

    /// The Vehicle Identification Number (VIN) is a unique serial number used by the automotive industry to identify individual motor vehicles.
    pub vehicle_identification_number: Option<Text>,

    /// The color or color combination of the interior of the vehicle.
    pub vehicle_interior_color: Option<Text>,

    /// The type or material of the interior of the vehicle (e.g. synthetic fabric, leather, wood, etc.). While most interior types are characterized by the material used, an interior type can also be based on vehicle usage or target audience.
    pub vehicle_interior_type: Option<Text>,

    /// The release date of a vehicle model (often used to differentiate versions of the same make and model).
    pub vehicle_model_date: Option<Date>,
    ...
    pub vehicle_seating_capacity: Option<vehicleSeatingCapacity>,

    /// Indicates whether the vehicle has been used for special purposes, like commercial rental, driving school, or as a taxi. The legislation in many countries requires this information to be revealed when offering a car for sale.
    pub vehicle_special_usage: Option<vehicleSpecialUsage>,

    /// The type of component used for transmitting the power from a rotating power source to the wheels or other relevant component(s) ("gearbox" for cars).
    pub vehicle_transmission: Option<vehicleTransmission>,
    ...
    pub weight_total: Option<QuantitativeValue>,
    ...
    pub wheelbase: Option<QuantitativeValue>,

    /// The ACRISS Car Classification Code is a code used by many car rental companies, for classifying vehicles. ACRISS stands for Association of Car Rental Industry Systems and Standards.
    pub acriss_code: Option<Text>,
    ...
    pub roof_load: Option<QuantitativeValue>,
}
