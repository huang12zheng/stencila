...
use super::arrival_bus_stop_prop_enum::ArrivalBusStopPropEnum;
use super::arrival_time_prop_enum::ArrivalTimePropEnum;
use super::departure_bus_stop_prop_enum::DepartureBusStopPropEnum;
...
pub struct BusTrip {
    ...
    pub arrival_bus_stop_prop_enum: Option<ArrivalBusStopPropEnum>,

    /// The name of the bus (e.g. Bolt Express).
    pub bus_name_prop_enum: Option<Text>,

    /// The unique identifier for the bus.
    pub bus_number_prop_enum: Option<Text>,

    /// The stop or station from which the bus departs.
    pub departure_bus_stop_prop_enum: Option<DepartureBusStopPropEnum>,
}
