...
/// * COMMENT: A service which provides access to media programming like TV or radio. Access may be via cable or satellite. * EXTEND FROM: https://schema.org/Service
...
pub struct CableOrSatelliteService {
    ...
    #[serde(flatten)]
    pub options: Box<CableOrSatelliteServiceOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct CableOrSatelliteServiceOptions {
