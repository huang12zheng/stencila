...
/// * MOD OF: https://pending.schema.org * COMMENT: A set of Category Code values. * EXTEND FROM: https://schema.org/DefinedTermSet
...
pub struct CategoryCodeSet {
    ...
    #[serde(flatten)]
    pub options: Box<CategoryCodeSetOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct CategoryCodeSetOptions {
    ...
    pub has_category_code: Option<CategoryCodeSet>,
}

impl CategoryCodeSet {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
