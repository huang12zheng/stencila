...
/// * MOD OF: https://bib.schema.org * COMMENT: One of the sections into which a book is divided. A chapter usually has a section number or a name. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct Chapter {
    ...
    #[serde(flatten)]
    pub options: Box<ChapterOptions>,
}
