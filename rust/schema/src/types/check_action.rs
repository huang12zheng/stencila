...
/// * COMMENT: An agent inspects, determines, investigates, inquires, or examines an object's accuracy, quality, condition, or state. * EXTEND FROM: https://schema.org/FindAction
...
pub struct CheckAction {
    ...
    #[serde(flatten)]
    pub options: Box<CheckActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct CheckActionOptions {
