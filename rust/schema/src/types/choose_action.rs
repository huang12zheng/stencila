...
use super::url::URL;
use super::action_option::actionOption;
...
/// * COMMENT: The act of expressing a preference from a set of options or a large or unbounded set of choices/options. * EXTEND FROM: https://schema.org/AssessAction * LOOK ALSO: https://schema.org/VoteAction
...
pub struct ChooseAction {
    ...
    #[serde(flatten)]
    pub options: Box<ChooseActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ChooseActionOptions {
    ...
    pub action_option: Option<actionOption>,
}
