...
use super::claim_interpreter_prop_enum::ClaimInterpreterPropEnum;
...
pub struct Claim {
    ...
    pub appearance_prop_enum: Option<CreativeWork>,
    ...
    pub claim_interpreter_prop_enum: Option<ClaimInterpreterPropEnum>,
    ...
    pub first_appearance_prop_enum: Option<CreativeWork>,
}
