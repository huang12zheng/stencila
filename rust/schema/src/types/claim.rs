...
use super::claim_interpreter::claimInterpreter;
...
pub struct ClaimOptions {
    ...
    pub appearance: Option<CreativeWork>,
    ...
    pub claim_interpreter: Option<claimInterpreter>,
    ...
    pub first_appearance: Option<CreativeWork>,
}
