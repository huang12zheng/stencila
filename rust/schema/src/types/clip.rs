...
use super::clip_number_prop_enum::ClipNumberPropEnum;
...
use super::end_offset_prop_enum::EndOffsetPropEnum;
...
use super::start_offset_prop_enum::StartOffsetPropEnum;
...
/// * LOOK ALSO:
/// https://schema.org/MovieClip, https://schema.org/RadioClip, https://schema.org/TVClip, https://schema.org/VideoGameClip
...
pub struct Clip {
    ...
    pub clip_number_prop_enum: Option<ClipNumberPropEnum>,

    /// A director of e.g. TV, radio, movie, video gaming etc. content, or of an event. Directors can be associated with individual items or with a series, episode, clip.
    pub director_prop_enum: Option<Person>,

    /// The end time of the clip expressed as the number of seconds from the beginning of the work.
    pub end_offset_prop_enum: Option<EndOffsetPropEnum>,

    /// The composer of the soundtrack.
    pub music_by_prop_enum: Option<MusicByPropEnum>,

    /// The episode to which this clip belongs.
    pub part_of_episode_prop_enum: Option<Episode>,

    /// The season to which this episode belongs.
    pub part_of_season_prop_enum: Option<CreativeWorkSeason>,

    /// The series to which this episode or season belongs.
    pub part_of_series_prop_enum: Option<CreativeWorkSeries>,

    /// The start time of the clip expressed as the number of seconds from the beginning of the work.
    pub start_offset_prop_enum: Option<StartOffsetPropEnum>,
}
