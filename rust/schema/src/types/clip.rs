...
use super::start_offset::startOffset;
use super::teaches::teaches;
use super::translator::translator;
use super::typical_age_range::typicalAgeRange;

/// * COMMENT: A short TV or radio program or a segment/part of a program. * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/MovieClip, https://schema.org/RadioClip, https://schema.org/TVClip, https://schema.org/VideoGameClip
