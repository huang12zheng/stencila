...
/// * MOD OF: https://bib.schema.org * COMMENT: A collection of items, e.g. creative works or products. * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/ProductCollection
...
pub struct CollectionOptions {
    ...
    pub collection_size: Option<Collection>,
}
