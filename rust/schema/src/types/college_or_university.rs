...
/// * COMMENT: A college, university, or other third-level educational institution. * EXTEND FROM: https://schema.org/EducationalOrganization
...
pub struct CollegeOrUniversity {
    ...
    #[serde(flatten)]
    pub options: Box<CollegeOrUniversityOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct CollegeOrUniversityOptions {
