...
/// * MOD OF: https://bib.schema.org * COMMENT: The artwork on the cover of a comic. * EXTEND FROM: https://schema.org/ComicStory, https://schema.org/CoverArt
...
pub struct ComicCoverArt {
    ...
    #[serde(flatten)]
    pub options: Box<ComicCoverArtOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ComicCoverArtOptions {
    ...
    pub art_edition: Option<VisualArtwork>,

    /// The material used. (E.g. Oil, Watercolour, Acrylic, Linoprint, Marble, Cyanotype, Digital, Lithograph, DryPoint, Intaglio, Pastel, Woodcut, Pencil, Mixed Media, etc.)
    pub art_medium: Option<VisualArtwork>,

    /// e.g. Painting, Drawing, Sculpture, Print, Photograph, Assemblage, Collage, etc.
    pub artform: Option<VisualArtwork>,

    /// The supporting materials for the artwork, e.g. Canvas, Paper, Wood, Board, etc.
    pub artwork_surface: Option<VisualArtwork>,
