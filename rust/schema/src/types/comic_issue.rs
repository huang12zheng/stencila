...
/// * MOD OF: https://bib.schema.org * COMMENT: Individual comic issues are serially published as         part of a larger series. For the sake of consistency, even one-shot issues         belong to a series comprised of a single issue. All comic issues can be         uniquely identified by: the combination of the name and volume number of the         series to which the issue belongs; the issue number; and the variant         description of the issue (if any). * EXTEND FROM: https://schema.org/PublicationIssue
...
pub struct ComicIssue {
    ...
    #[serde(flatten)]
    pub options: Box<ComicIssueOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ComicIssueOptions {
    ...
    pub issue_number: Option<PublicationIssue>,
    ...
    pub colorist: Option<colorist>,

    /// The individual who traces over the pencil drawings in ink after pencils are complete.
    pub inker: Option<inker>,

    /// The individual who adds lettering, including speech balloons and sound effects, to artwork.
    pub letterer: Option<letterer>,

    /// The individual who draws the primary narrative artwork.
    pub penciler: Option<penciler>,
    ...
    pub variant_cover: Option<ComicIssue>,
}
