...
/// * MOD OF: https://bib.schema.org * COMMENT: A sequential publication of comic stories under a         unifying title, for example "The Amazing Spider-Man" or "Groo the         Wanderer". * EXTEND FROM: https://schema.org/Periodical
...
pub struct ComicSeries {
    ...
    #[serde(flatten)]
    pub options: Box<ComicSeriesOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ComicSeriesOptions {
