...
/// * MOD OF: https://bib.schema.org * COMMENT: The term "story" is any indivisible, re-printable         unit of a comic, including the interior stories, covers, and backmatter. Most         comics have at least two stories: a cover (ComicCoverArt) and an interior story. * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/ComicCoverArt
...
pub struct ComicStory {
    ...
    #[serde(flatten)]
    pub options: Box<ComicStoryOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ComicStoryOptions {
