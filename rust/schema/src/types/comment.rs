...
/// * COMMENT: A comment on an item - for example, a comment on a blog post. The comment's content is expressed via the <a class="localLink" href="/text">text</a> property, and its topic via <a class="localLink" href="/about">about</a>, properties shared with all CreativeWorks. * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/Answer, https://schema.org/CorrectionComment, https://schema.org/Question
