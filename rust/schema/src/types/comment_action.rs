...
/// * COMMENT: The act of generating a comment about a subject. * EXTEND FROM: https://schema.org/CommunicateAction
...
pub struct CommentAction {
    ...
    #[serde(flatten)]
    pub options: Box<CommentActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct CommentActionOptions {
