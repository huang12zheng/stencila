...
/// * COMMENT: The act of conveying information to another person via a communication medium (instrument) such as speech, email, or telephone conversation. * EXTEND FROM: https://schema.org/InteractAction * LOOK ALSO: https://schema.org/AskAction, https://schema.org/CheckInAction, https://schema.org/CheckOutAction, https://schema.org/CommentAction, https://schema.org/InformAction, https://schema.org/InviteAction, https://schema.org/ReplyAction, https://schema.org/ShareAction
...
pub struct CommunicateAction {
    ...
    #[serde(flatten)]
    pub options: Box<CommunicateActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct CommunicateActionOptions {
