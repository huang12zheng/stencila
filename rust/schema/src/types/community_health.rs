...
/// * COMMENT: A field of public health focusing on improving health characteristics of a defined population in relation with their geographical or environment areas. * EXTEND FROM: https://schema.org/MedicalBusiness, https://schema.org/MedicalSpecialty * ENUMERATION FROM: https://schema.org/MedicalSpecialty
...
pub struct CommunityHealth {
    ...
    #[serde(flatten)]
    pub options: Box<CommunityHealthOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct CommunityHealthOptions {
