...
pub struct CompleteDataFeed {
    ...
    #[serde(flatten)]
    pub options: Box<CompleteDataFeedOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct CompleteDataFeedOptions {
    ...
    pub distribution: Option<Dataset>,

    /// A data catalog which contains this dataset.
    pub included_in_data_catalog: Option<Dataset>,
    ...
    pub variable_measured: Option<Dataset>,

    /// An item within a data feed. Data feeds may have many elements.
    pub data_feed_element: Option<DataFeed>,
}

impl CompleteDataFeed {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
