...
use super::data_feed_element::dataFeedElement;
...
use super::variable_measured::variableMeasured;
...
pub struct CompleteDataFeedOptions {
    ...
    pub distribution: Option<DataDownload>,

    /// A data catalog which contains this dataset.
    pub included_in_data_catalog: Option<DataCatalog>,

    /// The International Standard Serial Number (ISSN) that identifies this serial publication. You can repeat this property to identify different formats of, or the linking ISSN (ISSN-L) for, this serial publication.
    pub issn: Option<Text>,
    ...
    pub variable_measured: Option<variableMeasured>,

    /// An item within a data feed. Data feeds may have many elements.
    pub data_feed_element: Option<dataFeedElement>,
}
