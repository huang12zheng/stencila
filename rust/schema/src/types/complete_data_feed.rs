...
use super::data_feed_element_prop_enum::DataFeedElementPropEnum;
use super::date::Date;
...
use super::variable_measured_prop_enum::VariableMeasuredPropEnum;
...
/// * COMMENT:
/// A <a class="localLink" href="/CompleteDataFeed">CompleteDataFeed</a> is a <a class="localLink" href="/DataFeed">DataFeed</a> whose standard representation includes content for every item currently in the feed.<br/><br/>
/// 
...
pub struct CompleteDataFeed {
    ...
    pub distribution_prop_enum: Option<DataDownload>,

    /// A data catalog which contains this dataset.
    pub included_in_data_catalog_prop_enum: Option<DataCatalog>,
    ...
    pub variable_measured_prop_enum: Option<VariableMeasuredPropEnum>,

    /// An item within a data feed. Data feeds may have many elements.
    pub data_feed_element_prop_enum: Option<DataFeedElementPropEnum>,
}
