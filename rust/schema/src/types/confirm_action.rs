...
/// * COMMENT: The act of notifying someone that a future event/action is going to happen as expected.<br/><br/>  Related actions:<br/><br/>  <ul> <li><a class="localLink" href="/CancelAction">CancelAction</a>: The antonym of ConfirmAction.</li> </ul> * EXTEND FROM: https://schema.org/InformAction
...
pub struct ConfirmAction {
    ...
    #[serde(flatten)]
    pub options: Box<ConfirmActionOptions>,
}
