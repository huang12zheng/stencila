...
/// * MOD OF: https://pending.schema.org * COMMENT: A Consortium is a membership <a class="localLink" href="/Organization">Organization</a> whose members are typically Organizations. * EXTEND FROM: https://schema.org/Organization
...
pub struct Consortium {
    ...
    #[serde(flatten)]
    pub options: Box<ConsortiumOptions>,
}
