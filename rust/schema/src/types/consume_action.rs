...
/// * COMMENT: The act of ingesting information/resources/food. * EXTEND FROM: https://schema.org/Action * LOOK ALSO: https://schema.org/DrinkAction, https://schema.org/EatAction, https://schema.org/InstallAction, https://schema.org/ListenAction, https://schema.org/PlayGameAction, https://schema.org/ReadAction, https://schema.org/UseAction, https://schema.org/ViewAction, https://schema.org/WatchAction
...
pub struct ConsumeAction {
    ...
    #[serde(flatten)]
    pub options: Box<ConsumeActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ConsumeActionOptions {
    ...
    pub action_accessibility_requirement: Option<ActionAccessSpecification>,
