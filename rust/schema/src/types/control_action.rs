...
/// * COMMENT: An agent controls a device or application. * EXTEND FROM: https://schema.org/Action * LOOK ALSO: https://schema.org/ActivateAction, https://schema.org/DeactivateAction, https://schema.org/ResumeAction, https://schema.org/SuspendAction
...
pub struct ControlAction {
    ...
    #[serde(flatten)]
    pub options: Box<ControlActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ControlActionOptions {
