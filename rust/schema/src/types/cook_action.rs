...
use super::food_establishment_prop_enum::FoodEstablishmentPropEnum;
...
pub struct CookAction {
    ...
    pub food_establishment_prop_enum: Option<FoodEstablishmentPropEnum>,

    /// A sub property of location. The specific food event where the action occurred.
    pub food_event_prop_enum: Option<FoodEvent>,

    /// A sub property of instrument. The recipe/instructions used to perform the action.
    pub recipe_prop_enum: Option<Recipe>,
}
