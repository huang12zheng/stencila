...
/// * COMMENT: The act of producing/preparing food. * EXTEND FROM: https://schema.org/CreateAction
...
pub struct CookAction {
    ...
    #[serde(flatten)]
    pub options: Box<CookActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct CookActionOptions {
    ...
    pub food_establishment: Option<CookAction>,

    /// A sub property of location. The specific food event where the action occurred.
    pub food_event: Option<CookAction>,

    /// A sub property of instrument. The recipe/instructions used to perform the action.
    pub recipe: Option<CookAction>,
}
