...
/// * COMMENT: Organization: A business corporation. * EXTEND FROM: https://schema.org/Organization
...
pub struct Corporation {
    ...
    #[serde(flatten)]
    pub options: Box<CorporationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct CorporationOptions {
    ...
    pub ticker_symbol: Option<Corporation>,
}
