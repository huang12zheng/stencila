...
/// * MOD OF: https://pending.schema.org * COMMENT: A <a class="localLink" href="/comment">comment</a> that corrects <a class="localLink" href="/CreativeWork">CreativeWork</a>. * EXTEND FROM: https://schema.org/Comment
...
pub struct CorrectionComment {
    ...
    #[serde(flatten)]
    pub options: Box<CorrectionCommentOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct CorrectionCommentOptions {
