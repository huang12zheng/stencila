...
use super::course_prerequisites::coursePrerequisites;
...
pub struct CourseOptions {
    ...
    pub course_prerequisites: Option<coursePrerequisites>,
    ...
    pub has_course_instance: Option<CourseInstance>,
