...
/// * COMMENT: A description of an educational course which may be offered as distinct instances which take place at different times or take place at different locations, or be offered through different media or modes of study. An educational course is a sequence of one or more educational events and/or creative works which aims to build knowledge, competence or ability of learners. * EXTEND FROM: https://schema.org/CreativeWork, https://schema.org/LearningResource
...
pub struct CourseOptions {
    ...
    pub course_prerequisites: Option<Course>,
    ...
    pub has_course_instance: Option<Course>,
