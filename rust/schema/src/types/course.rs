...
use super::course_prerequisites_prop_enum::CoursePrerequisitesPropEnum;
...
/// * EXTEND FROM:
/// https://schema.org/CreativeWork, https://schema.org/LearningResource
...
pub struct Course {
    ...
    pub course_code_prop_enum: Option<Text>,
    ...
    pub course_prerequisites_prop_enum: Option<CoursePrerequisitesPropEnum>,
    ...
    pub has_course_instance_prop_enum: Option<CourseInstance>,
