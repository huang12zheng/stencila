...
/// * COMMENT: An instance of a <a class="localLink" href="/Course">Course</a> which is distinct from other instances because it is offered at a different time or location or through different media or modes of study or to a specific section of students. * EXTEND FROM: https://schema.org/Event
...
pub struct CourseInstance {
    ...
    #[serde(flatten)]
    pub options: Box<CourseInstanceOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct CourseInstanceOptions {
    ...
    pub course_mode: Option<CourseInstance>,

    /// The amount of work expected of students taking the course, often provided as a figure per week or per month, and may be broken down by type. For example, "2 hours of lectures, 1 hour of lab work and 3 hours of independent study per week".
    pub course_workload: Option<CourseInstance>,
    ...
    pub instructor: Option<CourseInstance>,
}
