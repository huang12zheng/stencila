...
/// * MOD OF: https://bib.schema.org * COMMENT: The artwork on the outer surface of a CreativeWork. * EXTEND FROM: https://schema.org/VisualArtwork * LOOK ALSO: https://schema.org/ComicCoverArt
...
pub struct CoverArt {
    ...
    #[serde(flatten)]
    pub options: Box<CoverArtOptions>,
}
