...
use super::season_number_prop_enum::SeasonNumberPropEnum;
...
/// * LOOK ALSO:
/// https://schema.org/PodcastSeason, https://schema.org/RadioSeason, https://schema.org/TVSeason
...
pub struct CreativeWorkSeason {
    ...
    pub season_number_prop_enum: Option<SeasonNumberPropEnum>,
