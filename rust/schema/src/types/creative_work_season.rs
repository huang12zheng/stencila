...
use super::part_of_series::partOfSeries;
...
/// * COMMENT: A media season, e.g. TV, radio, video game etc. * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/PodcastSeason, https://schema.org/RadioSeason, https://schema.org/TVSeason
...
pub struct CreativeWorkSeason {
    ...
    #[serde(flatten)]
    pub options: Box<CreativeWorkSeasonOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct CreativeWorkSeasonOptions {
    ...
    pub part_of_series: Option<partOfSeries>,

    /// The production company or studio responsible for the item, e.g. series, video game, episode etc.
    pub production_company: Option<productionCompany>,

    /// Position of the season within an ordered group of seasons.
    pub season_number: Option<CreativeWorkSeason>,
