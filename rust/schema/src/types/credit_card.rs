...
use super::loan_type::loanType;
use super::logo::logo;
use super::main_entity_of_page::mainEntityOfPage;
use super::monthly_minimum_repayment_amount::monthlyMinimumRepaymentAmount;
use super::offers::offers;
use super::provider::provider;
use super::required_collateral::requiredCollateral;
use super::service_type::serviceType;
use super::subject_of::subjectOf;
use super::superseded_by::supersededBy;
use super::terms_of_service::termsOfService;

/// * COMMENT: A card payment method of a particular brand or name.  Used to mark up a particular payment method and/or the financial product/service that supplies the card account.<br/><br/>  Commonly used values:<br/><br/>  <ul> <li>http://purl.org/goodrelations/v1#AmericanExpress</li> <li>http://purl.org/goodrelations/v1#DinersClub</li> <li>http://purl.org/goodrelations/v1#Discover</li> <li>http://purl.org/goodrelations/v1#JCB</li> <li>http://purl.org/goodrelations/v1#MasterCard</li> <li>http://purl.org/goodrelations/v1#VISA</li> </ul> * EXTEND FROM: https://schema.org/LoanOrCredit, https://schema.org/PaymentCard
...
pub struct CreditCard {
    ...
    #[serde(flatten)]
    pub options: Box<CreditCardOptions>,
}
...
pub struct CreditCardOptions {
    ...
    pub loan_repayment_form: Option<RepaymentSpecification>,

    /// The duration of the loan or credit agreement.
    pub loan_term: Option<QuantitativeValue>,

    /// The type of a loan or credit.
    pub loan_type: Option<loanType>,

    /// The only way you get the money back in the event of default is the security. Recourse is where you still have the opportunity to go back to the borrower for the rest of the money.
    pub recourse_loan: Option<Boolean>,

    /// Whether the terms for payment of interest can be renegotiated during the life of the loan.
    pub renegotiable_loan: Option<Boolean>,

    /// Assets required to secure loan or credit repayments. It may take form of third party pledge, goods, financial instruments (cash, securities, etc.)
    pub required_collateral: Option<requiredCollateral>,

    /// Relates a term (i.e. a property, class or enumeration) to one that supersedes it.
    pub superseded_by: Option<supersededBy>,

    /// A cardholder benefit that pays the cardholder a small percentage of their net expenditures.
    pub cash_back: Option<cashBack>,

    /// A secure method for consumers to purchase products or services via debit, credit or smartcards by using RFID or NFC technology.
    pub contactless_payment: Option<Boolean>,

    /// A floor limit is the amount of money above which credit card transactions must be authorized.
    pub floor_limit: Option<MonetaryAmount>,

    /// The minimum payment is the lowest amount of money that one is required to pay on a credit card statement each month.
    pub monthly_minimum_repayment_amount: Option<monthlyMinimumRepaymentAmount>,
}
