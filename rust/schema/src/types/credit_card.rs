...
use super::amount_prop_enum::AmountPropEnum;
...
use super::cash_back_prop_enum::CashBackPropEnum;
...
use super::loan_type_prop_enum::LoanTypePropEnum;
use super::logo_prop_enum::LogoPropEnum;
use super::main_entity_of_page_prop_enum::MainEntityOfPagePropEnum;
use super::monetary_amount::MonetaryAmount;
use super::monthly_minimum_repayment_amount_prop_enum::MonthlyMinimumRepaymentAmountPropEnum;
...
use super::required_collateral_prop_enum::RequiredCollateralPropEnum;
...
/// </ul>
/// * EXTEND FROM:
/// https://schema.org/LoanOrCredit, https://schema.org/PaymentCard
...
pub struct CreditCard {
    ...
    /// The amount of money.
    pub amount_prop_enum: Option<AmountPropEnum>,
    ...
    pub grace_period_prop_enum: Option<Duration>,

    /// A form of paying back money previously borrowed from a lender. Repayment usually takes the form of periodic payments that normally include part principal plus interest in each payment.
    pub loan_repayment_form_prop_enum: Option<RepaymentSpecification>,

    /// The duration of the loan or credit agreement.
    pub loan_term_prop_enum: Option<QuantitativeValue>,

    /// The type of a loan or credit.
    pub loan_type_prop_enum: Option<LoanTypePropEnum>,

    /// The only way you get the money back in the event of default is the security. Recourse is where you still have the opportunity to go back to the borrower for the rest of the money.
    pub recourse_loan_prop_enum: Option<Boolean>,

    /// Whether the terms for payment of interest can be renegotiated during the life of the loan.
    pub renegotiable_loan_prop_enum: Option<Boolean>,

    /// Assets required to secure loan or credit repayments. It may take form of third party pledge, goods, financial instruments (cash, securities, etc.)
    pub required_collateral_prop_enum: Option<RequiredCollateralPropEnum>,

    /// Relates a term (i.e. a property, class or enumeration) to one that supersedes it.
    pub superseded_by_prop_enum: Option<SupersededByPropEnum>,

    /// A cardholder benefit that pays the cardholder a small percentage of their net expenditures.
    pub cash_back_prop_enum: Option<CashBackPropEnum>,

    /// A secure method for consumers to purchase products or services via debit, credit or smartcards by using RFID or NFC technology.
    pub contactless_payment_prop_enum: Option<Boolean>,

    /// A floor limit is the amount of money above which credit card transactions must be authorized.
    pub floor_limit_prop_enum: Option<MonetaryAmount>,

    /// The minimum payment is the lowest amount of money that one is required to pay on a credit card statement each month.
    pub monthly_minimum_repayment_amount_prop_enum: Option<MonthlyMinimumRepaymentAmountPropEnum>,
}
