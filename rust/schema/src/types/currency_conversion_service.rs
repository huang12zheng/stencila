...
/// * COMMENT: A service to convert funds from one currency to another currency. * EXTEND FROM: https://schema.org/FinancialProduct
...
pub struct CurrencyConversionService {
    ...
    #[serde(flatten)]
    pub options: Box<CurrencyConversionServiceOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct CurrencyConversionServiceOptions {
