...
/// * COMMENT: An alternative, closely-related condition typically considered later in the differential diagnosis process along with the signs that are used to distinguish it. * EXTEND FROM: https://schema.org/MedicalIntangible
...
pub struct DDxElement {
    ...
    #[serde(flatten)]
    pub options: Box<DDxElementOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DDxElementOptions {
    ...
    pub distinguishing_sign: Option<MedicalSignOrSymptom>,
}
