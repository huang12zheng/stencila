...
/// * COMMENT: A dance group&#x2014;for example, the Alvin Ailey Dance Theater or Riverdance. * EXTEND FROM: https://schema.org/PerformingGroup
...
pub struct DanceGroup {
    ...
    #[serde(flatten)]
    pub options: Box<DanceGroupOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DanceGroupOptions {
