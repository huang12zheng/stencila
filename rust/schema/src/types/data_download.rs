...
/// * COMMENT: All or part of a <a class="localLink" href="/Dataset">Dataset</a> in downloadable form. * EXTEND FROM: https://schema.org/MediaObject
...
pub struct DataDownload {
    ...
    #[serde(flatten)]
    pub options: Box<DataDownloadOptions>,
}
