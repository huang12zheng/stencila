...
/// * COMMENT: A single feed providing structured information about one or more entities or topics. * EXTEND FROM: https://schema.org/Dataset * LOOK ALSO: https://schema.org/CompleteDataFeed
...
pub struct DataFeed {
    ...
    #[serde(flatten)]
    pub options: Box<DataFeedOptions>,
}
