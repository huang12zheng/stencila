...
/// * COMMENT: A body of structured information describing some topic(s) of interest. * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/DataFeed
...
pub struct Dataset {
    ...
    #[serde(flatten)]
    pub options: Box<DatasetOptions>,
}
