...
/// * COMMENT: The act of stopping or deactivating a device or application (e.g. stopping a timer or turning off a flashlight). * EXTEND FROM: https://schema.org/ControlAction
...
pub struct DeactivateAction {
    ...
    #[serde(flatten)]
    pub options: Box<DeactivateActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DeactivateActionOptions {
