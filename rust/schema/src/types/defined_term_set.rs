...
use super::has_defined_term::hasDefinedTerm;
...
/// * MOD OF: https://pending.schema.org * COMMENT: A set of defined terms, for example a set of categories or a classification scheme, a glossary, dictionary or enumeration. * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/CategoryCodeSet
...
pub struct DefinedTermSet {
    ...
    #[serde(flatten)]
    pub options: Box<DefinedTermSetOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DefinedTermSetOptions {
    ...
    pub has_defined_term: Option<hasDefinedTerm>,
}
