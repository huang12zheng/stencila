...
/// * COMMENT: The price for the delivery of an offer using a particular delivery method. * EXTEND FROM: https://schema.org/PriceSpecification
...
pub struct DeliveryChargeSpecification {
    ...
    #[serde(flatten)]
    pub options: Box<DeliveryChargeSpecificationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DeliveryChargeSpecificationOptions {
    ...
    pub applies_to_delivery_method: Option<DeliveryMethod>,
...
impl DeliveryChargeSpecification {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
