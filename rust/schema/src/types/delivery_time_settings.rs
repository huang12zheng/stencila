...
use super::delivery_time::deliveryTime;
use super::is_unlabelled_fallback::isUnlabelledFallback;
use super::shipping_destination::shippingDestination;
use super::transit_time_label::transitTimeLabel;

/// * MOD OF: https://pending.schema.org * COMMENT: A DeliveryTimeSettings represents re-usable pieces of shipping information, relating to timing. It is designed for publication on an URL that may be referenced via the <a class="localLink" href="/shippingSettingsLink">shippingSettingsLink</a> property of an <a class="localLink" href="/OfferShippingDetails">OfferShippingDetails</a>. Several occurrences can be published, distinguished (and identified/referenced) by their different values for <a class="localLink" href="/transitTimeLabel">transitTimeLabel</a>. * EXTEND FROM: https://schema.org/StructuredValue
...
pub struct DeliveryTimeSettings {
    ...
    #[serde(flatten)]
    pub options: Box<DeliveryTimeSettingsOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DeliveryTimeSettingsOptions {
    ...
    pub transit_time_label: Option<transitTimeLabel>,
}

impl DeliveryTimeSettings {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
