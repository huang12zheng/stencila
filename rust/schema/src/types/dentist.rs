...
/// * COMMENT: A dentist. * EXTEND FROM: https://schema.org/LocalBusiness, https://schema.org/MedicalBusiness, https://schema.org/MedicalOrganization
...
pub struct Dentist {
    ...
    #[serde(flatten)]
    pub options: Box<DentistOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DentistOptions {
