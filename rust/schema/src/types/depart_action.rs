...
/// * COMMENT: The act of  departing from a place. An agent departs from a fromLocation for a destination, optionally with participants. * EXTEND FROM: https://schema.org/MoveAction
...
pub struct DepartAction {
    ...
    #[serde(flatten)]
    pub options: Box<DepartActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DepartActionOptions {
