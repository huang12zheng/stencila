...
use super::bank_account_type_prop_enum::BankAccountTypePropEnum;
...
/// * EXTEND FROM:
/// https://schema.org/BankAccount, https://schema.org/InvestmentOrDeposit
...
pub struct DepositAccount {
    ...
    pub account_minimum_inflow_prop_enum: Option<MonetaryAmount>,

    /// An overdraft is an extension of credit from a lending institution when an account reaches zero. An overdraft allows the individual to continue withdrawing money even if the account has no funds in it. Basically the bank allows people to borrow a set amount of money.
    pub account_overdraft_limit_prop_enum: Option<MonetaryAmount>,

    /// The type of a bank account.
    pub bank_account_type_prop_enum: Option<BankAccountTypePropEnum>,
