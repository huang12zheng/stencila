...
/// * COMMENT: A medical laboratory that offers on-site or off-site diagnostic services. * EXTEND FROM: https://schema.org/MedicalOrganization
...
pub struct DiagnosticLab {
    ...
    #[serde(flatten)]
    pub options: Box<DiagnosticLabOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DiagnosticLabOptions {
    ...
    pub available_test: Option<DiagnosticLab>,
}
