...
use super::endorsers_prop_enum::EndorsersPropEnum;
...
/// * EXTEND FROM:
/// https://schema.org/CreativeWork, https://schema.org/LifestyleModification
...
pub struct Diet {
    ...
    pub diet_features_prop_enum: Option<Text>,

    /// People or organizations that endorse the plan.
    pub endorsers_prop_enum: Option<EndorsersPropEnum>,

    /// Medical expert advice related to the plan.
    pub expert_considerations_prop_enum: Option<Text>,

    /// Specific physiologic benefits associated to the plan.
    pub physiological_benefits_prop_enum: Option<Text>,

    /// Specific physiologic risks associated to the diet plan.
    pub risks_prop_enum: Option<Text>,
}
