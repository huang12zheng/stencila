...
/// * COMMENT: A strategy of regulating the intake of food to achieve or maintain a specific health-related goal. * EXTEND FROM: https://schema.org/CreativeWork, https://schema.org/LifestyleModification
...
pub struct DietOptions {
    ...
    pub diet_features: Option<Diet>,

    /// People or organizations that endorse the plan.
    pub endorsers: Option<Diet>,

    /// Medical expert advice related to the plan.
    pub expert_considerations: Option<Diet>,

    /// Specific physiologic benefits associated to the plan.
    pub physiological_benefits: Option<Diet>,

    /// Specific physiologic risks associated to the diet plan.
    pub risks: Option<Diet>,
}
