...
/// * COMMENT: Dietetics and nutrition as a medical specialty. * EXTEND FROM: https://schema.org/MedicalBusiness, https://schema.org/MedicalSpecialty * ENUMERATION FROM: https://schema.org/MedicalSpecialty
...
pub struct DietNutrition {
    ...
    #[serde(flatten)]
    pub options: Box<DietNutritionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DietNutritionOptions {
