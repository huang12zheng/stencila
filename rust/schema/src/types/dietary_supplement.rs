...
use super::is_proprietary::isProprietary;
...
/// * COMMENT: A product taken by mouth that contains a dietary ingredient intended to supplement the diet. Dietary ingredients may include vitamins, minerals, herbs or other botanicals, amino acids, and substances such as enzymes, organ tissues, glandulars and metabolites. * EXTEND FROM: https://schema.org/Product, https://schema.org/Substance
...
pub struct DietarySupplement {
    ...
    #[serde(flatten)]
    pub options: Box<DietarySupplementOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DietarySupplementOptions {
    ...
    pub is_proprietary: Option<isProprietary>,

    /// The specific biochemical interaction through which this drug or supplement produces its pharmacological effect.
    pub mechanism_of_action: Option<mechanismOfAction>,

    /// The generic name of this drug or supplement.
    pub non_proprietary_name: Option<nonProprietaryName>,

    /// Proprietary name given to the diet plan, typically by its originator or creator.
    pub proprietary_name: Option<proprietaryName>,

    /// Recommended intake of this supplement for a given population as defined by a specific recommending authority.
    pub recommended_intake: Option<DietarySupplement>,

    /// Any potential safety concern associated with the supplement. May include interactions with other drugs and foods, pregnancy, breastfeeding, known adverse reactions, and documented efficacy of the supplement.
    pub safety_consideration: Option<DietarySupplement>,
