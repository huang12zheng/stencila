...
/// * COMMENT: An electronic file or document. * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/NoteDigitalDocument, https://schema.org/PresentationDigitalDocument, https://schema.org/SpreadsheetDigitalDocument, https://schema.org/TextDigitalDocument
...
pub struct DigitalDocument {
    ...
    #[serde(flatten)]
    pub options: Box<DigitalDocumentOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DigitalDocumentOptions {
    ...
    pub has_digital_document_permission: Option<DigitalDocument>,
}

impl DigitalDocument {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
