...
/// * LOOK ALSO:
/// https://schema.org/NoteDigitalDocument, https://schema.org/PresentationDigitalDocument, https://schema.org/SpreadsheetDigitalDocument, https://schema.org/TextDigitalDocument
...
pub struct DigitalDocument {
    ...
    pub has_digital_document_permission_prop_enum: Option<DigitalDocumentPermission>,
}
