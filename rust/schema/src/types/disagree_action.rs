...
/// * COMMENT: The act of expressing a difference of opinion with the object. An agent disagrees to/about an object (a proposition, topic or theme) with participants. * EXTEND FROM: https://schema.org/ReactAction
...
pub struct DisagreeAction {
    ...
    #[serde(flatten)]
    pub options: Box<DisagreeActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DisagreeActionOptions {
