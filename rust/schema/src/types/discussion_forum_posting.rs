...
/// * COMMENT: A posting to a discussion forum. * EXTEND FROM: https://schema.org/SocialMediaPosting
...
pub struct DiscussionForumPosting {
    ...
    #[serde(flatten)]
    pub options: Box<DiscussionForumPostingOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DiscussionForumPostingOptions {
