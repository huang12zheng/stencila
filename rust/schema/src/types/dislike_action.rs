...
/// * COMMENT: The act of expressing a negative sentiment about the object. An agent dislikes an object (a proposition, topic or theme) with participants. * EXTEND FROM: https://schema.org/ReactAction
...
pub struct DislikeAction {
    ...
    #[serde(flatten)]
    pub options: Box<DislikeActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DislikeActionOptions {
