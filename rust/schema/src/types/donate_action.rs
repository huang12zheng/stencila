...
/// * COMMENT: The act of providing goods, services, or money without compensation, often for philanthropic reasons. * EXTEND FROM: https://schema.org/TradeAction
...
pub struct DonateAction {
    ...
    #[serde(flatten)]
    pub options: Box<DonateActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DonateActionOptions {
