...
/// * COMMENT: A specific dosing schedule for a drug or supplement. * EXTEND FROM: https://schema.org/MedicalIntangible * LOOK ALSO: https://schema.org/MaximumDoseSchedule, https://schema.org/RecommendedDoseSchedule, https://schema.org/ReportedDoseSchedule
...
pub struct DoseSchedule {
    ...
    #[serde(flatten)]
    pub options: Box<DoseScheduleOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DoseScheduleOptions {
