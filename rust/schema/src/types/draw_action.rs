...
/// * COMMENT: The act of producing a visual/graphical representation of an object, typically with a pen/pencil and paper as instruments. * EXTEND FROM: https://schema.org/CreateAction
...
pub struct DrawAction {
    ...
    #[serde(flatten)]
    pub options: Box<DrawActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DrawActionOptions {
