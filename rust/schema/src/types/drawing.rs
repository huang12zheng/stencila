...
/// * MOD OF: https://pending.schema.org * COMMENT: A picture or diagram made with a pencil, pen, or crayon rather than paint. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct Drawing {
    ...
    #[serde(flatten)]
    pub options: Box<DrawingOptions>,
}
