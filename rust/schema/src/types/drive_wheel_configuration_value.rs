...
/// * COMMENT: A value indicating which roadwheels will receive torque. * EXTEND FROM: https://schema.org/QualitativeValue
...
pub struct DriveWheelConfigurationValue {
    ...
    #[serde(flatten)]
    pub options: Box<DriveWheelConfigurationValueOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DriveWheelConfigurationValueOptions {
...
impl DriveWheelConfigurationValue {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
