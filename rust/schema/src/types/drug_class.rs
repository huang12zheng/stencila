...
/// * COMMENT: A class of medical drugs, e.g., statins. Classes can represent general pharmacological class, common mechanisms of action, common physiological effects, etc. * EXTEND FROM: https://schema.org/MedicalEntity
...
pub struct DrugClass {
    ...
    #[serde(flatten)]
    pub options: Box<DrugClassOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DrugClassOptions {
