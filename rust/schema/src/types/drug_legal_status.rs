...
/// * COMMENT: The legal availability status of a medical drug. * EXTEND FROM: https://schema.org/MedicalIntangible
...
pub struct DrugLegalStatus {
    ...
    #[serde(flatten)]
    pub options: Box<DrugLegalStatusOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct DrugLegalStatusOptions {
    ...
    pub applicable_location: Option<AdministrativeArea>,
}

impl DrugLegalStatus {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
