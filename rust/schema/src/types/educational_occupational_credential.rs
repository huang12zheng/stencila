...
use super::competency_required::competencyRequired;
...
use super::valid_for::validFor;
use super::valid_in::validIn;

/// * MOD OF: https://pending.schema.org * COMMENT: An educational or occupational credential. A diploma, academic degree, certification, qualification, badge, etc., that may be awarded to a person or other entity that meets the requirements defined by the credentialer. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct EducationalOccupationalCredential {
    ...
    #[serde(flatten)]
    pub options: Box<EducationalOccupationalCredentialOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct EducationalOccupationalCredentialOptions {
    ...
    pub competency_required: Option<competencyRequired>,

    /// The category or type of credential being described, for example "degree”, “certificate”, “badge”, or more specific term.
    pub credential_category: Option<EducationalOccupationalCredential>,

    /// An organization that acknowledges the validity, value or utility of a credential. Note: recognition may include a process of quality assurance or accreditation.
    pub recognized_by: Option<EducationalOccupationalCredential>,

    /// The duration of validity of a permit or similar thing.
    pub valid_for: Option<validFor>,

    /// The geographic area where a permit or similar thing is valid.
    pub valid_in: Option<validIn>,
}

impl EducationalOccupationalCredential {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
