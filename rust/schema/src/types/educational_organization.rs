...
/// * EXTEND FROM:
/// https://schema.org/CivicStructure, https://schema.org/Organization
/// * LOOK ALSO:
/// https://schema.org/CollegeOrUniversity, https://schema.org/ElementarySchool, https://schema.org/HighSchool, https://schema.org/MiddleSchool, https://schema.org/Preschool, https://schema.org/School
