...
/// * COMMENT: An educational organization. * EXTEND FROM: https://schema.org/CivicStructure, https://schema.org/Organization * LOOK ALSO: https://schema.org/CollegeOrUniversity, https://schema.org/ElementarySchool, https://schema.org/HighSchool, https://schema.org/MiddleSchool, https://schema.org/Preschool, https://schema.org/School
...
pub struct EducationalOrganization {
    ...
    #[serde(flatten)]
    pub options: Box<EducationalOrganizationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct EducationalOrganizationOptions {
