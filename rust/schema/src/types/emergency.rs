...
/// * COMMENT: A specific branch of medical science that deals with the evaluation and initial treatment of medical conditions caused by trauma or sudden illness. * EXTEND FROM: https://schema.org/MedicalBusiness, https://schema.org/MedicalSpecialty * ENUMERATION FROM: https://schema.org/MedicalSpecialty
...
pub struct Emergency {
    ...
    #[serde(flatten)]
    pub options: Box<EmergencyOptions>,
}
