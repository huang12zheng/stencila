...
/// * COMMENT: An emergency service, such as a fire station or ER. * EXTEND FROM: https://schema.org/LocalBusiness * LOOK ALSO: https://schema.org/FireStation, https://schema.org/Hospital, https://schema.org/PoliceStation
...
pub struct EmergencyService {
    ...
    #[serde(flatten)]
    pub options: Box<EmergencyServiceOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct EmergencyServiceOptions {
