...
/// * MOD OF: https://pending.schema.org * COMMENT: An <a class="localLink" href="/EmployerReview">EmployerReview</a> is a review of an <a class="localLink" href="/Organization">Organization</a> regarding its role as an employer, written by a current or former employee of that organization. * EXTEND FROM: https://schema.org/Review
...
pub struct EmployerReview {
    ...
    #[serde(flatten)]
    pub options: Box<EmployerReviewOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct EmployerReviewOptions {
