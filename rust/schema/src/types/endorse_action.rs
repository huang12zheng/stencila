...
/// * COMMENT: An agent approves/certifies/likes/supports/sanctions an object. * EXTEND FROM: https://schema.org/ReactAction
...
pub struct EndorseAction {
    ...
    #[serde(flatten)]
    pub options: Box<EndorseActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct EndorseActionOptions {
