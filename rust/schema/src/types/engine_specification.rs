...
use super::text::Text;
use super::url::URL;
use super::engine_type::engineType;
...
pub struct EngineSpecificationOptions {
    ...
    pub engine_displacement: Option<QuantitativeValue>,
    ...
    pub engine_power: Option<QuantitativeValue>,
    ...
    pub torque: Option<QuantitativeValue>,
}
