...
/// * COMMENT: A business providing entertainment. * EXTEND FROM: https://schema.org/LocalBusiness * LOOK ALSO: https://schema.org/AdultEntertainment, https://schema.org/AmusementPark, https://schema.org/ArtGallery, https://schema.org/Casino, https://schema.org/ComedyClub, https://schema.org/MovieTheater, https://schema.org/NightClub
...
pub struct EntertainmentBusiness {
    ...
    #[serde(flatten)]
    pub options: Box<EntertainmentBusinessOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct EntertainmentBusinessOptions {
