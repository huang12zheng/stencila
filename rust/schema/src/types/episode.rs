...
/// * COMMENT: A media episode (e.g. TV, radio, video game) which can be part of a series or season. * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/PodcastEpisode, https://schema.org/RadioEpisode, https://schema.org/TVEpisode
...
pub struct Episode {
    ...
    #[serde(flatten)]
    pub options: Box<EpisodeOptions>,
}
