...
use super::exchange_rate_spread_prop_enum::ExchangeRateSpreadPropEnum;
...
pub struct ExchangeRateSpecification {
    ...
    pub current_exchange_rate_prop_enum: Option<UnitPriceSpecification>,

    /// The difference between the price at which a broker or other intermediary buys and sells foreign currency.
    pub exchange_rate_spread_prop_enum: Option<ExchangeRateSpreadPropEnum>,
}
