...
/// * COMMENT: Fitness-related activity designed for a specific health-related purpose, including defined exercise routines as well as activity prescribed by a clinician. * EXTEND FROM: https://schema.org/CreativeWork, https://schema.org/PhysicalActivity
...
pub struct ExercisePlan {
    ...
    #[serde(flatten)]
    pub options: Box<ExercisePlanOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ExercisePlanOptions {
    ...
    pub activity_duration: Option<ExercisePlan>,

    /// How often one should engage in the activity.
    pub activity_frequency: Option<ExercisePlan>,

    /// Any additional component of the exercise prescription that may need to be articulated to the patient. This may include the order of exercises, the number of repetitions of movement, quantitative distance, progressions over time, etc.
    pub additional_variable: Option<ExercisePlan>,

    /// Type(s) of exercise or activity, such as strength training, flexibility training, aerobics, cardiac rehabilitation, etc.
    pub exercise_type: Option<exerciseType>,

    /// Quantitative measure gauging the degree of force involved in the exercise, for example, heartbeats per minute. May include the velocity of the movement.
    pub intensity: Option<ExercisePlan>,

    /// Number of times one should repeat the activity.
    pub repetitions: Option<ExercisePlan>,

    /// How often one should break from the activity.
    pub rest_periods: Option<ExercisePlan>,

    /// Quantitative measure of the physiologic output of the exercise; also referred to as energy expenditure.
    pub workload: Option<ExercisePlan>,
}
