...
use super::activity_duration::activityDuration;
use super::activity_frequency::activityFrequency;
...
use super::repetitions::repetitions;
use super::rest_periods::restPeriods;
...
pub struct ExercisePlanOptions {
    ...
    pub repetitions: Option<repetitions>,

    /// How often one should break from the activity.
    pub rest_periods: Option<restPeriods>,
