...
/// * COMMENT: Event type: Exhibition event, e.g. at a museum, library, archive, tradeshow, ... * EXTEND FROM: https://schema.org/Event
...
pub struct ExhibitionEvent {
    ...
    #[serde(flatten)]
    pub options: Box<ExhibitionEventOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ExhibitionEventOptions {
