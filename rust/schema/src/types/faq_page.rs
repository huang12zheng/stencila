...
/// * COMMENT: A <a class="localLink" href="/FAQPage">FAQPage</a> is a <a class="localLink" href="/WebPage">WebPage</a> presenting one or more "<a href="https://en.wikipedia.org/wiki/FAQ">Frequently asked questions</a>" (see also <a class="localLink" href="/QAPage">QAPage</a>). * EXTEND FROM: https://schema.org/WebPage
...
pub struct FAQPage {
    ...
    #[serde(flatten)]
    pub options: Box<FAQPageOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct FAQPageOptions {
    ...
    pub breadcrumb: Option<WebPage>,

    /// Date on which the content on this web page was last reviewed for accuracy and/or completeness.
    pub last_reviewed: Option<WebPage>,

    /// Indicates if this web page element is the main subject of the page.
    pub main_content_of_page: Option<WebPage>,

    /// Indicates the main image on the page.
    pub primary_image_of_page: Option<WebPage>,

    /// A link related to this web page, for example to other related web pages.
    pub related_link: Option<WebPage>,

    /// People or organizations that have reviewed the content on this web page for accuracy and/or completeness.
    pub reviewed_by: Option<WebPage>,

    /// One of the more significant URLs on the page. Typically, these are the non-navigation links that are clicked on the most.
    pub significant_link: Option<WebPage>,
