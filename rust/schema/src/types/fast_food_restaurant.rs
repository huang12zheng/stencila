...
use super::text::Text;
use super::url::URL;
use super::accepts_reservations::acceptsReservations;
...
/// * COMMENT: A fast-food restaurant. * EXTEND FROM: https://schema.org/FoodEstablishment
...
pub struct FastFoodRestaurant {
    ...
    #[serde(flatten)]
    pub options: Box<FastFoodRestaurantOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct FastFoodRestaurantOptions {
    ...
    pub accepts_reservations: Option<acceptsReservations>,

    /// Either the actual menu as a structured representation, as text, or a URL of the menu.
    pub has_menu: Option<hasMenu>,

    /// The cuisine of the restaurant.
    pub serves_cuisine: Option<Text>,

    /// An official rating for a lodging business or food establishment, e.g. from national associations or standards bodies. Use the author property to indicate the rating organization, e.g. as an Organization with name such as (e.g. HOTREC, DEHOGA, WHR, or Hotelstars).
    pub star_rating: Option<Rating>,
}

impl FastFoodRestaurant {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
