...
/// * COMMENT: The act of capturing sound and moving images on film, video, or digitally. * EXTEND FROM: https://schema.org/CreateAction
...
pub struct FilmAction {
    ...
    #[serde(flatten)]
    pub options: Box<FilmActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct FilmActionOptions {
