...
/// * COMMENT: Financial services business. * EXTEND FROM: https://schema.org/LocalBusiness * LOOK ALSO: https://schema.org/AccountingService, https://schema.org/AutomatedTeller, https://schema.org/BankOrCreditUnion, https://schema.org/InsuranceAgency
...
pub struct FinancialService {
    ...
    #[serde(flatten)]
    pub options: Box<FinancialServiceOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct FinancialServiceOptions {
