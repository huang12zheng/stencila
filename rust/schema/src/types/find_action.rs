...
/// * COMMENT: The act of finding an object.<br/><br/>  Related actions:<br/><br/>  <ul> <li><a class="localLink" href="/SearchAction">SearchAction</a>: FindAction is generally lead by a SearchAction, but not necessarily.</li> </ul> * EXTEND FROM: https://schema.org/Action * LOOK ALSO: https://schema.org/CheckAction, https://schema.org/DiscoverAction, https://schema.org/TrackAction
...
pub struct FindAction {
    ...
    #[serde(flatten)]
    pub options: Box<FindActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct FindActionOptions {
