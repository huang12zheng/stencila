...
/// * COMMENT: A fire station. With firemen. * EXTEND FROM: https://schema.org/CivicStructure, https://schema.org/EmergencyService
...
pub struct FireStation {
    ...
    #[serde(flatten)]
    pub options: Box<FireStationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct FireStationOptions {
