...
pub struct FlightReservationOptions {
    ...
    pub boarding_group: Option<FlightReservation>,

    /// The priority status assigned to a passenger for security or boarding (e.g. FastTrack or Priority).
    pub passenger_priority_status: Option<FlightReservation>,

    /// The passenger's sequence number as assigned by the airline.
    pub passenger_sequence_number: Option<FlightReservation>,

    /// The type of security screening the passenger is subject to.
    pub security_screening: Option<FlightReservation>,
}
