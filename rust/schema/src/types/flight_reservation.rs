...
use super::passenger_priority_status_prop_enum::PassengerPriorityStatusPropEnum;
...
pub struct FlightReservation {
    ...
    pub boarding_group_prop_enum: Option<Text>,

    /// The priority status assigned to a passenger for security or boarding (e.g. FastTrack or Priority).
    pub passenger_priority_status_prop_enum: Option<PassengerPriorityStatusPropEnum>,

    /// The passenger's sequence number as assigned by the airline.
    pub passenger_sequence_number_prop_enum: Option<Text>,

    /// The type of security screening the passenger is subject to.
    pub security_screening_prop_enum: Option<Text>,
}
