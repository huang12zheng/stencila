...
use super::passenger_priority_status::passengerPriorityStatus;
use super::provider::provider;
use super::subject_of::subjectOf;
use super::total_price::totalPrice;
use super::under_name::underName;

/// * COMMENT: A reservation for air travel.<br/><br/>  Note: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations. For offers of tickets, use <a class="localLink" href="/Offer">Offer</a>. * EXTEND FROM: https://schema.org/Reservation
...
pub struct FlightReservation {
    ...
    #[serde(flatten)]
    pub options: Box<FlightReservationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct FlightReservationOptions {
    ...
    pub boarding_group: Option<Text>,

    /// The priority status assigned to a passenger for security or boarding (e.g. FastTrack or Priority).
    pub passenger_priority_status: Option<passengerPriorityStatus>,

    /// The passenger's sequence number as assigned by the airline.
    pub passenger_sequence_number: Option<Text>,

    /// The type of security screening the passenger is subject to.
    pub security_screening: Option<Text>,
}
