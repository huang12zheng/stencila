...
/// * COMMENT: A food-related business. * EXTEND FROM: https://schema.org/LocalBusiness * LOOK ALSO: https://schema.org/Bakery, https://schema.org/BarOrPub, https://schema.org/Brewery, https://schema.org/CafeOrCoffeeShop, https://schema.org/Distillery, https://schema.org/FastFoodRestaurant, https://schema.org/IceCreamShop, https://schema.org/Restaurant, https://schema.org/Winery
...
pub struct FoodEstablishment {
    ...
    #[serde(flatten)]
    pub options: Box<FoodEstablishmentOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct FoodEstablishmentOptions {
    ...
    pub accepts_reservations: Option<FoodEstablishment>,

    /// Either the actual menu as a structured representation, as text, or a URL of the menu.
    pub has_menu: Option<FoodEstablishment>,

    /// The cuisine of the restaurant.
    pub serves_cuisine: Option<FoodEstablishment>,
