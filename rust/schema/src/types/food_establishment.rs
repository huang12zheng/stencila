...
use super::accepts_reservations_prop_enum::AcceptsReservationsPropEnum;
...
use super::has_menu_prop_enum::HasMenuPropEnum;
...
/// * LOOK ALSO:
/// https://schema.org/Bakery, https://schema.org/BarOrPub, https://schema.org/Brewery, https://schema.org/CafeOrCoffeeShop, https://schema.org/Distillery, https://schema.org/FastFoodRestaurant, https://schema.org/IceCreamShop, https://schema.org/Restaurant, https://schema.org/Winery
...
pub struct FoodEstablishment {
    ...
    pub accepts_reservations_prop_enum: Option<AcceptsReservationsPropEnum>,

    /// Either the actual menu as a structured representation, as text, or a URL of the menu.
    pub has_menu_prop_enum: Option<HasMenuPropEnum>,

    /// The cuisine of the restaurant.
    pub serves_cuisine_prop_enum: Option<Text>,

    /// An official rating for a lodging business or food establishment, e.g. from national associations or standards bodies. Use the author property to indicate the rating organization, e.g. as an Organization with name such as (e.g. HOTREC, DEHOGA, WHR, or Hotelstars).
    pub star_rating_prop_enum: Option<Rating>,
}

impl FoodEstablishment {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
