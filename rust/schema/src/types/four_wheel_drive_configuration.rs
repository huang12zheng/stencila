...
/// * COMMENT: Four-wheel drive is a transmission layout where the engine primarily drives two wheels with a part-time four-wheel drive capability. * EXTEND FROM: https://schema.org/DriveWheelConfigurationValue * ENUMERATION FROM: https://schema.org/DriveWheelConfigurationValue
#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct FourWheelDriveConfiguration {
    

    /// Non-core optional fields
    #[serde(flatten)]
    pub options: Box<FourWheelDriveConfigurationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct FourWheelDriveConfigurationOptions {
...
impl FourWheelDriveConfiguration {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
