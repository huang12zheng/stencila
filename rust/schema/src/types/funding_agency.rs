...
/// * MOD OF: https://pending.schema.org * COMMENT: A FundingAgency is an organization that implements one or more <a class="localLink" href="/FundingScheme">FundingScheme</a>s and manages     the granting process (via <a class="localLink" href="/Grant">Grant</a>s, typically <a class="localLink" href="/MonetaryGrant">MonetaryGrant</a>s).     A funding agency is not always required for grant funding, e.g. philanthropic giving, corporate sponsorship etc.<br/><br/>  Examples of funding agencies include ERC, REA, NIH, Bill and Melinda Gates Foundation, ... * EXTEND FROM: https://schema.org/Project
...
pub struct FundingAgency {
    ...
    #[serde(flatten)]
    pub options: Box<FundingAgencyOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct FundingAgencyOptions {
