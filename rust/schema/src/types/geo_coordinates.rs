...
/// * COMMENT: The geographic coordinates of a place or event. * EXTEND FROM: https://schema.org/StructuredValue
...
pub struct GeoCoordinates {
    ...
    #[serde(flatten)]
    pub options: Box<GeoCoordinatesOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct GeoCoordinatesOptions {
