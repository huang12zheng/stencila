...
/// * COMMENT: A government building. * EXTEND FROM: https://schema.org/CivicStructure * LOOK ALSO: https://schema.org/CityHall, https://schema.org/Courthouse, https://schema.org/DefenceEstablishment, https://schema.org/Embassy, https://schema.org/LegislativeBuilding
...
pub struct GovernmentBuilding {
    ...
    #[serde(flatten)]
    pub options: Box<GovernmentBuildingOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct GovernmentBuildingOptions {
