...
/// * COMMENT: A government office&#x2014;for example, an IRS or DMV office. * EXTEND FROM: https://schema.org/LocalBusiness * LOOK ALSO: https://schema.org/PostOffice
...
pub struct GovernmentOffice {
    ...
    #[serde(flatten)]
    pub options: Box<GovernmentOfficeOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct GovernmentOfficeOptions {
