...
/// * COMMENT: A governmental organization or agency. * EXTEND FROM: https://schema.org/Organization
...
pub struct GovernmentOrganization {
    ...
    #[serde(flatten)]
    pub options: Box<GovernmentOrganizationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct GovernmentOrganizationOptions {
