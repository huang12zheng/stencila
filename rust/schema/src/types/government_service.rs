...
/// * COMMENT: A service provided by a government organization, e.g. food stamps, veterans benefits, etc. * EXTEND FROM: https://schema.org/Service
...
pub struct GovernmentService {
    ...
    #[serde(flatten)]
    pub options: Box<GovernmentServiceOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct GovernmentServiceOptions {
    ...
    pub service_operator: Option<GovernmentService>,
}
