...
/// * MOD OF: https://pending.schema.org * COMMENT: A <a href="https://en.wikipedia.org/wiki/Hackathon">hackathon</a> event. * EXTEND FROM: https://schema.org/Event
...
pub struct Hackathon {
    ...
    #[serde(flatten)]
    pub options: Box<HackathonOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct HackathonOptions {
