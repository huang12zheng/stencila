...
/// * COMMENT: Health and beauty. * EXTEND FROM: https://schema.org/LocalBusiness * LOOK ALSO: https://schema.org/BeautySalon, https://schema.org/DaySpa, https://schema.org/HairSalon, https://schema.org/HealthClub, https://schema.org/NailSalon, https://schema.org/TattooParlor
...
pub struct HealthAndBeautyBusiness {
    ...
    #[serde(flatten)]
    pub options: Box<HealthAndBeautyBusinessOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct HealthAndBeautyBusinessOptions {
