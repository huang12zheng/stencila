...
/// * COMMENT: A health club. * EXTEND FROM: https://schema.org/HealthAndBeautyBusiness, https://schema.org/SportsActivityLocation
...
pub struct HealthClub {
    ...
    #[serde(flatten)]
    pub options: Box<HealthClubOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct HealthClubOptions {
