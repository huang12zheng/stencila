...
pub struct HealthPlanCostSharingSpecificationOptions {
    ...
    pub health_plan_coinsurance_option: Option<Text>,

    /// The rate of coinsurance expressed as a number between 0.0 and 1.0.
    pub health_plan_coinsurance_rate: Option<Number>,

    /// The copay amount.
    pub health_plan_copay: Option<PriceSpecification>,

    /// Whether the copay is before or after deductible, etc. TODO: Is this a closed set?
    pub health_plan_copay_option: Option<Text>,

    /// The category or type of pharmacy associated with this cost sharing.
    pub health_plan_pharmacy_category: Option<Text>,
}
