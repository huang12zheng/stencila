...
pub struct HealthTopicContent {
    ...
    #[serde(flatten)]
    pub options: Box<HealthTopicContentOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct HealthTopicContentOptions {
    ...
    pub has_health_aspect: Option<HealthTopicContent>,
}

impl HealthTopicContent {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
