...
/// * COMMENT: A store that sells materials useful or necessary for various hobbies. * EXTEND FROM: https://schema.org/Store
...
pub struct HobbyShop {
    ...
    #[serde(flatten)]
    pub options: Box<HobbyShopOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct HobbyShopOptions {
