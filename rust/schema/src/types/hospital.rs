...
use super::available_service_prop_enum::AvailableServicePropEnum;
...
use super::healthcare_reporting_data_prop_enum::HealthcareReportingDataPropEnum;
...
/// A hospital.
/// * EXTEND FROM:
/// https://schema.org/CivicStructure, https://schema.org/EmergencyService, https://schema.org/MedicalOrganization
...
pub struct Hospital {
    ...
    pub health_plan_network_id_prop_enum: Option<Text>,

    /// Whether the provider is accepting new patients.
    pub is_accepting_new_patients_prop_enum: Option<Boolean>,

    /// A medical specialty of the provider.
    pub medical_specialty_prop_enum: Option<MedicalSpecialty>,

    /// A medical service available from this provider.
    pub available_service_prop_enum: Option<AvailableServicePropEnum>,
    ...
    pub healthcare_reporting_data_prop_enum: Option<HealthcareReportingDataPropEnum>,
}
