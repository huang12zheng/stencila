...
/// * COMMENT: A hospital. * EXTEND FROM: https://schema.org/CivicStructure, https://schema.org/EmergencyService, https://schema.org/MedicalOrganization
...
pub struct Hospital {
    ...
    #[serde(flatten)]
    pub options: Box<HospitalOptions>,
}
...
pub struct HospitalOptions {
    ...
    pub healthcare_reporting_data: Option<Hospital>,
}
