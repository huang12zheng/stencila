...
/// * COMMENT: A house is a building or structure that has the ability to be occupied for habitation by humans or other creatures (source: Wikipedia, the free encyclopedia, see <a href="http://en.wikipedia.org/wiki/House">http://en.wikipedia.org/wiki/House</a>). * EXTEND FROM: https://schema.org/Accommodation * LOOK ALSO: https://schema.org/SingleFamilyResidence
...
pub struct House {
    ...
    #[serde(flatten)]
    pub options: Box<HouseOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct HouseOptions {
