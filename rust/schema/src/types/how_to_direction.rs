...
use super::perform_time::performTime;
use super::position::position;
use super::prep_time::prepTime;
...
use super::tool::tool;
use super::total_time::totalTime;
use super::translator::translator;
use super::typical_age_range::typicalAgeRange;

/// * COMMENT: A direction indicating a single action to do in the instructions for how to achieve a result. * EXTEND FROM: https://schema.org/CreativeWork, https://schema.org/ListItem
...
pub struct HowToDirection {
    ...
    #[serde(flatten)]
    pub options: Box<HowToDirectionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct HowToDirectionOptions {
    ...
    pub after_media: Option<HowToDirection>,

    /// A media object representing the circumstances before performing this direction.
    pub before_media: Option<HowToDirection>,

    /// A media object representing the circumstances while performing this direction.
    pub during_media: Option<HowToDirection>,
    ...
    pub perform_time: Option<performTime>,
