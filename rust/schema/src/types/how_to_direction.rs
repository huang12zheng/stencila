...
use super::after_media_prop_enum::AfterMediaPropEnum;
...
use super::before_media_prop_enum::BeforeMediaPropEnum;
...
use super::during_media_prop_enum::DuringMediaPropEnum;
...
/// * EXTEND FROM:
/// https://schema.org/CreativeWork, https://schema.org/ListItem
...
pub struct HowToDirection {
    ...
    pub after_media_prop_enum: Option<AfterMediaPropEnum>,

    /// A media object representing the circumstances before performing this direction.
    pub before_media_prop_enum: Option<BeforeMediaPropEnum>,

    /// A media object representing the circumstances while performing this direction.
    pub during_media_prop_enum: Option<DuringMediaPropEnum>,
