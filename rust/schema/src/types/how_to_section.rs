...
/// * COMMENT: A sub-grouping of steps in the instructions for how to achieve a result (e.g. steps for making a pie crust within a pie recipe). * EXTEND FROM: https://schema.org/CreativeWork, https://schema.org/ItemList, https://schema.org/ListItem
...
pub struct HowToSection {
    ...
    #[serde(flatten)]
    pub options: Box<HowToSectionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct HowToSectionOptions {
    ...
    pub item_list_element: Option<ItemList>,

    /// Type of ordering (e.g. Ascending, Descending, Unordered).
    pub item_list_order: Option<ItemList>,

    /// The number of items in an ItemList. Note that some descriptions might not fully describe all items in a list (e.g., multi-page pagination); in such cases, the numberOfItems would be for the entire list.
    pub number_of_items: Option<ItemList>,
