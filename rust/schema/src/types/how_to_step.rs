...
/// * COMMENT: A step in the instructions for how to achieve a result. It is an ordered list with HowToDirection and/or HowToTip items. * EXTEND FROM: https://schema.org/CreativeWork, https://schema.org/ItemList, https://schema.org/ListItem
...
pub struct HowToStep {
    ...
    #[serde(flatten)]
    pub options: Box<HowToStepOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct HowToStepOptions {
