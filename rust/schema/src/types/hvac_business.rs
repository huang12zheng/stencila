...
/// * COMMENT: A business that provides Heating, Ventilation and Air Conditioning services. * EXTEND FROM: https://schema.org/HomeAndConstructionBusiness
...
pub struct HVACBusiness {
    ...
    #[serde(flatten)]
    pub options: Box<HVACBusinessOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct HVACBusinessOptions {
