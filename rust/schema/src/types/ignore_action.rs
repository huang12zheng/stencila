...
/// * COMMENT: The act of intentionally disregarding the object. An agent ignores an object. * EXTEND FROM: https://schema.org/AssessAction
...
pub struct IgnoreAction {
    ...
    #[serde(flatten)]
    pub options: Box<IgnoreActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct IgnoreActionOptions {
