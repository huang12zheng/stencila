...
/// * MOD OF: https://pending.schema.org * COMMENT: A specific and exact (byte-for-byte) version of an <a class="localLink" href="/ImageObject">ImageObject</a>. Two byte-for-byte identical files, for the purposes of this type, considered identical. If they have different embedded metadata (e.g. XMP, EXIF) the files will differ. Different external facts about the files, e.g. creator or dateCreated that aren't represented in their actual content, do not affect this notion of identity. * EXTEND FROM: https://schema.org/ImageObject
...
pub struct ImageObjectSnapshot {
    ...
    #[serde(flatten)]
    pub options: Box<ImageObjectSnapshotOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ImageObjectSnapshotOptions {
    ...
    pub exif_data: Option<ImageObject>,

    /// Indicates whether this image is representative of the content of the page.
    pub representative_of_page: Option<ImageObject>,

    /// Thumbnail image for an image or video.
    pub thumbnail: Option<thumbnail>,
}

impl ImageObjectSnapshot {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
