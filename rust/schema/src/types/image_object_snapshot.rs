...
use super::exif_data_prop_enum::ExifDataPropEnum;
...
/// * COMMENT:
/// A specific and exact (byte-for-byte) version of an <a class="localLink" href="/ImageObject">ImageObject</a>. Two byte-for-byte identical files, for the purposes of this type, considered identical. If they have different embedded metadata (e.g. XMP, EXIF) the files will differ. Different external facts about the files, e.g. creator or dateCreated that aren't represented in their actual content, do not affect this notion of identity.
/// * EXTEND FROM:
...
pub struct ImageObjectSnapshot {
    ...
    pub exif_data_prop_enum: Option<ExifDataPropEnum>,

    /// Indicates whether this image is representative of the content of the page.
    pub representative_of_page_prop_enum: Option<Boolean>,
