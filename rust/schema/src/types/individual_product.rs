...
/// * COMMENT: A single, identifiable product instance (e.g. a laptop with a particular serial number). * EXTEND FROM: https://schema.org/Product
...
pub struct IndividualProduct {
    ...
    #[serde(flatten)]
    pub options: Box<IndividualProductOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct IndividualProductOptions {
