...
/// * COMMENT: The act of notifying someone of information pertinent to them, with no expectation of a response. * EXTEND FROM: https://schema.org/CommunicateAction * LOOK ALSO: https://schema.org/ConfirmAction, https://schema.org/RsvpAction
...
pub struct InformAction {
    ...
    #[serde(flatten)]
    pub options: Box<InformActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct InformActionOptions {
