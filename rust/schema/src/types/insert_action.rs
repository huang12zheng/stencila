...
/// * COMMENT: The act of adding at a specific location in an ordered collection. * EXTEND FROM: https://schema.org/AddAction * LOOK ALSO: https://schema.org/AppendAction, https://schema.org/PrependAction
...
pub struct InsertAction {
    ...
    #[serde(flatten)]
    pub options: Box<InsertActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct InsertActionOptions {
    ...
    pub target_collection: Option<UpdateAction>,
