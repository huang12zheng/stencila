...
/// * COMMENT: The act of interacting with another person or organization. * EXTEND FROM: https://schema.org/Action * LOOK ALSO: https://schema.org/BefriendAction, https://schema.org/CommunicateAction, https://schema.org/FollowAction, https://schema.org/JoinAction, https://schema.org/LeaveAction, https://schema.org/MarryAction, https://schema.org/RegisterAction, https://schema.org/SubscribeAction, https://schema.org/UnRegisterAction
...
pub struct InteractAction {
    ...
    #[serde(flatten)]
    pub options: Box<InteractActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct InteractActionOptions {
