...
/// * COMMENT: A type of financial product that typically requires the client to transfer funds to a financial service in return for potential beneficial financial return. * EXTEND FROM: https://schema.org/FinancialProduct * LOOK ALSO: https://schema.org/BrokerageAccount, https://schema.org/DepositAccount, https://schema.org/InvestmentFund
...
pub struct InvestmentOrDeposit {
    ...
    #[serde(flatten)]
    pub options: Box<InvestmentOrDepositOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct InvestmentOrDepositOptions {
