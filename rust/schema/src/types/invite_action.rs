...
/// * COMMENT: The act of asking someone to attend an event. Reciprocal of RsvpAction. * EXTEND FROM: https://schema.org/CommunicateAction
...
pub struct InviteAction {
    ...
    #[serde(flatten)]
    pub options: Box<InviteActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct InviteActionOptions {
