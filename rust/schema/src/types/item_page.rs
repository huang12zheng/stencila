...
/// * COMMENT: A page devoted to a single item, such as a particular product or hotel. * EXTEND FROM: https://schema.org/WebPage
...
pub struct ItemPage {
    ...
    #[serde(flatten)]
    pub options: Box<ItemPageOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ItemPageOptions {
