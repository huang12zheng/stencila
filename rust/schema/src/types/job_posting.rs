...
use super::hiring_organization::hiringOrganization;
use super::identifier::identifier;
use super::image::image;
use super::industry::industry;
use super::job_start_date::jobStartDate;
use super::main_entity_of_page::mainEntityOfPage;
use super::occupational_category::occupationalCategory;
use super::physical_requirement::physicalRequirement;
use super::qualifications::qualifications;
use super::security_clearance_requirement::securityClearanceRequirement;
use super::sensory_requirement::sensoryRequirement;
...
pub struct JobPostingOptions {
    ...
    pub applicant_location_requirements: Option<AdministrativeArea>,

    /// Contact details for further information relevant to this job posting.
    pub application_contact: Option<ContactPoint>,
    ...
    pub direct_apply: Option<Boolean>,

    /// Educational background needed for the position or Occupation.
    pub education_requirements: Option<educationRequirements>,

    /// The legal requirements such as citizenship, visa and other documentation required for an applicant to this job.
    pub eligibility_to_work_requirement: Option<Text>,

    /// A description of the employer, career opportunities and work environment for this position.
    pub employer_overview: Option<Text>,

    /// Type of employment (e.g. full-time, part-time, contract, temporary, seasonal, internship).
    pub employment_type: Option<Text>,

    /// Indicates the department, unit and/or facility where the employee reports and/or in which the job is to be performed.
    pub employment_unit: Option<Organization>,
    ...
    pub experience_in_place_of_education: Option<Boolean>,
    ...
    pub incentive_compensation: Option<Text>,

    /// The industry associated with the job position.
    pub industry: Option<industry>,

    /// Description of benefits associated with the job.
    pub job_benefits: Option<Text>,

    /// An indicator as to whether a position is available for an immediate start.
    pub job_immediate_start: Option<Boolean>,

    /// A (typically single) geographic location associated with the job position.
    pub job_location: Option<Place>,

    /// A description of the job location (e.g. TELECOMMUTE for telecommute jobs).
    pub job_location_type: Option<Text>,

    /// The date on which a successful applicant for this job would be expected to start work. Choose a specific date in the future or use the jobImmediateStart property to indicate the position is to be filled as soon as possible.
    pub job_start_date: Option<jobStartDate>,
