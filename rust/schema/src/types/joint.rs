...
use super::functional_class_prop_enum::FunctionalClassPropEnum;
...
pub struct Joint {
    ...
    pub biomechnical_class_prop_enum: Option<Text>,

    /// The degree of mobility the joint allows.
    pub functional_class_prop_enum: Option<FunctionalClassPropEnum>,

    /// The name given to how bone physically connects to each other.
    pub structural_class_prop_enum: Option<Text>,
}
