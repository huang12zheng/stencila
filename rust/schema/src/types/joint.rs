...
use super::text::Text;
use super::url::URL;
use super::functional_class::functionalClass;
...
/// * COMMENT: The anatomical location at which two or more bones make contact. * EXTEND FROM: https://schema.org/AnatomicalStructure
...
pub struct JointOptions {
    ...
    pub biomechnical_class: Option<Text>,

    /// The degree of mobility the joint allows.
    pub functional_class: Option<functionalClass>,

    /// The name given to how bone physically connects to each other.
    pub structural_class: Option<Text>,
}
