...
/// * COMMENT: An historical landmark or building. * EXTEND FROM: https://schema.org/Place
...
pub struct LandmarksOrHistoricalBuildings {
    ...
    #[serde(flatten)]
    pub options: Box<LandmarksOrHistoricalBuildingsOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct LandmarksOrHistoricalBuildingsOptions {
...
impl LandmarksOrHistoricalBuildings {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
