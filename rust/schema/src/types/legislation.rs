...
/// * MOD OF: https://pending.schema.org * COMMENT: A legal document such as an act, decree, bill, etc. (enforceable or not) or a component of a legal act (like an article). * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/LegislationObject
...
pub struct Legislation {
    ...
    #[serde(flatten)]
    pub options: Box<LegislationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct LegislationOptions {
