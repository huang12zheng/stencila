...
/// * COMMENT: A legislative building&#x2014;for example, the state capitol. * EXTEND FROM: https://schema.org/GovernmentBuilding
...
pub struct LegislativeBuilding {
    ...
    #[serde(flatten)]
    pub options: Box<LegislativeBuildingOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct LegislativeBuildingOptions {
