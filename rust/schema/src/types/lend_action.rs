...
/// * COMMENT: The act of providing an object under an agreement that it will be returned at a later date. Reciprocal of BorrowAction.<br/><br/>  Related actions:<br/><br/>  <ul> <li><a class="localLink" href="/BorrowAction">BorrowAction</a>: Reciprocal of LendAction.</li> </ul> * EXTEND FROM: https://schema.org/TransferAction
...
pub struct LendAction {
    ...
    #[serde(flatten)]
    pub options: Box<LendActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct LendActionOptions {
    ...
    pub borrower: Option<LendAction>,
}
