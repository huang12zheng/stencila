...
/// * MOD OF: https://pending.schema.org * COMMENT: A <a class="localLink" href="/LibrarySystem">LibrarySystem</a> is a collaborative system amongst several libraries. * EXTEND FROM: https://schema.org/Organization
...
pub struct LibrarySystem {
    ...
    #[serde(flatten)]
    pub options: Box<LibrarySystemOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct LibrarySystemOptions {
