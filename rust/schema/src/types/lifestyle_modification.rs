...
/// * COMMENT: A process of care involving exercise, changes to diet, fitness routines, and other lifestyle changes aimed at improving a health condition. * EXTEND FROM: https://schema.org/MedicalEntity * LOOK ALSO: https://schema.org/Diet, https://schema.org/PhysicalActivity
...
pub struct LifestyleModification {
    ...
    #[serde(flatten)]
    pub options: Box<LifestyleModificationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct LifestyleModificationOptions {
