...
/// * COMMENT: The act of expressing a positive sentiment about the object. An agent likes an object (a proposition, topic or theme) with participants. * EXTEND FROM: https://schema.org/ReactAction
...
pub struct LikeAction {
    ...
    #[serde(flatten)]
    pub options: Box<LikeActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct LikeActionOptions {
