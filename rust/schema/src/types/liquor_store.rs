...
/// * COMMENT: A shop that sells alcoholic drinks such as wine, beer, whisky and other spirits. * EXTEND FROM: https://schema.org/Store
...
pub struct LiquorStore {
    ...
    #[serde(flatten)]
    pub options: Box<LiquorStoreOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct LiquorStoreOptions {
