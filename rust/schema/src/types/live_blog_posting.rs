...
/// * COMMENT: A <a class="localLink" href="/LiveBlogPosting">LiveBlogPosting</a> is a <a class="localLink" href="/BlogPosting">BlogPosting</a> intended to provide a rolling textual coverage of an ongoing event through continuous updates. * EXTEND FROM: https://schema.org/BlogPosting
...
pub struct LiveBlogPosting {
    ...
    #[serde(flatten)]
    pub options: Box<LiveBlogPostingOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct LiveBlogPostingOptions {
    ...
    pub shared_content: Option<SocialMediaPosting>,

    /// The time when the live blog will stop covering the Event. Note that coverage may continue after the Event concludes.
    pub coverage_end_time: Option<LiveBlogPosting>,

    /// The time when the live blog will begin covering the Event. Note that coverage may begin before the Event's start time. The LiveBlogPosting may also be created before coverage begins.
    pub coverage_start_time: Option<LiveBlogPosting>,

    /// An update to the LiveBlog.
    pub live_blog_update: Option<LiveBlogPosting>,
}

impl LiveBlogPosting {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
