...
/// * COMMENT: A financial product for the loaning of an amount of money, or line of credit, under agreed terms and charges. * EXTEND FROM: https://schema.org/FinancialProduct * LOOK ALSO: https://schema.org/CreditCard, https://schema.org/MortgageLoan
...
pub struct LoanOrCredit {
    ...
    #[serde(flatten)]
    pub options: Box<LoanOrCreditOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct LoanOrCreditOptions {
