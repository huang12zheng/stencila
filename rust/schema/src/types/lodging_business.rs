...
/// * COMMENT: A lodging business, such as a motel, hotel, or inn. * EXTEND FROM: https://schema.org/LocalBusiness * LOOK ALSO: https://schema.org/BedAndBreakfast, https://schema.org/Campground, https://schema.org/Hostel, https://schema.org/Hotel, https://schema.org/Motel, https://schema.org/Resort
...
pub struct LodgingBusiness {
    ...
    #[serde(flatten)]
    pub options: Box<LodgingBusinessOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct LodgingBusinessOptions {
