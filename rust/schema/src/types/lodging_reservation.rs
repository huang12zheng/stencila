...
use super::checkin_time_prop_enum::CheckinTimePropEnum;
use super::checkout_time_prop_enum::CheckoutTimePropEnum;
use super::date_time::DateTime;
use super::identifier_prop_enum::IdentifierPropEnum;
use super::image_prop_enum::ImagePropEnum;
use super::lodging_unit_type_prop_enum::LodgingUnitTypePropEnum;
use super::main_entity_of_page_prop_enum::MainEntityOfPagePropEnum;
use super::num_adults_prop_enum::NumAdultsPropEnum;
use super::num_children_prop_enum::NumChildrenPropEnum;
...
pub struct LodgingReservation {
    ...
    pub checkin_time_prop_enum: Option<CheckinTimePropEnum>,

    /// The latest someone may check out of a lodging establishment.
    pub checkout_time_prop_enum: Option<CheckoutTimePropEnum>,

    /// A full description of the lodging unit.
    pub lodging_unit_description_prop_enum: Option<Text>,

    /// Textual description of the unit type (including suite vs. room, size of bed, etc.).
    pub lodging_unit_type_prop_enum: Option<LodgingUnitTypePropEnum>,

    /// The number of adults staying in the unit.
    pub num_adults_prop_enum: Option<NumAdultsPropEnum>,

    /// The number of children staying in the unit.
    pub num_children_prop_enum: Option<NumChildrenPropEnum>,
}
