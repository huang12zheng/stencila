...
pub struct LodgingReservationOptions {
    ...
    pub lodging_unit_description: Option<LodgingReservation>,

    /// Textual description of the unit type (including suite vs. room, size of bed, etc.).
    pub lodging_unit_type: Option<LodgingReservation>,

    /// The number of adults staying in the unit.
    pub num_adults: Option<LodgingReservation>,

    /// The number of children staying in the unit.
    pub num_children: Option<LodgingReservation>,
}
