...
/// * COMMENT: The act of being defeated in a competitive activity. * EXTEND FROM: https://schema.org/AchieveAction
...
pub struct LoseAction {
    ...
    #[serde(flatten)]
    pub options: Box<LoseActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct LoseActionOptions {
