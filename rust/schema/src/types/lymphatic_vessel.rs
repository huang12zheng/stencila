...
use super::region_drained::regionDrained;
use super::related_condition::relatedCondition;
use super::related_therapy::relatedTherapy;

/// * COMMENT: A type of blood vessel that specifically carries lymph fluid unidirectionally toward the heart. * EXTEND FROM: https://schema.org/Vessel
...
pub struct LymphaticVessel {
    ...
    #[serde(flatten)]
    pub options: Box<LymphaticVesselOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct LymphaticVesselOptions {
    ...
    pub originates_from: Option<LymphaticVessel>,

    /// The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
    pub region_drained: Option<regionDrained>,

    /// The vasculature the lymphatic structure runs, or efferents, to.
    pub runs_to: Option<LymphaticVessel>,
}
