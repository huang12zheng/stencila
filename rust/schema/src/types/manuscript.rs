...
/// * MOD OF: https://pending.schema.org * COMMENT: A book, document, or piece of music written by hand rather than typed or printed. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct Manuscript {
    ...
    #[serde(flatten)]
    pub options: Box<ManuscriptOptions>,
}
