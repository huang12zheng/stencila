...
/// * MOD OF: https://pending.schema.org * COMMENT: A math solver which is capable of solving a subset of mathematical problems. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct MathSolver {
    ...
    #[serde(flatten)]
    pub options: Box<MathSolverOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MathSolverOptions {
    ...
    pub math_expression: Option<MathSolver>,
}
