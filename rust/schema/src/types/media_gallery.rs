...
/// * COMMENT: Web page type: Media gallery page. A mixed-media page that can contain media such as images, videos, and other multimedia. * EXTEND FROM: https://schema.org/CollectionPage * LOOK ALSO: https://schema.org/ImageGallery, https://schema.org/VideoGallery
...
pub struct MediaGallery {
    ...
    #[serde(flatten)]
    pub options: Box<MediaGalleryOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MediaGalleryOptions {
