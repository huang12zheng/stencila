...
/// * COMMENT: A media object, such as an image, video, or audio object embedded in a web page or a downloadable dataset, i.e. DataDownload. Note that a creative work may have many media objects associated with it on the same web page. For example, a page about a single song (MusicRecording) may have a music video (VideoObject), and a high and low bandwidth audio stream (2 <a class="localLink" href="/AudioObject">AudioObject</a>s). * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/3DModel, https://schema.org/AmpStory, https://schema.org/AudioObject, https://schema.org/DataDownload, https://schema.org/ImageObject, https://schema.org/LegislationObject, https://schema.org/MusicVideoObject, https://schema.org/VideoObject
