...
use super::original_media_link::originalMediaLink;
...
pub struct MediaReviewOptions {
    ...
    pub media_authenticity_category: Option<MediaManipulationRatingEnumeration>,
    ...
    pub original_media_context_description: Option<Text>,
    ...
    pub original_media_link: Option<originalMediaLink>,
}
