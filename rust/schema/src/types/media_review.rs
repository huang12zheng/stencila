...
use super::original_media_link_prop_enum::OriginalMediaLinkPropEnum;
...
/// * COMMENT:
/// A <a class="localLink" href="/MediaReview">MediaReview</a> is a more specialized form of Review dedicated to the evaluation of media content online, typically in the context of fact-checking and misinformation.
...
pub struct MediaReview {
    ...
    pub media_authenticity_category_prop_enum: Option<MediaManipulationRatingEnumeration>,
    ...
    pub original_media_context_description_prop_enum: Option<Text>,
    ...
    pub original_media_link_prop_enum: Option<OriginalMediaLinkPropEnum>,
}
