...
pub struct MediaReview {
    ...
    #[serde(flatten)]
    pub options: Box<MediaReviewOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MediaReviewOptions {
    ...
    pub media_authenticity_category: Option<MediaReview>,
    ...
    pub original_media_context_description: Option<MediaReview>,
    ...
    pub original_media_link: Option<MediaReview>,
}
