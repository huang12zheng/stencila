...
/// * MOD OF: https://pending.schema.org * COMMENT: Represents an item or group of closely related items treated as a unit for the sake of evaluation in a <a class="localLink" href="/MediaReview">MediaReview</a>. Authorship etc. apply to the items rather than to the curation/grouping or reviewing party. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct MediaReviewItem {
    ...
    #[serde(flatten)]
    pub options: Box<MediaReviewItemOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MediaReviewItemOptions {
    ...
    pub media_item_appearance: Option<MediaReviewItem>,
}

impl MediaReviewItem {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
