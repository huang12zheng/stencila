...
/// * COMMENT: A particular physical or virtual business of an organization for medical purposes. Examples of MedicalBusiness include different businesses run by health professionals. * EXTEND FROM: https://schema.org/LocalBusiness * LOOK ALSO: https://schema.org/CommunityHealth, https://schema.org/Dentist, https://schema.org/Dermatology, https://schema.org/DietNutrition, https://schema.org/Emergency, https://schema.org/Geriatric, https://schema.org/Gynecologic, https://schema.org/MedicalClinic, https://schema.org/Midwifery, https://schema.org/Nursing, https://schema.org/Obstetric, https://schema.org/Oncologic, https://schema.org/Optician, https://schema.org/Optometric, https://schema.org/Otolaryngologic, https://schema.org/Pediatric, https://schema.org/Pharmacy, https://schema.org/Physician, https://schema.org/Physiotherapy, https://schema.org/PlasticSurgery, https://schema.org/Podiatric, https://schema.org/PrimaryCare, https://schema.org/Psychiatric, https://schema.org/PublicHealth
...
pub struct MedicalBusiness {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalBusinessOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalBusinessOptions {
