...
/// * COMMENT: A facility, often associated with a hospital or medical school, that is devoted to the specific diagnosis and/or healthcare. Previously limited to outpatients but with evolution it may be open to inpatients as well. * EXTEND FROM: https://schema.org/MedicalBusiness, https://schema.org/MedicalOrganization * LOOK ALSO: https://schema.org/CovidTestingFacility
...
pub struct MedicalClinic {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalClinicOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalClinicOptions {
