...
use super::in_code_set_prop_enum::InCodeSetPropEnum;
use super::in_defined_term_set_prop_enum::InDefinedTermSetPropEnum;
...
/// * EXTEND FROM:
/// https://schema.org/CategoryCode, https://schema.org/MedicalIntangible
...
pub struct MedicalCode {
    ...
    pub in_defined_term_set_prop_enum: Option<InDefinedTermSetPropEnum>,
    ...
    pub term_code_prop_enum: Option<Text>,

    /// A short textual code that uniquely identifies the value.
    pub code_value_prop_enum: Option<Text>,

    /// A <a class="localLink" href="/CategoryCodeSet">CategoryCodeSet</a> that contains this category code.
    pub in_code_set_prop_enum: Option<InCodeSetPropEnum>,
    ...
    pub coding_system_prop_enum: Option<Text>,
}
