...
/// * COMMENT: Any condition of the human body that affects the normal functioning of a person, whether physically or mentally. Includes diseases, injuries, disabilities, disorders, syndromes, etc. * EXTEND FROM: https://schema.org/MedicalEntity * LOOK ALSO: https://schema.org/InfectiousDisease, https://schema.org/MedicalSignOrSymptom
...
pub struct MedicalCondition {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalConditionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalConditionOptions {
