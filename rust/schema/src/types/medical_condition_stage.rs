...
/// * COMMENT: A stage of a medical condition, such as 'Stage IIIa'. * EXTEND FROM: https://schema.org/MedicalIntangible
...
pub struct MedicalConditionStage {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalConditionStageOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalConditionStageOptions {
    ...
    pub stage_as_number: Option<MedicalConditionStage>,

    /// The substage, e.g. 'a' for Stage IIIa.
    pub sub_stage_suffix: Option<MedicalConditionStage>,
}

impl MedicalConditionStage {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
