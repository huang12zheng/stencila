...
/// * LOOK ALSO:
/// https://schema.org/MedicalGuidelineContraindication, https://schema.org/MedicalGuidelineRecommendation
...
pub struct MedicalGuideline {
    ...
    pub evidence_level_prop_enum: Option<MedicalEvidenceLevel>,

    /// Source of the data used to formulate the guidance, e.g. RCT, consensus opinion, etc.
    pub evidence_origin_prop_enum: Option<Text>,

    /// Date on which this guideline's recommendation was made.
    pub guideline_date_prop_enum: Option<Date>,

    /// The medical conditions, treatments, etc. that are the subject of the guideline.
    pub guideline_subject_prop_enum: Option<MedicalEntity>,
}
