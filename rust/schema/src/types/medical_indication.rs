...
/// * COMMENT: A condition or factor that indicates use of a medical therapy, including signs, symptoms, risk factors, anatomical states, etc. * EXTEND FROM: https://schema.org/MedicalEntity * LOOK ALSO: https://schema.org/ApprovedIndication, https://schema.org/PreventionIndication, https://schema.org/TreatmentIndication
...
pub struct MedicalIndication {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalIndicationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalIndicationOptions {
