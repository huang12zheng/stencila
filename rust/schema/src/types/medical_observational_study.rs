...
pub struct MedicalObservationalStudy {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalObservationalStudyOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalObservationalStudyOptions {
    ...
    pub study_location: Option<MedicalStudy>,

    /// A subject of the study, i.e. one of the medical conditions, therapies, devices, drugs, etc. investigated by the study.
    pub study_subject: Option<MedicalStudy>,

    /// Specifics about the observational study design (enumerated).
    pub study_design: Option<MedicalObservationalStudy>,
}

impl MedicalObservationalStudy {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
