...
/// * COMMENT: A medical organization (physical or not), such as hospital, institution or clinic. * EXTEND FROM: https://schema.org/Organization * LOOK ALSO: https://schema.org/Dentist, https://schema.org/DiagnosticLab, https://schema.org/Hospital, https://schema.org/MedicalClinic, https://schema.org/Pharmacy, https://schema.org/Physician, https://schema.org/VeterinaryCare
...
pub struct MedicalOrganization {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalOrganizationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalOrganizationOptions {
