...
/// * COMMENT: A process of care used in either a diagnostic, therapeutic, preventive or palliative capacity that relies on invasive (surgical), non-invasive, or other techniques. * EXTEND FROM: https://schema.org/MedicalEntity * LOOK ALSO: https://schema.org/DiagnosticProcedure, https://schema.org/PalliativeProcedure, https://schema.org/PhysicalExam, https://schema.org/SurgicalProcedure, https://schema.org/TherapeuticProcedure
...
pub struct MedicalProcedure {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalProcedureOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalProcedureOptions {
