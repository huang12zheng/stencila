...
/// * LOOK ALSO:
/// https://schema.org/MedicalRiskCalculator, https://schema.org/MedicalRiskScore
...
pub struct MedicalRiskEstimator {
    ...
    pub estimates_risk_of_prop_enum: Option<MedicalEntity>,

    /// A modifiable or non-modifiable risk factor included in the calculation, e.g. age, coexisting condition.
    pub included_risk_factor_prop_enum: Option<MedicalRiskFactor>,
}
