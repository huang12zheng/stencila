...
/// * COMMENT: Any rule set or interactive tool for estimating the risk of developing a complication or condition. * EXTEND FROM: https://schema.org/MedicalEntity * LOOK ALSO: https://schema.org/MedicalRiskCalculator, https://schema.org/MedicalRiskScore
...
pub struct MedicalRiskEstimator {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalRiskEstimatorOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalRiskEstimatorOptions {
    ...
    pub estimates_risk_of: Option<MedicalEntity>,

    /// A modifiable or non-modifiable risk factor included in the calculation, e.g. age, coexisting condition.
    pub included_risk_factor: Option<MedicalRiskFactor>,
}

impl MedicalRiskEstimator {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
