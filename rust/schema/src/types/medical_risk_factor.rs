...
/// * COMMENT: A risk factor is anything that increases a person's likelihood of developing or contracting a disease, medical condition, or complication. * EXTEND FROM: https://schema.org/MedicalEntity
...
pub struct MedicalRiskFactor {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalRiskFactorOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalRiskFactorOptions {
    ...
    pub increases_risk_of: Option<MedicalRiskFactor>,
}

impl MedicalRiskFactor {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
