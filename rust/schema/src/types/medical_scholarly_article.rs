...
/// * COMMENT: A scholarly article in the medical domain. * EXTEND FROM: https://schema.org/ScholarlyArticle
...
pub struct MedicalScholarlyArticle {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalScholarlyArticleOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalScholarlyArticleOptions {
    ...
    pub publication_type: Option<MedicalScholarlyArticle>,
}
