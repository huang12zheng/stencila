...
/// * COMMENT: Any physical manifestation of a person's medical condition discoverable by objective diagnostic tests or physical examination. * EXTEND FROM: https://schema.org/MedicalSignOrSymptom * LOOK ALSO: https://schema.org/VitalSign
...
pub struct MedicalSign {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalSignOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalSignOptions {
    ...
    pub identifying_exam: Option<PhysicalExam>,

    /// A diagnostic test that can identify this sign.
    pub identifying_test: Option<MedicalTest>,
}
