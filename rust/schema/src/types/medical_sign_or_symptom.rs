...
/// * COMMENT: Any feature associated or not with a medical condition. In medicine a symptom is generally subjective while a sign is objective. * EXTEND FROM: https://schema.org/MedicalCondition * LOOK ALSO: https://schema.org/MedicalSign, https://schema.org/MedicalSymptom
...
pub struct MedicalSignOrSymptom {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalSignOrSymptomOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalSignOrSymptomOptions {
