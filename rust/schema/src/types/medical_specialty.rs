...
/// * COMMENT: Any specific branch of medical science or practice. Medical specialities include clinical specialties that pertain to particular organ systems and their respective disease states, as well as allied health specialties. Enumerated type. * EXTEND FROM: https://schema.org/MedicalEnumeration, https://schema.org/Specialty
...
pub struct MedicalSpecialty {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalSpecialtyOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalSpecialtyOptions {
