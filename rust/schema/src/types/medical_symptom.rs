...
/// * COMMENT: Any complaint sensed and expressed by the patient (therefore defined as subjective)  like stomachache, lower-back pain, or fatigue. * EXTEND FROM: https://schema.org/MedicalSignOrSymptom
...
pub struct MedicalSymptom {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalSymptomOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalSymptomOptions {
