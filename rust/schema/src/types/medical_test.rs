...
/// * COMMENT: Any medical test, typically performed for diagnostic purposes. * EXTEND FROM: https://schema.org/MedicalEntity * LOOK ALSO: https://schema.org/BloodTest, https://schema.org/ImagingTest, https://schema.org/MedicalTestPanel, https://schema.org/PathologyTest
...
pub struct MedicalTest {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalTestOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalTestOptions {
