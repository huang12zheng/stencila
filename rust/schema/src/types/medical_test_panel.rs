...
use super::normal_range_prop_enum::NormalRangePropEnum;
...
pub struct MedicalTestPanel {
    ...
    pub affected_by_prop_enum: Option<Drug>,

    /// Range of acceptable values for a typical patient, when applicable.
    pub normal_range_prop_enum: Option<NormalRangePropEnum>,

    /// A sign detected by the test.
    pub sign_detected_prop_enum: Option<MedicalSign>,

    /// A condition the test is used to diagnose.
    pub used_to_diagnose_prop_enum: Option<MedicalCondition>,

    /// Device used to perform the test.
    pub uses_device_prop_enum: Option<MedicalDevice>,

    /// A component test of the panel.
    pub sub_test_prop_enum: Option<MedicalTest>,
}

impl MedicalTestPanel {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
