...
/// * COMMENT: Any collection of tests commonly ordered together. * EXTEND FROM: https://schema.org/MedicalTest
...
pub struct MedicalTestPanel {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalTestPanelOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalTestPanelOptions {
    ...
    pub sub_test: Option<MedicalTestPanel>,
}
