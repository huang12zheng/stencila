...
/// * COMMENT: A web page that provides medical information. * EXTEND FROM: https://schema.org/WebPage
...
pub struct MedicalWebPage {
    ...
    #[serde(flatten)]
    pub options: Box<MedicalWebPageOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MedicalWebPageOptions {
    ...
    pub medical_audience: Option<MedicalWebPage>,
}
