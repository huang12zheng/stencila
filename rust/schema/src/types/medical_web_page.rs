...
use super::breadcrumb_prop_enum::BreadcrumbPropEnum;
...
use super::medical_audience_prop_enum::MedicalAudiencePropEnum;
...
use super::reviewed_by_prop_enum::ReviewedByPropEnum;
...
pub struct MedicalWebPage {
    ...
    pub breadcrumb_prop_enum: Option<BreadcrumbPropEnum>,

    /// Date on which the content on this web page was last reviewed for accuracy and/or completeness.
    pub last_reviewed_prop_enum: Option<Date>,

    /// Indicates if this web page element is the main subject of the page.
    pub main_content_of_page_prop_enum: Option<WebPageElement>,

    /// Indicates the main image on the page.
    pub primary_image_of_page_prop_enum: Option<ImageObject>,

    /// A link related to this web page, for example to other related web pages.
    pub related_link_prop_enum: Option<URL>,

    /// People or organizations that have reviewed the content on this web page for accuracy and/or completeness.
    pub reviewed_by_prop_enum: Option<ReviewedByPropEnum>,

    /// One of the more significant URLs on the page. Typically, these are the non-navigation links that are clicked on the most.
    pub significant_link_prop_enum: Option<URL>,
    ...
    pub specialty_prop_enum: Option<Specialty>,

    /// Medical audience for page.
    pub medical_audience_prop_enum: Option<MedicalAudiencePropEnum>,
}
