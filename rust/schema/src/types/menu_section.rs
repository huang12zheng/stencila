...
use super::has_menu_item::hasMenuItem;
use super::has_menu_section::hasMenuSection;
...
/// * COMMENT: A sub-grouping of food or drink items in a menu. E.g. courses (such as 'Dinner', 'Breakfast', etc.), specific type of dishes (such as 'Meat', 'Vegan', 'Drinks', etc.), or some other classification made by the menu provider. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct MenuSection {
    ...
    #[serde(flatten)]
    pub options: Box<MenuSectionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MenuSectionOptions {
    ...
    pub has_menu_item: Option<hasMenuItem>,

    /// A subgrouping of the menu (by dishes, course, serving time period, etc.).
    pub has_menu_section: Option<hasMenuSection>,
}
