...
/// * COMMENT: A single message from a sender to one or more organizations or people. * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/EmailMessage
...
pub struct MessageOptions {
    ...
    pub bcc_recipient: Option<Message>,

    /// A sub property of recipient. The recipient copied on a message.
    pub cc_recipient: Option<Message>,

    /// The date/time at which the message has been read by the recipient if a single recipient exists.
    pub date_read: Option<Message>,

    /// The date/time the message was received if a single recipient exists.
    pub date_received: Option<Message>,

    /// The date/time at which the message was sent.
    pub date_sent: Option<Message>,

    /// A CreativeWork attached to the message.
    pub message_attachment: Option<Message>,
    ...
    pub to_recipient: Option<Message>,
}
