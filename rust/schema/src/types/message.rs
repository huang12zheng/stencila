...
use super::bcc_recipient::bccRecipient;
use super::cc_recipient::ccRecipient;
...
use super::to_recipient::toRecipient;
...
pub struct MessageOptions {
    ...
    pub bcc_recipient: Option<bccRecipient>,

    /// A sub property of recipient. The recipient copied on a message.
    pub cc_recipient: Option<ccRecipient>,

    /// The date/time at which the message has been read by the recipient if a single recipient exists.
    pub date_read: Option<dateRead>,
    ...
    pub message_attachment: Option<CreativeWork>,
    ...
    pub to_recipient: Option<toRecipient>,
}
