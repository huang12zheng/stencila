...
/// * COMMENT: A software application designed specifically to work well on a mobile device such as a telephone. * EXTEND FROM: https://schema.org/SoftwareApplication
...
pub struct MobileApplication {
    ...
    #[serde(flatten)]
    pub options: Box<MobileApplicationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MobileApplicationOptions {
    ...
    pub carrier_requirements: Option<MobileApplication>,
}
