...
/// * COMMENT: A store that sells mobile phones and related accessories. * EXTEND FROM: https://schema.org/Store
...
pub struct MobilePhoneStore {
    ...
    #[serde(flatten)]
    pub options: Box<MobilePhoneStoreOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MobilePhoneStoreOptions {
