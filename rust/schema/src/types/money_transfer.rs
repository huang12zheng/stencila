...
/// * MOD OF: https://pending.schema.org * COMMENT: The act of transferring money from one place to another place. This may occur electronically or physically. * EXTEND FROM: https://schema.org/TransferAction
...
pub struct MoneyTransfer {
    ...
    #[serde(flatten)]
    pub options: Box<MoneyTransferOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MoneyTransferOptions {
    ...
    pub beneficiary_bank: Option<MoneyTransfer>,
}
