...
/// * MOD OF: https://pending.schema.org * COMMENT: A loan in which property or real estate is used as collateral. (A loan securitized against some real estate.) * EXTEND FROM: https://schema.org/LoanOrCredit
...
pub struct MortgageLoan {
    ...
    #[serde(flatten)]
    pub options: Box<MortgageLoanOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MortgageLoanOptions {
    ...
    pub domiciled_mortgage: Option<Boolean>,

    /// Amount of mortgage mandate that can be converted into a proper mortgage at a later stage.
    pub loan_mortgage_mandate_amount: Option<MonetaryAmount>,
}
