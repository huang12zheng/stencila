...
/// * MOD OF: https://auto.schema.org * COMMENT: A motorcycle or motorbike is a single-track, two-wheeled motor vehicle. * EXTEND FROM: https://schema.org/Vehicle
...
pub struct Motorcycle {
    ...
    #[serde(flatten)]
    pub options: Box<MotorcycleOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MotorcycleOptions {
