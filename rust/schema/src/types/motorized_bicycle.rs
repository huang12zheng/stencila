...
/// * MOD OF: https://auto.schema.org * COMMENT: A motorized bicycle is a bicycle with an attached motor used to power the vehicle, or to assist with pedaling. * EXTEND FROM: https://schema.org/Vehicle
...
pub struct MotorizedBicycle {
    ...
    #[serde(flatten)]
    pub options: Box<MotorizedBicycleOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MotorizedBicycleOptions {
