...
use super::from_location::fromLocation;
use super::location::location;
use super::provider::provider;
use super::start_time::startTime;
use super::to_location::toLocation;

/// * COMMENT: The act of an agent relocating to a place.<br/><br/>  Related actions:<br/><br/>  <ul> <li><a class="localLink" href="/TransferAction">TransferAction</a>: Unlike TransferAction, the subject of the move is a living Person or Organization rather than an inanimate object.</li> </ul> * EXTEND FROM: https://schema.org/Action * LOOK ALSO: https://schema.org/ArriveAction, https://schema.org/DepartAction, https://schema.org/TravelAction
...
pub struct MoveAction {
    ...
    #[serde(flatten)]
    pub options: Box<MoveActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MoveActionOptions {
    ...
    pub from_location: Option<fromLocation>,

    /// A sub property of location. The final location of the object or the agent after the action.
    pub to_location: Option<toLocation>,
}
