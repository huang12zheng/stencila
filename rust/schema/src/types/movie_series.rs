...
/// * COMMENT: A series of movies. Included movies can be indicated with the hasPart property. * EXTEND FROM: https://schema.org/CreativeWorkSeries
...
pub struct MovieSeries {
    ...
    #[serde(flatten)]
    pub options: Box<MovieSeriesOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MovieSeriesOptions {
