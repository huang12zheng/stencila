...
/// * COMMENT: A movie theater. * EXTEND FROM: https://schema.org/CivicStructure, https://schema.org/EntertainmentBusiness
...
pub struct MovieTheater {
    ...
    #[serde(flatten)]
    pub options: Box<MovieTheaterOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MovieTheaterOptions {
    ...
    pub screen_count: Option<MovieTheater>,
}
