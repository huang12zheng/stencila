...
/// * COMMENT: A muscle is an anatomical structure consisting of a contractile form of tissue that animals use to effect movement. * EXTEND FROM: https://schema.org/AnatomicalStructure
...
pub struct MuscleOptions {
    ...
    pub antagonist: Option<Muscle>,

    /// The blood vessel that carries blood from the heart to the muscle.
    pub blood_supply: Option<Muscle>,

    /// The place of attachment of a muscle, or what the muscle moves.
    pub insertion: Option<Muscle>,

    /// The movement the muscle generates.
    pub muscle_action: Option<Muscle>,

    /// The underlying innervation associated with the muscle.
    pub nerve: Option<Muscle>,
}
