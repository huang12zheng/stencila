...
pub struct Muscle {
    ...
    pub antagonist_prop_enum: Option<Muscle>,

    /// The blood vessel that carries blood from the heart to the muscle.
    pub blood_supply_prop_enum: Option<Vessel>,

    /// The place of attachment of a muscle, or what the muscle moves.
    pub insertion_prop_enum: Option<AnatomicalStructure>,

    /// The movement the muscle generates.
    pub muscle_action_prop_enum: Option<Text>,

    /// The underlying innervation associated with the muscle.
    pub nerve_prop_enum: Option<Nerve>,
}
