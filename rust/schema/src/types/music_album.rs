...
use super::by_artist_prop_enum::ByArtistPropEnum;
...
pub struct MusicAlbum {
    ...
    pub album_production_type_prop_enum: Option<MusicAlbumProductionType>,

    /// A release of this album.
    pub album_release_prop_enum: Option<MusicRelease>,

    /// The kind of release which this album is: single, EP or album.
    pub album_release_type_prop_enum: Option<MusicAlbumReleaseType>,

    /// The artist that performed this album or recording.
    pub by_artist_prop_enum: Option<ByArtistPropEnum>,
}
