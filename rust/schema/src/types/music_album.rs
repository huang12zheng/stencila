...
/// * COMMENT: A collection of music tracks. * EXTEND FROM: https://schema.org/MusicPlaylist
...
pub struct MusicAlbum {
    ...
    #[serde(flatten)]
    pub options: Box<MusicAlbumOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MusicAlbumOptions {
    ...
    pub album_production_type: Option<MusicAlbum>,

    /// A release of this album.
    pub album_release: Option<MusicAlbum>,

    /// The kind of release which this album is: single, EP or album.
    pub album_release_type: Option<MusicAlbum>,
