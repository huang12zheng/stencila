...
pub struct MusicComposition {
    ...
    pub first_performance_prop_enum: Option<Event>,

    /// Smaller compositions included in this work (e.g. a movement in a symphony).
    pub included_composition_prop_enum: Option<MusicComposition>,

    /// The International Standard Musical Work Code for the composition.
    pub iswc_code_prop_enum: Option<Text>,

    /// The person who wrote the words.
    pub lyricist_prop_enum: Option<Person>,

    /// The words in the song.
    pub lyrics_prop_enum: Option<CreativeWork>,

    /// An arrangement derived from the composition.
    pub music_arrangement_prop_enum: Option<MusicComposition>,

    /// The type of composition (e.g. overture, sonata, symphony, etc.).
    pub music_composition_form_prop_enum: Option<Text>,

    /// The key, mode, or scale this composition uses.
    pub musical_key_prop_enum: Option<Text>,

    /// An audio recording of the work.
    pub recorded_as_prop_enum: Option<MusicRecording>,
}
