...
/// * COMMENT: A musical composition. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct MusicComposition {
    ...
    #[serde(flatten)]
    pub options: Box<MusicCompositionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MusicCompositionOptions {
    ...
    pub first_performance: Option<MusicComposition>,

    /// Smaller compositions included in this work (e.g. a movement in a symphony).
    pub included_composition: Option<MusicComposition>,

    /// The International Standard Musical Work Code for the composition.
    pub iswc_code: Option<MusicComposition>,

    /// The person who wrote the words.
    pub lyricist: Option<MusicComposition>,

    /// The words in the song.
    pub lyrics: Option<MusicComposition>,

    /// An arrangement derived from the composition.
    pub music_arrangement: Option<MusicComposition>,

    /// The type of composition (e.g. overture, sonata, symphony, etc.).
    pub music_composition_form: Option<MusicComposition>,

    /// The key, mode, or scale this composition uses.
    pub musical_key: Option<MusicComposition>,

    /// An audio recording of the work.
    pub recorded_as: Option<MusicComposition>,
}
