...
/// * COMMENT: A collection of music tracks in playlist form. * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/MusicAlbum, https://schema.org/MusicRelease
...
pub struct MusicPlaylist {
    ...
    #[serde(flatten)]
    pub options: Box<MusicPlaylistOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MusicPlaylistOptions {
