...
/// * COMMENT: A music recording (track), usually a single song. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct MusicRecording {
    ...
    #[serde(flatten)]
    pub options: Box<MusicRecordingOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct MusicRecordingOptions {
    ...
    pub by_artist: Option<byArtist>,

    /// The duration of the item (movie, audio recording, event, etc.) in <a href="http://en.wikipedia.org/wiki/ISO_8601">ISO 8601 date format</a>.
    pub duration: Option<duration>,

    /// The album to which this recording belongs.
    pub in_album: Option<MusicRecording>,

    /// The playlist to which this recording belongs.
    pub in_playlist: Option<MusicRecording>,

    /// The International Standard Recording Code for the recording.
    pub isrc_code: Option<MusicRecording>,

    /// The composition this track is a recording of.
    pub recording_of: Option<MusicRecording>,
}
