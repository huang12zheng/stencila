...
use super::credited_to_prop_enum::CreditedToPropEnum;
use super::date::Date;
...
use super::track_prop_enum::TrackPropEnum;
...
pub struct MusicRelease {
    ...
    pub num_tracks_prop_enum: Option<Integer>,

    /// A music recording (track)&#x2014;usually a single song. If an ItemList is given, the list should contain items of type MusicRecording.
    pub track_prop_enum: Option<TrackPropEnum>,

    /// The catalog number for the release.
    pub catalog_number_prop_enum: Option<Text>,

    /// The group the release is credited to if different than the byArtist. For example, Red and Blue is credited to "Stefani Germanotta Band", but by Lady Gaga.
    pub credited_to_prop_enum: Option<CreditedToPropEnum>,

    /// The duration of the item (movie, audio recording, event, etc.) in <a href="http://en.wikipedia.org/wiki/ISO_8601">ISO 8601 date format</a>.
    pub duration_prop_enum: Option<Duration>,

    /// Format of this release (the type of recording media used, i.e. compact disc, digital media, LP, etc.).
    pub music_release_format_prop_enum: Option<MusicReleaseFormatType>,

    /// The label that issued the release.
    pub record_label_prop_enum: Option<Organization>,

    /// The album this is a release of.
    pub release_of_prop_enum: Option<MusicAlbum>,
}
