...
/// * COMMENT: Neck assessment with clinical examination. * EXTEND FROM: https://schema.org/PhysicalExam * ENUMERATION FROM: https://schema.org/PhysicalExam
