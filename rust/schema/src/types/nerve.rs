...
use super::sensory_unit::sensoryUnit;
use super::subject_of::subjectOf;

/// * COMMENT: A common pathway for the electrochemical nerve impulses that are transmitted along each of the axons. * EXTEND FROM: https://schema.org/AnatomicalStructure
...
pub struct Nerve {
    ...
    #[serde(flatten)]
    pub options: Box<NerveOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct NerveOptions {
    ...
    pub nerve_motor: Option<Muscle>,

    /// The neurological pathway extension that inputs and sends information to the brain or spinal cord.
    pub sensory_unit: Option<sensoryUnit>,

    /// The neurological pathway that originates the neurons.
    pub sourced_from: Option<BrainStructure>,
}
