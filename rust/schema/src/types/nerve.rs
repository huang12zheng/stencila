...
use super::sensory_unit_prop_enum::SensoryUnitPropEnum;
...
pub struct Nerve {
    ...
    pub nerve_motor_prop_enum: Option<Muscle>,

    /// The neurological pathway extension that inputs and sends information to the brain or spinal cord.
    pub sensory_unit_prop_enum: Option<SensoryUnitPropEnum>,

    /// The neurological pathway that originates the neurons.
    pub sourced_from_prop_enum: Option<BrainStructure>,
}
