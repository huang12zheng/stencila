...
use super::mission_coverage_priorities_policy::missionCoveragePrioritiesPolicy;
use super::no_bylines_policy::noBylinesPolicy;
...
use super::verification_fact_checking_policy::verificationFactCheckingPolicy;

/// * MOD OF: https://pending.schema.org * COMMENT: A News/Media organization such as a newspaper or TV station. * EXTEND FROM: https://schema.org/Organization
...
pub struct NewsMediaOrganization {
    ...
    #[serde(flatten)]
    pub options: Box<NewsMediaOrganizationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct NewsMediaOrganizationOptions {
    ...
    pub mission_coverage_priorities_policy: Option<missionCoveragePrioritiesPolicy>,
    ...
    pub no_bylines_policy: Option<noBylinesPolicy>,
    ...
    pub verification_fact_checking_policy: Option<verificationFactCheckingPolicy>,
}

impl NewsMediaOrganization {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
