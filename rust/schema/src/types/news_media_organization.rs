...
use super::masthead_prop_enum::MastheadPropEnum;
...
use super::mission_coverage_priorities_policy_prop_enum::MissionCoveragePrioritiesPolicyPropEnum;
use super::no_bylines_policy_prop_enum::NoBylinesPolicyPropEnum;
...
use super::verification_fact_checking_policy_prop_enum::VerificationFactCheckingPolicyPropEnum;
...
pub struct NewsMediaOrganization {
    ...
    pub masthead_prop_enum: Option<MastheadPropEnum>,
    ...
    pub mission_coverage_priorities_policy_prop_enum: Option<MissionCoveragePrioritiesPolicyPropEnum>,
    ...
    pub no_bylines_policy_prop_enum: Option<NoBylinesPolicyPropEnum>,
    ...
    pub verification_fact_checking_policy_prop_enum: Option<VerificationFactCheckingPolicyPropEnum>,
}
