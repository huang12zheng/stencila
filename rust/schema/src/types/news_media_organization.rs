...
pub struct NewsMediaOrganizationOptions {
    ...
    pub masthead: Option<NewsMediaOrganization>,
    ...
    pub mission_coverage_priorities_policy: Option<NewsMediaOrganization>,
    ...
    pub no_bylines_policy: Option<NewsMediaOrganization>,
    ...
    pub verification_fact_checking_policy: Option<NewsMediaOrganization>,
}
