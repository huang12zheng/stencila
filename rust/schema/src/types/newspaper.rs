...
/// * MOD OF: https://bib.schema.org * COMMENT: A publication containing information about varied topics that are pertinent to general information, a geographic area, or a specific subject matter (i.e. business, culture, education). Often published daily. * EXTEND FROM: https://schema.org/Periodical
...
pub struct Newspaper {
    ...
    #[serde(flatten)]
    pub options: Box<NewspaperOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct NewspaperOptions {
