...
/// * COMMENT: A file containing a note, primarily for the author. * EXTEND FROM: https://schema.org/DigitalDocument
...
pub struct NoteDigitalDocument {
    ...
    #[serde(flatten)]
    pub options: Box<NoteDigitalDocumentOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct NoteDigitalDocumentOptions {
