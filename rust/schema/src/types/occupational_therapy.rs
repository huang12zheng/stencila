...
/// * COMMENT: A treatment of people with physical, emotional, or social problems, using purposeful activity to help them overcome or learn to deal with their problems. * EXTEND FROM: https://schema.org/MedicalTherapy
...
pub struct OccupationalTherapy {
    ...
    #[serde(flatten)]
    pub options: Box<OccupationalTherapyOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct OccupationalTherapyOptions {
