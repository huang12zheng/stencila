...
use super::offered_by::offeredBy;
...
/// * MOD OF: https://pending.schema.org * COMMENT: An <a class="localLink" href="/OfferForPurchase">OfferForPurchase</a> in Schema.org represents an <a class="localLink" href="/Offer">Offer</a> to sell something, i.e. an <a class="localLink" href="/Offer">Offer</a> whose   <a class="localLink" href="/businessFunction">businessFunction</a> is <a href="http://purl.org/goodrelations/v1#Sell.">sell</a>. See <a href="https://en.wikipedia.org/wiki/GoodRelations">Good Relations</a> for   background on the underlying concepts. * EXTEND FROM: https://schema.org/Offer
...
pub struct OfferForPurchase {
    ...
    #[serde(flatten)]
    pub options: Box<OfferForPurchaseOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct OfferForPurchaseOptions {
    ...
    pub checkout_page_url_template: Option<Text>,
    ...
    pub offered_by: Option<offeredBy>,
    ...
    pub price_valid_until: Option<Date>,
    ...
    pub shipping_details: Option<OfferShippingDetails>,
