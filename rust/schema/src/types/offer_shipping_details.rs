...
pub struct OfferShippingDetails {
    ...
    pub delivery_time_prop_enum: Option<ShippingDeliveryTime>,
    ...
    pub shipping_origin_prop_enum: Option<DefinedRegion>,
    ...
    pub shipping_settings_link_prop_enum: Option<URL>,
    ...
    pub transit_time_label_prop_enum: Option<Text>,
