...
/// * COMMENT: A publication event, e.g. catch-up TV or radio podcast, during which a program is available on-demand. * EXTEND FROM: https://schema.org/PublicationEvent
...
pub struct OnDemandEvent {
    ...
    #[serde(flatten)]
    pub options: Box<OnDemandEventOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct OnDemandEventOptions {
