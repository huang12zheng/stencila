...
/// * MOD OF: https://pending.schema.org * COMMENT: An eCommerce site. * EXTEND FROM: https://schema.org/OnlineBusiness
...
pub struct OnlineStore {
    ...
    #[serde(flatten)]
    pub options: Box<OnlineStoreOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct OnlineStoreOptions {
