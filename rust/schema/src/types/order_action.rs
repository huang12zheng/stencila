...
/// * COMMENT: An agent orders an object/product/service to be delivered/sent. * EXTEND FROM: https://schema.org/TradeAction
...
pub struct OrderAction {
    ...
    #[serde(flatten)]
    pub options: Box<OrderActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct OrderActionOptions {
