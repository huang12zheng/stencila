...
/// * COMMENT: The act of manipulating/administering/supervising/controlling one or more objects. * EXTEND FROM: https://schema.org/Action * LOOK ALSO: https://schema.org/AllocateAction, https://schema.org/ApplyAction, https://schema.org/BookmarkAction, https://schema.org/PlanAction
...
pub struct OrganizeAction {
    ...
    #[serde(flatten)]
    pub options: Box<OrganizeActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct OrganizeActionOptions {
