...
/// * COMMENT: The act of producing a painting, typically with paint and canvas as instruments. * EXTEND FROM: https://schema.org/CreateAction
...
pub struct PaintAction {
    ...
    #[serde(flatten)]
    pub options: Box<PaintActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PaintActionOptions {
