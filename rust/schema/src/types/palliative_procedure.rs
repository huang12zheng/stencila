...
/// * COMMENT: A medical procedure intended primarily for palliative purposes, aimed at relieving the symptoms of an underlying health condition. * EXTEND FROM: https://schema.org/MedicalProcedure, https://schema.org/MedicalTherapy
...
pub struct PalliativeProcedure {
    ...
    #[serde(flatten)]
    pub options: Box<PalliativeProcedureOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PalliativeProcedureOptions {
