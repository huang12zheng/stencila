...
/// * COMMENT: A set of characteristics describing parents, who can be interested in viewing some content. * EXTEND FROM: https://schema.org/PeopleAudience
...
pub struct ParentAudience {
    ...
    #[serde(flatten)]
    pub options: Box<ParentAudienceOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ParentAudienceOptions {
    ...
    pub child_max_age: Option<ParentAudience>,

    /// Minimal age of the child.
    pub child_min_age: Option<ParentAudience>,
}
