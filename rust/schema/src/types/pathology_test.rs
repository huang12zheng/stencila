...
/// * COMMENT: A medical test performed by a laboratory that typically involves examination of a tissue sample by a pathologist. * EXTEND FROM: https://schema.org/MedicalTest
...
pub struct PathologyTest {
    ...
    #[serde(flatten)]
    pub options: Box<PathologyTestOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PathologyTestOptions {
    ...
    pub tissue_sample: Option<PathologyTest>,
}
