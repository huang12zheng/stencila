...
/// * COMMENT: A shop that will buy, or lend money against the security of, personal possessions. * EXTEND FROM: https://schema.org/Store
...
pub struct PawnShop {
    ...
    #[serde(flatten)]
    pub options: Box<PawnShopOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PawnShopOptions {
