...
/// * COMMENT: A Service to transfer funds from a person or organization to a beneficiary person or organization. * EXTEND FROM: https://schema.org/FinancialProduct
...
pub struct PaymentService {
    ...
    #[serde(flatten)]
    pub options: Box<PaymentServiceOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PaymentServiceOptions {
