...
/// * COMMENT: The act of participating in performance arts. * EXTEND FROM: https://schema.org/PlayAction
...
pub struct PerformAction {
    ...
    #[serde(flatten)]
    pub options: Box<PerformActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PerformActionOptions {
    ...
    pub entertainment_business: Option<EntertainmentBusiness>,
}
