...
/// * COMMENT: A theater or other performing art center. * EXTEND FROM: https://schema.org/CivicStructure
...
pub struct PerformingArtsTheater {
    ...
    #[serde(flatten)]
    pub options: Box<PerformingArtsTheaterOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PerformingArtsTheaterOptions {
