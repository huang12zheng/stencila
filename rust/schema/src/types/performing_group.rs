...
/// * COMMENT: A performance group, such as a band, an orchestra, or a circus. * EXTEND FROM: https://schema.org/Organization * LOOK ALSO: https://schema.org/DanceGroup, https://schema.org/MusicGroup, https://schema.org/TheaterGroup
...
pub struct PerformingGroup {
    ...
    #[serde(flatten)]
    pub options: Box<PerformingGroupOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PerformingGroupOptions {
