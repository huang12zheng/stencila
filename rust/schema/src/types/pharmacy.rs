...
/// * COMMENT: A pharmacy or drugstore. * EXTEND FROM: https://schema.org/MedicalBusiness, https://schema.org/MedicalOrganization
...
pub struct Pharmacy {
    ...
    #[serde(flatten)]
    pub options: Box<PharmacyOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PharmacyOptions {
