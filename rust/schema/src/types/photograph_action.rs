...
/// * COMMENT: The act of capturing still images of objects using a camera. * EXTEND FROM: https://schema.org/CreateAction
...
pub struct PhotographAction {
    ...
    #[serde(flatten)]
    pub options: Box<PhotographActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PhotographActionOptions {
