...
/// * COMMENT: A type of physical examination of a patient performed by a physician. * EXTEND FROM: https://schema.org/MedicalEnumeration, https://schema.org/MedicalProcedure
...
pub struct PhysicalExam {
    ...
    #[serde(flatten)]
    pub options: Box<PhysicalExamOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PhysicalExamOptions {
