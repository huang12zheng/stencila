...
/// * COMMENT: A process of progressive physical care and rehabilitation aimed at improving a health condition. * EXTEND FROM: https://schema.org/MedicalTherapy
...
pub struct PhysicalTherapy {
    ...
    #[serde(flatten)]
    pub options: Box<PhysicalTherapyOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PhysicalTherapyOptions {
