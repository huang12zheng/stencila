...
/// * COMMENT: A doctor's office. * EXTEND FROM: https://schema.org/MedicalBusiness, https://schema.org/MedicalOrganization
...
pub struct Physician {
    ...
    #[serde(flatten)]
    pub options: Box<PhysicianOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PhysicianOptions {
    ...
    pub hospital_affiliation: Option<Physician>,
}
