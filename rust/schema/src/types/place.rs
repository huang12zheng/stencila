...
/// * COMMENT: Entities that have a somewhat fixed, physical extension. * EXTEND FROM: https://schema.org/Thing * LOOK ALSO: https://schema.org/Accommodation, https://schema.org/AdministrativeArea, https://schema.org/CivicStructure, https://schema.org/Landform, https://schema.org/LandmarksOrHistoricalBuildings, https://schema.org/LocalBusiness, https://schema.org/Residence, https://schema.org/TouristAttraction, https://schema.org/TouristDestination
