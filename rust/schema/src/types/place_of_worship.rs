...
/// * COMMENT: Place of worship, such as a church, synagogue, or mosque. * EXTEND FROM: https://schema.org/CivicStructure * LOOK ALSO: https://schema.org/BuddhistTemple, https://schema.org/Church, https://schema.org/HinduTemple, https://schema.org/Mosque, https://schema.org/Synagogue
...
pub struct PlaceOfWorship {
    ...
    #[serde(flatten)]
    pub options: Box<PlaceOfWorshipOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PlaceOfWorshipOptions {
