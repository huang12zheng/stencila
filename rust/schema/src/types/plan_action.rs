...
/// * COMMENT: The act of planning the execution of an event/task/action/reservation/plan to a future date. * EXTEND FROM: https://schema.org/OrganizeAction * LOOK ALSO: https://schema.org/CancelAction, https://schema.org/ReserveAction, https://schema.org/ScheduleAction
...
pub struct PlanAction {
    ...
    #[serde(flatten)]
    pub options: Box<PlanActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PlanActionOptions {
