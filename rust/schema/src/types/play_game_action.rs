...
use super::game_availability_type::gameAvailabilityType;
...
/// * MOD OF: https://pending.schema.org * COMMENT: The act of playing a video game. * EXTEND FROM: https://schema.org/ConsumeAction
...
pub struct PlayGameAction {
    ...
    #[serde(flatten)]
    pub options: Box<PlayGameActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PlayGameActionOptions {
    ...
    pub game_availability_type: Option<gameAvailabilityType>,
}
