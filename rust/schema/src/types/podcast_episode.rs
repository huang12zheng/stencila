...
/// * MOD OF: https://pending.schema.org * COMMENT: A single episode of a podcast series. * EXTEND FROM: https://schema.org/Episode
...
pub struct PodcastEpisode {
    ...
    #[serde(flatten)]
    pub options: Box<PodcastEpisodeOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PodcastEpisodeOptions {
