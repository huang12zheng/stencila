...
/// * MOD OF: https://pending.schema.org * COMMENT: A single season of a podcast. Many podcasts do not break down into separate seasons. In that case, PodcastSeries should be used. * EXTEND FROM: https://schema.org/CreativeWorkSeason
...
pub struct PodcastSeason {
    ...
    #[serde(flatten)]
    pub options: Box<PodcastSeasonOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PodcastSeasonOptions {
