...
/// * MOD OF: https://pending.schema.org * COMMENT: A podcast is an episodic series of digital audio or video files which a user can download and listen to. * EXTEND FROM: https://schema.org/CreativeWorkSeries
...
pub struct PodcastSeries {
    ...
    #[serde(flatten)]
    pub options: Box<PodcastSeriesOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PodcastSeriesOptions {
