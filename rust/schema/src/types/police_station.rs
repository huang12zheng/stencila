...
/// * COMMENT: A police station. * EXTEND FROM: https://schema.org/CivicStructure, https://schema.org/EmergencyService
...
pub struct PoliceStation {
    ...
    #[serde(flatten)]
    pub options: Box<PoliceStationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PoliceStationOptions {
