...
/// * MOD OF: https://pending.schema.org * COMMENT: A large, usually printed placard, bill, or announcement, often illustrated, that is posted to advertise or publicize something. * EXTEND FROM: https://schema.org/CreativeWork
