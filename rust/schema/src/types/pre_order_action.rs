...
/// * COMMENT: An agent orders a (not yet released) object/product/service to be delivered/sent. * EXTEND FROM: https://schema.org/TradeAction
...
pub struct PreOrderAction {
    ...
    #[serde(flatten)]
    pub options: Box<PreOrderActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PreOrderActionOptions {
