...
/// * COMMENT: The act of inserting at the beginning if an ordered collection. * EXTEND FROM: https://schema.org/InsertAction
...
pub struct PrependAction {
    ...
    #[serde(flatten)]
    pub options: Box<PrependActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PrependActionOptions {
