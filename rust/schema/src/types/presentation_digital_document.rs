...
/// * COMMENT: A file containing slides or used for a presentation. * EXTEND FROM: https://schema.org/DigitalDocument
...
pub struct PresentationDigitalDocument {
    ...
    #[serde(flatten)]
    pub options: Box<PresentationDigitalDocumentOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PresentationDigitalDocumentOptions {
...
impl PresentationDigitalDocument {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
