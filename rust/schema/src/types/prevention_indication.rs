...
/// * COMMENT: An indication for preventing an underlying condition, symptom, etc. * EXTEND FROM: https://schema.org/MedicalIndication
...
pub struct PreventionIndication {
    ...
    #[serde(flatten)]
    pub options: Box<PreventionIndicationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PreventionIndicationOptions {
