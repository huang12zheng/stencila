...
/// * COMMENT: A structured value representing a price or price range. Typically, only the subclasses of this type are used for markup. It is recommended to use <a class="localLink" href="/MonetaryAmount">MonetaryAmount</a> to describe independent amounts of money such as a salary, credit card limits, etc. * EXTEND FROM: https://schema.org/StructuredValue * LOOK ALSO: https://schema.org/CompoundPriceSpecification, https://schema.org/DeliveryChargeSpecification, https://schema.org/PaymentChargeSpecification, https://schema.org/UnitPriceSpecification
...
pub struct PriceSpecification {
    ...
    #[serde(flatten)]
    pub options: Box<PriceSpecificationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PriceSpecificationOptions {
