...
/// * COMMENT: A datasheet or vendor specification of a product (in the sense of a prototypical description). * EXTEND FROM: https://schema.org/Product
...
pub struct ProductModel {
    ...
    #[serde(flatten)]
    pub options: Box<ProductModelOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ProductModelOptions {
    ...
    pub predecessor_of: Option<ProductModel>,

    /// A pointer from a newer variant of a product  to its previous, often discontinued predecessor.
    pub successor_of: Option<ProductModel>,
}
