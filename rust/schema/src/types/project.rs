...
/// * MOD OF: https://pending.schema.org * COMMENT: An enterprise (potentially individual but typically collaborative), planned to achieve a particular aim. Use properties from <a class="localLink" href="/Organization">Organization</a>, <a class="localLink" href="/subOrganization">subOrganization</a>/<a class="localLink" href="/parentOrganization">parentOrganization</a> to indicate project sub-structures. * EXTEND FROM: https://schema.org/Organization * LOOK ALSO: https://schema.org/FundingAgency, https://schema.org/ResearchProject
...
pub struct Project {
    ...
    #[serde(flatten)]
    pub options: Box<ProjectOptions>,
}
