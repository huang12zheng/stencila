...
/// * COMMENT: A process of care relying upon counseling, dialogue and communication  aimed at improving a mental health condition without use of drugs. * EXTEND FROM: https://schema.org/TherapeuticProcedure
...
pub struct PsychologicalTreatment {
    ...
    #[serde(flatten)]
    pub options: Box<PsychologicalTreatmentOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PsychologicalTreatmentOptions {
