...
/// * MOD OF: https://pending.schema.org * COMMENT: A public toilet is a room or small building containing one or more toilets (and possibly also urinals) which is available for use by the general public, or by customers or employees of certain businesses. * EXTEND FROM: https://schema.org/CivicStructure
...
pub struct PublicToilet {
    ...
    #[serde(flatten)]
    pub options: Box<PublicToiletOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct PublicToiletOptions {
