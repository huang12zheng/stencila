...
/// * COMMENT: A part of a successively published publication such as a periodical or multi-volume work, often numbered. It may represent a time span, such as a year.<br/><br/>  See also <a href="http://blog.schema.org/2014/09/schemaorg-support-for-bibliographic_2.html">blog post</a>. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct PublicationVolumeOptions {
    ...
    pub volume_number: Option<PublicationVolume>,
}
