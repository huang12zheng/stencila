...
/// * COMMENT: A QAPage is a WebPage focussed on a specific Question and its Answer(s), e.g. in a question answering site or documenting Frequently Asked Questions (FAQs). * EXTEND FROM: https://schema.org/WebPage
...
pub struct QAPage {
    ...
    #[serde(flatten)]
    pub options: Box<QAPageOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct QAPageOptions {
