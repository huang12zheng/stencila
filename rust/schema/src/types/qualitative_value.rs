...
/// * COMMENT: A predefined value for a product characteristic, e.g. the power cord plug type 'US' or the garment sizes 'S', 'M', 'L', and 'XL'. * EXTEND FROM: https://schema.org/Enumeration * LOOK ALSO: https://schema.org/BedType, https://schema.org/DriveWheelConfigurationValue, https://schema.org/SizeSpecification, https://schema.org/SteeringPositionValue
...
pub struct QualitativeValue {
    ...
    #[serde(flatten)]
    pub options: Box<QualitativeValueOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct QualitativeValueOptions {
