...
/// * COMMENT: A point value or interval for product characteristics and other purposes. * EXTEND FROM: https://schema.org/StructuredValue
...
pub struct QuantitativeValue {
    ...
    #[serde(flatten)]
    pub options: Box<QuantitativeValueOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct QuantitativeValueOptions {
