...
/// * MOD OF: https://pending.schema.org * COMMENT: Quiz: A test of knowledge, skills and abilities. * EXTEND FROM: https://schema.org/LearningResource
