...
/// * COMMENT: A process of care using radiation aimed at improving a health condition. * EXTEND FROM: https://schema.org/MedicalTherapy
...
pub struct RadiationTherapy {
    ...
    #[serde(flatten)]
    pub options: Box<RadiationTherapyOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct RadiationTherapyOptions {
