...
/// * COMMENT: A short radio program or a segment/part of a radio program. * EXTEND FROM: https://schema.org/Clip
...
pub struct RadioClip {
    ...
    #[serde(flatten)]
    pub options: Box<RadioClipOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct RadioClipOptions {
