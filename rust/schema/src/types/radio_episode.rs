...
/// * COMMENT: A radio episode which can be part of a series or season. * EXTEND FROM: https://schema.org/Episode
...
pub struct RadioEpisode {
    ...
    #[serde(flatten)]
    pub options: Box<RadioEpisodeOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct RadioEpisodeOptions {
