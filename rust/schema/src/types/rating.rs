...
/// * COMMENT: A rating is an evaluation on a numeric scale, such as 1 to 5 stars. * EXTEND FROM: https://schema.org/Intangible * LOOK ALSO: https://schema.org/AggregateRating, https://schema.org/EndorsementRating
