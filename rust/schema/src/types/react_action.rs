...
/// * COMMENT: The act of responding instinctively and emotionally to an object, expressing a sentiment. * EXTEND FROM: https://schema.org/AssessAction * LOOK ALSO: https://schema.org/AgreeAction, https://schema.org/DisagreeAction, https://schema.org/DislikeAction, https://schema.org/EndorseAction, https://schema.org/LikeAction, https://schema.org/WantAction
...
pub struct ReactAction {
    ...
    #[serde(flatten)]
    pub options: Box<ReactActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ReactActionOptions {
