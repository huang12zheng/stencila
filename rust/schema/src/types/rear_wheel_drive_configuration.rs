...
/// * COMMENT: Real-wheel drive is a transmission layout where the engine drives the rear wheels. * EXTEND FROM: https://schema.org/DriveWheelConfigurationValue * ENUMERATION FROM: https://schema.org/DriveWheelConfigurationValue
#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct RearWheelDriveConfiguration {
    

    /// Non-core optional fields
    #[serde(flatten)]
    pub options: Box<RearWheelDriveConfigurationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct RearWheelDriveConfigurationOptions {
...
impl RearWheelDriveConfiguration {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
