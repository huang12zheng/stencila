...
use super::estimated_cost_prop_enum::EstimatedCostPropEnum;
...
use super::recipe_instructions_prop_enum::RecipeInstructionsPropEnum;
use super::recipe_yield_prop_enum::RecipeYieldPropEnum;
...
use super::step_prop_enum::StepPropEnum;
use super::subject_of_prop_enum::SubjectOfPropEnum;
use super::supply_prop_enum::SupplyPropEnum;
...
use super::tool_prop_enum::ToolPropEnum;
...
use super::yield_prop_enum::YieldPropEnum;
...
pub struct Recipe {
    ...
    pub estimated_cost_prop_enum: Option<EstimatedCostPropEnum>,
    ...
    pub perform_time_prop_enum: Option<Duration>,
    ...
    pub prep_time_prop_enum: Option<Duration>,

    /// A single step item (as HowToStep, text, document, video, etc.) or a HowToSection.
    pub step_prop_enum: Option<StepPropEnum>,

    /// A sub-property of instrument. A supply consumed when performing instructions or a direction.
    pub supply_prop_enum: Option<SupplyPropEnum>,

    /// A sub property of instrument. An object used (but not consumed) when performing instructions or a direction.
    pub tool_prop_enum: Option<ToolPropEnum>,
    ...
    pub total_time_prop_enum: Option<Duration>,

    /// The quantity that results by performing instructions. For example, a paper airplane, 10 personalized candles.
    pub yield_prop_enum: Option<YieldPropEnum>,

    /// The time it takes to actually cook the dish, in <a href="http://en.wikipedia.org/wiki/ISO_8601">ISO 8601 duration format</a>.
    pub cook_time_prop_enum: Option<Duration>,

    /// The method of cooking, such as Frying, Steaming, ...
    pub cooking_method_prop_enum: Option<Text>,

    /// Nutrition information about the recipe or menu item.
    pub nutrition_prop_enum: Option<NutritionInformation>,

    /// The category of the recipe—for example, appetizer, entree, etc.
    pub recipe_category_prop_enum: Option<Text>,

    /// The cuisine of the recipe (for example, French or Ethiopian).
    pub recipe_cuisine_prop_enum: Option<Text>,

    /// A single ingredient used in the recipe, e.g. sugar, flour or garlic.
    pub recipe_ingredient_prop_enum: Option<Text>,

    /// A step in making the recipe, in the form of a single item (document, video, etc.) or an ordered list with HowToStep and/or HowToSection items.
    pub recipe_instructions_prop_enum: Option<RecipeInstructionsPropEnum>,

    /// The quantity produced by the recipe (for example, number of people served, number of servings, etc).
    pub recipe_yield_prop_enum: Option<RecipeYieldPropEnum>,

    /// Indicates a dietary restriction or guideline for which this recipe or menu item is suitable, e.g. diabetic, halal etc.
    pub suitable_for_diet_prop_enum: Option<RestrictedDiet>,
}
