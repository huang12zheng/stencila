...
/// * COMMENT: The act of rejecting to/adopting an object.<br/><br/>  Related actions:<br/><br/>  <ul> <li><a class="localLink" href="/AcceptAction">AcceptAction</a>: The antonym of RejectAction.</li> </ul> * EXTEND FROM: https://schema.org/AllocateAction
...
pub struct RejectAction {
    ...
    #[serde(flatten)]
    pub options: Box<RejectActionOptions>,
}
