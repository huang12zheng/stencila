...
/// * COMMENT: The act of editing a recipient by replacing an old object with a new object. * EXTEND FROM: https://schema.org/UpdateAction
...
pub struct ReplaceAction {
    ...
    #[serde(flatten)]
    pub options: Box<ReplaceActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ReplaceActionOptions {
    ...
    pub replacee: Option<ReplaceAction>,

    /// A sub property of object. The object that replaces.
    pub replacer: Option<ReplaceAction>,
}
