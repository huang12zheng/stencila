...
/// * COMMENT: A patient-reported or observed dosing schedule for a drug or supplement. * EXTEND FROM: https://schema.org/DoseSchedule
...
pub struct ReportedDoseSchedule {
    ...
    #[serde(flatten)]
    pub options: Box<ReportedDoseScheduleOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ReportedDoseScheduleOptions {
