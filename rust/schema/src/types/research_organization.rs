...
/// * MOD OF: https://pending.schema.org * COMMENT: A Research Organization (e.g. scientific institute, research company). * EXTEND FROM: https://schema.org/Organization
...
pub struct ResearchOrganization {
    ...
    #[serde(flatten)]
    pub options: Box<ResearchOrganizationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ResearchOrganizationOptions {
