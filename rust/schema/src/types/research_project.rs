...
/// * MOD OF: https://pending.schema.org * COMMENT: A Research project. * EXTEND FROM: https://schema.org/Project
...
pub struct ResearchProject {
    ...
    #[serde(flatten)]
    pub options: Box<ResearchProjectOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ResearchProjectOptions {
