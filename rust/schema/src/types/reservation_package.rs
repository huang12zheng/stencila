...
/// * COMMENT: A group of multiple reservations with common values for all sub-reservations. * EXTEND FROM: https://schema.org/Reservation
...
pub struct ReservationPackage {
    ...
    #[serde(flatten)]
    pub options: Box<ReservationPackageOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ReservationPackageOptions {
    ...
    pub sub_reservation: Option<ReservationPackage>,
}

impl ReservationPackage {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
