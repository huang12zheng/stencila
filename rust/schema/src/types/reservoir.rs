...
/// * COMMENT: A reservoir of water, typically an artificially created lake, like the Lake Kariba reservoir. * EXTEND FROM: https://schema.org/BodyOfWater
...
pub struct Reservoir {
    ...
    #[serde(flatten)]
    pub options: Box<ReservoirOptions>,
}
