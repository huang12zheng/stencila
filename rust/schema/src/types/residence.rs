...
/// * COMMENT: The place where a person lives. * EXTEND FROM: https://schema.org/Place * LOOK ALSO: https://schema.org/ApartmentComplex, https://schema.org/GatedResidenceCommunity
...
pub struct Residence {
    ...
    #[serde(flatten)]
    pub options: Box<ResidenceOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ResidenceOptions {
