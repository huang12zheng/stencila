...
/// * COMMENT: The act of resuming a device or application which was formerly paused (e.g. resume music playback or resume a timer). * EXTEND FROM: https://schema.org/ControlAction
...
pub struct ResumeAction {
    ...
    #[serde(flatten)]
    pub options: Box<ResumeActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ResumeActionOptions {
