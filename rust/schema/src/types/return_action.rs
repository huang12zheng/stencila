...
/// * COMMENT: The act of returning to the origin that which was previously received (concrete objects) or taken (ownership). * EXTEND FROM: https://schema.org/TransferAction
...
pub struct ReturnAction {
    ...
    #[serde(flatten)]
    pub options: Box<ReturnActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ReturnActionOptions {
