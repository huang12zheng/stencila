...
/// * COMMENT: A review of an item - for example, of a restaurant, movie, or store. * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/ClaimReview, https://schema.org/CriticReview, https://schema.org/EmployerReview, https://schema.org/MediaReview, https://schema.org/Recommendation, https://schema.org/UserReview
