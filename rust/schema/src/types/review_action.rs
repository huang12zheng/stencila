...
/// * COMMENT: The act of producing a balanced opinion about the object for an audience. An agent reviews an object with participants resulting in a review. * EXTEND FROM: https://schema.org/AssessAction
...
pub struct ReviewAction {
    ...
    #[serde(flatten)]
    pub options: Box<ReviewActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ReviewActionOptions {
    ...
    pub result_review: Option<ReviewAction>,
}
