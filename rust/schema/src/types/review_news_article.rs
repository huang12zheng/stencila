...
use super::page_end::pageEnd;
use super::page_start::pageStart;
...
use super::size::size;
use super::speakable::speakable;
use super::sponsor::sponsor;
use super::teaches::teaches;
use super::translator::translator;
use super::typical_age_range::typicalAgeRange;

/// * MOD OF: https://pending.schema.org * COMMENT: A <a class="localLink" href="/NewsArticle">NewsArticle</a> and <a class="localLink" href="/CriticReview">CriticReview</a> providing a professional critic's assessment of a service, product, performance, or artistic or literary work. * EXTEND FROM: https://schema.org/CriticReview, https://schema.org/NewsArticle
...
pub struct ReviewNewsArticle {
    ...
    #[serde(flatten)]
    pub options: Box<ReviewNewsArticleOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ReviewNewsArticleOptions {
    ...
    pub review_rating: Option<Review>,

    /// The actual body of the article.
    pub article_body: Option<Article>,

    /// Articles may belong to one or more 'sections' in a magazine or newspaper, such as Sports, Lifestyle, etc.
    pub article_section: Option<Article>,
    ...
    pub speakable: Option<speakable>,

    /// The number of words in the text of the Article.
    pub word_count: Option<Article>,

    /// A <a href="https://en.wikipedia.org/wiki/Dateline">dateline</a> is a brief piece of text included in news articles that describes where and when the story was written or filed though the date is often omitted. Sometimes only a placename is provided.<br/><br/>  Structured representations of dateline-related information can also be expressed more explicitly using <a class="localLink" href="/locationCreated">locationCreated</a> (which represents where a work was created, e.g. where a news report was written).  For location depicted or described in the content, use <a class="localLink" href="/contentLocation">contentLocation</a>.<br/><br/>  Dateline summaries are oriented more towards human readers than towards automated processing, and can vary substantially. Some examples: "BEIRUT, Lebanon, June 2.", "Paris, France", "December 19, 2017 11:43AM Reporting from Washington", "Beijing/Moscow", "QUEZON CITY, Philippines".
    pub dateline: Option<NewsArticle>,

    /// The number of the column in which the NewsArticle appears in the print edition.
    pub print_column: Option<NewsArticle>,

    /// The edition of the print product in which the NewsArticle appears.
    pub print_edition: Option<NewsArticle>,

    /// If this NewsArticle appears in print, this field indicates the name of the page on which the article is found. Please note that this field is intended for the exact page name (e.g. A5, B18).
    pub print_page: Option<NewsArticle>,

    /// If this NewsArticle appears in print, this field indicates the print section in which the article appeared.
    pub print_section: Option<NewsArticle>,
}

impl ReviewNewsArticle {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
