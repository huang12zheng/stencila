...
/// * EXTEND FROM:
/// https://schema.org/CriticReview, https://schema.org/NewsArticle
...
pub struct ReviewNewsArticle {
    ...
    pub associated_claim_review_prop_enum: Option<Review>,

    /// An associated <a class="localLink" href="/MediaReview">MediaReview</a>, related by specific common content, topic or claim. The expectation is that this property would be most typically used in cases where a single activity is conducting both claim reviews and media reviews, in which case <a class="localLink" href="/relatedMediaReview">relatedMediaReview</a> would commonly be used on a <a class="localLink" href="/ClaimReview">ClaimReview</a>, while <a class="localLink" href="/relatedClaimReview">relatedClaimReview</a> would be used on <a class="localLink" href="/MediaReview">MediaReview</a>.
    pub associated_media_review_prop_enum: Option<Review>,

    /// An associated <a class="localLink" href="/Review">Review</a>.
    pub associated_review_prop_enum: Option<Review>,

    /// The item that is being reviewed/rated.
    pub item_reviewed_prop_enum: Option<Thing>,
    ...
    pub review_body_prop_enum: Option<Text>,
    ...
    pub review_rating_prop_enum: Option<Rating>,
    ...
    pub dateline_prop_enum: Option<Text>,

    /// The number of the column in which the NewsArticle appears in the print edition.
    pub print_column_prop_enum: Option<Text>,

    /// The edition of the print product in which the NewsArticle appears.
    pub print_edition_prop_enum: Option<Text>,

    /// If this NewsArticle appears in print, this field indicates the name of the page on which the article is found. Please note that this field is intended for the exact page name (e.g. A5, B18).
    pub print_page_prop_enum: Option<Text>,

    /// If this NewsArticle appears in print, this field indicates the print section in which the article appeared.
    pub print_section_prop_enum: Option<Text>,
}
