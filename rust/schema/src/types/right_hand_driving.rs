...
/// * COMMENT: The steering position is on the right side of the vehicle (viewed from the main direction of driving). * EXTEND FROM: https://schema.org/SteeringPositionValue * ENUMERATION FROM: https://schema.org/SteeringPositionValue
#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct RightHandDriving {
    

    /// Non-core optional fields
    #[serde(flatten)]
    pub options: Box<RightHandDrivingOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct RightHandDrivingOptions {
