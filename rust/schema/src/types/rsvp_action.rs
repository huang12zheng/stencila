...
/// * COMMENT: The act of notifying an event organizer as to whether you expect to attend the event. * EXTEND FROM: https://schema.org/InformAction
...
pub struct RsvpAction {
    ...
    #[serde(flatten)]
    pub options: Box<RsvpActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct RsvpActionOptions {
    ...
    pub additional_number_of_guests: Option<Number>,

    /// Comments, typically from users.
    pub comment: Option<Comment>,

    /// The response (yes, no, maybe) to the RSVP.
    pub rsvp_response: Option<RsvpResponseType>,
}
