...
/// * COMMENT: A scholarly article. * EXTEND FROM: https://schema.org/Article * LOOK ALSO: https://schema.org/MedicalScholarlyArticle
...
pub struct ScholarlyArticle {
    ...
    #[serde(flatten)]
    pub options: Box<ScholarlyArticleOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ScholarlyArticleOptions {
