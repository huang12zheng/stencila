...
/// * MOD OF: https://pending.schema.org * COMMENT: A School District is an administrative area for the administration of schools. * EXTEND FROM: https://schema.org/AdministrativeArea
...
pub struct SchoolDistrict {
    ...
    #[serde(flatten)]
    pub options: Box<SchoolDistrictOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct SchoolDistrictOptions {
