...
/// * COMMENT: A screening of a movie or other video. * EXTEND FROM: https://schema.org/Event
...
pub struct ScreeningEvent {
    ...
    #[serde(flatten)]
    pub options: Box<ScreeningEventOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ScreeningEventOptions {
    ...
    pub work_presented: Option<ScreeningEvent>,
}
