...
/// * MOD OF: https://pending.schema.org * COMMENT: A Search and Rescue organization of some kind. * EXTEND FROM: https://schema.org/Organization
...
pub struct SearchRescueOrganization {
    ...
    #[serde(flatten)]
    pub options: Box<SearchRescueOrganizationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct SearchRescueOrganizationOptions {
