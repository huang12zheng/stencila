...
/// * COMMENT: A service provided by an organization, e.g. delivery service, print services, etc. * EXTEND FROM: https://schema.org/Intangible * LOOK ALSO: https://schema.org/BroadcastService, https://schema.org/CableOrSatelliteService, https://schema.org/FinancialProduct, https://schema.org/FoodService, https://schema.org/GovernmentService, https://schema.org/Taxi, https://schema.org/TaxiService, https://schema.org/WebAPI
...
pub struct Service {
    ...
    #[serde(flatten)]
    pub options: Box<ServiceOptions>,
}
