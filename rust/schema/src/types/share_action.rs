...
/// * COMMENT: The act of distributing content to people for their amusement or edification. * EXTEND FROM: https://schema.org/CommunicateAction
...
pub struct ShareAction {
    ...
    #[serde(flatten)]
    pub options: Box<ShareActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ShareActionOptions {
