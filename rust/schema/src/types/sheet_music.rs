...
/// * MOD OF: https://pending.schema.org * COMMENT: Printed music, as opposed to performed or recorded music. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct SheetMusic {
    ...
    #[serde(flatten)]
    pub options: Box<SheetMusicOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct SheetMusicOptions {
