...
/// * MOD OF: https://pending.schema.org * COMMENT: Short story or tale. A brief work of literature, usually written in narrative prose. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct ShortStory {
    ...
    #[serde(flatten)]
    pub options: Box<ShortStoryOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ShortStoryOptions {
