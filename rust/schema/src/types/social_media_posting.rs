...
/// * COMMENT: A post to a social media platform, including blog posts, tweets, Facebook posts, etc. * EXTEND FROM: https://schema.org/Article * LOOK ALSO: https://schema.org/BlogPosting, https://schema.org/DiscussionForumPosting
...
pub struct SocialMediaPosting {
    ...
    #[serde(flatten)]
    pub options: Box<SocialMediaPostingOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct SocialMediaPostingOptions {
