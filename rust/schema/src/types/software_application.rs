...
/// * COMMENT: A software application. * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/MobileApplication, https://schema.org/VideoGame, https://schema.org/WebApplication
