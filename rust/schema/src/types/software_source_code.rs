...
/// * COMMENT: Computer programming source code. Example: Full (compile ready) solutions, code snippet samples, scripts, templates. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct SoftwareSourceCodeOptions {
    ...
    pub code_repository: Option<SoftwareSourceCode>,

    /// What type of code sample: full (compile ready) solution, code snippet, inline code, scripts, template.
    pub code_sample_type: Option<SoftwareSourceCode>,

    /// The computer programming language.
    pub programming_language: Option<SoftwareSourceCode>,

    /// Runtime platform or script interpreter dependencies (example: Java v1, Python 2.3, .NET Framework 3.0).
    pub runtime_platform: Option<SoftwareSourceCode>,

    /// Target Operating System / Product to which the code applies.  If applies to several versions, just the product name can be used.
    pub target_product: Option<SoftwareSourceCode>,
}
