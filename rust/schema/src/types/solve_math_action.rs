...
/// * MOD OF: https://pending.schema.org * COMMENT: The action that takes in a math expression and directs users to a page potentially capable of solving/simplifying that expression. * EXTEND FROM: https://schema.org/Action
...
pub struct SolveMathAction {
    ...
    #[serde(flatten)]
    pub options: Box<SolveMathActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct SolveMathActionOptions {
