...
/// * COMMENT: A placeholder for multiple similar products of the same kind. * EXTEND FROM: https://schema.org/Product
...
pub struct SomeProducts {
    ...
    #[serde(flatten)]
    pub options: Box<SomeProductsOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct SomeProductsOptions {
