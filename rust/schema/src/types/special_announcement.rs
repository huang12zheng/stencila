...
use super::announcement_location_prop_enum::AnnouncementLocationPropEnum;
...
use super::disease_prevention_info_prop_enum::DiseasePreventionInfoPropEnum;
use super::disease_spread_statistics_prop_enum::DiseaseSpreadStatisticsPropEnum;
...
use super::getting_tested_info_prop_enum::GettingTestedInfoPropEnum;
...
use super::news_updates_and_guidelines_prop_enum::NewsUpdatesAndGuidelinesPropEnum;
...
use super::public_transport_closures_info_prop_enum::PublicTransportClosuresInfoPropEnum;
...
use super::quarantine_guidelines_prop_enum::QuarantineGuidelinesPropEnum;
use super::review::Review;
use super::schema_version_prop_enum::SchemaVersionPropEnum;
use super::school_closures_info_prop_enum::SchoolClosuresInfoPropEnum;
...
use super::travel_bans_prop_enum::TravelBansPropEnum;
use super::url::URL;
...
use super::web_feed_prop_enum::WebFeedPropEnum;
...
pub struct SpecialAnnouncement {
    ...
    pub announcement_location_prop_enum: Option<AnnouncementLocationPropEnum>,
    ...
    pub disease_prevention_info_prop_enum: Option<DiseasePreventionInfoPropEnum>,
    ...
    pub disease_spread_statistics_prop_enum: Option<DiseaseSpreadStatisticsPropEnum>,
    ...
    pub getting_tested_info_prop_enum: Option<GettingTestedInfoPropEnum>,

    /// governmentBenefitsInfo provides information about government benefits associated with a SpecialAnnouncement.
    pub government_benefits_info_prop_enum: Option<GovernmentService>,
    ...
    pub news_updates_and_guidelines_prop_enum: Option<NewsUpdatesAndGuidelinesPropEnum>,

    /// Information about public transport closures.
    pub public_transport_closures_info_prop_enum: Option<PublicTransportClosuresInfoPropEnum>,

    /// Guidelines about quarantine rules, e.g. in the context of a pandemic.
    pub quarantine_guidelines_prop_enum: Option<QuarantineGuidelinesPropEnum>,

    /// Information about school closures.
    pub school_closures_info_prop_enum: Option<SchoolClosuresInfoPropEnum>,

    /// Information about travel bans, e.g. in the context of a pandemic.
    pub travel_bans_prop_enum: Option<TravelBansPropEnum>,

    /// The URL for a feed, e.g. associated with a podcast series, blog, or series of date-stamped updates. This is usually RSS or Atom.
    pub web_feed_prop_enum: Option<WebFeedPropEnum>,
}
