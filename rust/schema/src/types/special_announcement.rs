...
pub struct SpecialAnnouncement {
    ...
    #[serde(flatten)]
    pub options: Box<SpecialAnnouncementOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct SpecialAnnouncementOptions {
    ...
    pub announcement_location: Option<SpecialAnnouncement>,
    ...
    pub disease_prevention_info: Option<SpecialAnnouncement>,
    ...
    pub disease_spread_statistics: Option<SpecialAnnouncement>,
    ...
    pub getting_tested_info: Option<SpecialAnnouncement>,

    /// governmentBenefitsInfo provides information about government benefits associated with a SpecialAnnouncement.
    pub government_benefits_info: Option<SpecialAnnouncement>,
    ...
    pub news_updates_and_guidelines: Option<SpecialAnnouncement>,

    /// Information about public transport closures.
    pub public_transport_closures_info: Option<SpecialAnnouncement>,

    /// Guidelines about quarantine rules, e.g. in the context of a pandemic.
    pub quarantine_guidelines: Option<SpecialAnnouncement>,

    /// Information about school closures.
    pub school_closures_info: Option<SpecialAnnouncement>,

    /// Information about travel bans, e.g. in the context of a pandemic.
    pub travel_bans: Option<SpecialAnnouncement>,

    /// The URL for a feed, e.g. associated with a podcast series, blog, or series of date-stamped updates. This is usually RSS or Atom.
    pub web_feed: Option<webFeed>,
}

impl SpecialAnnouncement {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
