...
/// * COMMENT: A sports location, such as a playing field. * EXTEND FROM: https://schema.org/LocalBusiness * LOOK ALSO: https://schema.org/BowlingAlley, https://schema.org/ExerciseGym, https://schema.org/GolfCourse, https://schema.org/HealthClub, https://schema.org/PublicSwimmingPool, https://schema.org/SkiResort, https://schema.org/SportsClub, https://schema.org/StadiumOrArena, https://schema.org/TennisComplex
...
pub struct SportsActivityLocation {
    ...
    #[serde(flatten)]
    pub options: Box<SportsActivityLocationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct SportsActivityLocationOptions {
