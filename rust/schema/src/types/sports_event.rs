...
/// * COMMENT: Event type: Sports event. * EXTEND FROM: https://schema.org/Event
...
pub struct SportsEvent {
    ...
    #[serde(flatten)]
    pub options: Box<SportsEventOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct SportsEventOptions {
    ...
    pub away_team: Option<awayTeam>,

    /// A competitor in a sports event.
    pub competitor: Option<competitor>,

    /// The home team in a sports event.
    pub home_team: Option<homeTeam>,
