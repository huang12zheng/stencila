...
use super::away_team_prop_enum::AwayTeamPropEnum;
use super::boolean::Boolean;
use super::competitor_prop_enum::CompetitorPropEnum;
...
use super::home_team_prop_enum::HomeTeamPropEnum;
...
use super::sport_prop_enum::SportPropEnum;
...
pub struct SportsEvent {
    ...
    pub away_team_prop_enum: Option<AwayTeamPropEnum>,

    /// A competitor in a sports event.
    pub competitor_prop_enum: Option<CompetitorPropEnum>,

    /// The home team in a sports event.
    pub home_team_prop_enum: Option<HomeTeamPropEnum>,

    /// A type of sport (e.g. Baseball).
    pub sport_prop_enum: Option<SportPropEnum>,
}
