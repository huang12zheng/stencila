...
/// * COMMENT: Represents the collection of all sports organizations, including sports teams, governing bodies, and sports associations. * EXTEND FROM: https://schema.org/Organization * LOOK ALSO: https://schema.org/SportsTeam
...
pub struct SportsOrganization {
    ...
    #[serde(flatten)]
    pub options: Box<SportsOrganizationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct SportsOrganizationOptions {
