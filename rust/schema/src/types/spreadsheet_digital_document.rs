...
/// * COMMENT: A spreadsheet file. * EXTEND FROM: https://schema.org/DigitalDocument
...
pub struct SpreadsheetDigitalDocument {
    ...
    #[serde(flatten)]
    pub options: Box<SpreadsheetDigitalDocumentOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct SpreadsheetDigitalDocumentOptions {
...
impl SpreadsheetDigitalDocument {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
