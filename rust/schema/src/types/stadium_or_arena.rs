...
/// * COMMENT: A stadium. * EXTEND FROM: https://schema.org/CivicStructure, https://schema.org/SportsActivityLocation
...
pub struct StadiumOrArena {
    ...
    #[serde(flatten)]
    pub options: Box<StadiumOrArenaOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct StadiumOrArenaOptions {
