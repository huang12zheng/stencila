...
pub struct StatisticalPopulationOptions {
    ...
    pub constraining_property: Option<StatisticalPopulation>,
    ...
    pub num_constraints: Option<StatisticalPopulation>,
    ...
    pub population_type: Option<StatisticalPopulation>,
}
