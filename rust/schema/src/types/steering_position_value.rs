...
/// * COMMENT: A value indicating a steering position. * EXTEND FROM: https://schema.org/QualitativeValue
...
pub struct SteeringPositionValue {
    ...
    #[serde(flatten)]
    pub options: Box<SteeringPositionValueOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct SteeringPositionValueOptions {
