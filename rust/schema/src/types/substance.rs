...
/// * COMMENT: Any matter of defined composition that has discrete existence, whose origin may be biological, mineral or chemical. * EXTEND FROM: https://schema.org/MedicalEntity * LOOK ALSO: https://schema.org/DietarySupplement, https://schema.org/Drug
...
pub struct Substance {
    ...
    #[serde(flatten)]
    pub options: Box<SubstanceOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct SubstanceOptions {
