...
use super::related_anatomy_prop_enum::RelatedAnatomyPropEnum;
...
pub struct SuperficialAnatomy {
    ...
    pub related_anatomy_prop_enum: Option<RelatedAnatomyPropEnum>,
    ...
    pub significance_prop_enum: Option<Text>,
}
