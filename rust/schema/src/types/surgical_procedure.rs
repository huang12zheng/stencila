...
/// * COMMENT: A medical procedure involving an incision with instruments; performed for diagnose, or therapeutic purposes. * EXTEND FROM: https://schema.org/MedicalProcedure
...
pub struct SurgicalProcedure {
    ...
    #[serde(flatten)]
    pub options: Box<SurgicalProcedureOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct SurgicalProcedureOptions {
