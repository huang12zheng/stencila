...
/// * COMMENT: The act of momentarily pausing a device or application (e.g. pause music playback or pause a timer). * EXTEND FROM: https://schema.org/ControlAction
...
pub struct SuspendAction {
    ...
    #[serde(flatten)]
    pub options: Box<SuspendActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct SuspendActionOptions {
