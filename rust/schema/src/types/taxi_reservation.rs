...
use super::party_size_prop_enum::PartySizePropEnum;
...
pub struct TaxiReservation {
    ...
    pub party_size_prop_enum: Option<PartySizePropEnum>,

    /// Where a taxi will pick up a passenger or a rental car can be picked up.
    pub pickup_location_prop_enum: Option<Place>,

    /// When a taxi will pick up a passenger or a rental car can be picked up.
    pub pickup_time_prop_enum: Option<DateTime>,
}
