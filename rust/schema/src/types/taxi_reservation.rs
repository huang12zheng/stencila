...
/// * COMMENT: A reservation for a taxi.<br/><br/>  Note: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations. For offers of tickets, use <a class="localLink" href="/Offer">Offer</a>. * EXTEND FROM: https://schema.org/Reservation
...
pub struct TaxiReservation {
    ...
    #[serde(flatten)]
    pub options: Box<TaxiReservationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TaxiReservationOptions {
    ...
    pub pickup_time: Option<DateTime>,
}

impl TaxiReservation {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
