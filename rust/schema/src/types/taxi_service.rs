...
/// * COMMENT: A service for a vehicle for hire with a driver for local travel. Fares are usually calculated based on distance traveled. * EXTEND FROM: https://schema.org/Service
...
pub struct TaxiService {
    ...
    #[serde(flatten)]
    pub options: Box<TaxiServiceOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TaxiServiceOptions {
