...
/// * COMMENT: A technical article - Example: How-to (task) topics, step-by-step, procedural troubleshooting, specifications, etc. * EXTEND FROM: https://schema.org/Article * LOOK ALSO: https://schema.org/APIReference
...
pub struct TechArticle {
    ...
    #[serde(flatten)]
    pub options: Box<TechArticleOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TechArticleOptions {
