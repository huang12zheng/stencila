...
/// * COMMENT: A theater group or company, for example, the Royal Shakespeare Company or Druid Theatre. * EXTEND FROM: https://schema.org/PerformingGroup
...
pub struct TheaterGroup {
    ...
    #[serde(flatten)]
    pub options: Box<TheaterGroupOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TheaterGroupOptions {
