...
/// * COMMENT: A medical procedure intended primarily for therapeutic purposes, aimed at improving a health condition. * EXTEND FROM: https://schema.org/MedicalProcedure * LOOK ALSO: https://schema.org/MedicalTherapy, https://schema.org/PsychologicalTreatment
...
pub struct TherapeuticProcedure {
    ...
    #[serde(flatten)]
    pub options: Box<TherapeuticProcedureOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TherapeuticProcedureOptions {
