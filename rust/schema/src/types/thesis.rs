...
/// * MOD OF: https://bib.schema.org * COMMENT: A thesis or dissertation document submitted in support of candidature for an academic degree or professional qualification. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct Thesis {
    ...
    #[serde(flatten)]
    pub options: Box<ThesisOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct ThesisOptions {
    ...
    pub in_support_of: Option<Thesis>,
}
