...
use super::date_issued_prop_enum::DateIssuedPropEnum;
...
use super::text::Text;
use super::ticket_token_prop_enum::TicketTokenPropEnum;
...
pub struct Ticket {
    ...
    pub date_issued_prop_enum: Option<DateIssuedPropEnum>,

    /// The organization issuing the ticket or permit.
    pub issued_by_prop_enum: Option<Organization>,
    ...
    pub ticket_number_prop_enum: Option<Text>,

    /// Reference to an asset (e.g., Barcode, QR code image or PDF) usable for entrance.
    pub ticket_token_prop_enum: Option<TicketTokenPropEnum>,

    /// The seat associated with the ticket.
    pub ticketed_seat_prop_enum: Option<Seat>,
