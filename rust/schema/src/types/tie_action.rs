...
/// * COMMENT: The act of reaching a draw in a competitive activity. * EXTEND FROM: https://schema.org/AchieveAction
...
pub struct TieAction {
    ...
    #[serde(flatten)]
    pub options: Box<TieActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TieActionOptions {
