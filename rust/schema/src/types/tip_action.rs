...
/// * COMMENT: The act of giving money voluntarily to a beneficiary in recognition of services rendered. * EXTEND FROM: https://schema.org/TradeAction
...
pub struct TipAction {
    ...
    #[serde(flatten)]
    pub options: Box<TipActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TipActionOptions {
