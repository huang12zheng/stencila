...
use super::tourist_type_prop_enum::TouristTypePropEnum;
use super::url::URL;
...
pub struct TouristDestination {
    ...
    pub includes_attraction_prop_enum: Option<TouristAttraction>,

    /// Attraction suitable for type(s) of tourist. E.g. children, visitors from a particular country, etc.
    pub tourist_type_prop_enum: Option<TouristTypePropEnum>,
}
