...
/// * COMMENT: A tourist information center. * EXTEND FROM: https://schema.org/LocalBusiness
...
pub struct TouristInformationCenter {
    ...
    #[serde(flatten)]
    pub options: Box<TouristInformationCenterOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TouristInformationCenterOptions {
