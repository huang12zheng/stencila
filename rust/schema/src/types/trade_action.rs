...
/// * COMMENT: The act of participating in an exchange of goods and services for monetary compensation. An agent trades an object, product or service with a participant in exchange for a one time or periodic payment. * EXTEND FROM: https://schema.org/Action * LOOK ALSO: https://schema.org/BuyAction, https://schema.org/DonateAction, https://schema.org/OrderAction, https://schema.org/PayAction, https://schema.org/PreOrderAction, https://schema.org/QuoteAction, https://schema.org/RentAction, https://schema.org/SellAction, https://schema.org/TipAction
...
pub struct TradeAction {
    ...
    #[serde(flatten)]
    pub options: Box<TradeActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TradeActionOptions {
