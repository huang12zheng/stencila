...
pub struct TrainTripOptions {
    ...
    pub arrival_platform: Option<Text>,

    /// The station where the train trip ends.
    pub arrival_station: Option<TrainStation>,

    /// The platform from which the train departs.
    pub departure_platform: Option<Text>,

    /// The station from which the train departs.
    pub departure_station: Option<TrainStation>,

    /// The name of the train (e.g. The Orient Express).
    pub train_name: Option<Text>,

    /// The unique identifier for the train.
    pub train_number: Option<Text>,
}
