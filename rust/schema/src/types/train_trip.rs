...
/// * COMMENT: A trip on a commercial train line. * EXTEND FROM: https://schema.org/Trip
...
pub struct TrainTrip {
    ...
    #[serde(flatten)]
    pub options: Box<TrainTripOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TrainTripOptions {
    ...
    pub arrival_platform: Option<TrainTrip>,

    /// The station where the train trip ends.
    pub arrival_station: Option<TrainTrip>,

    /// The platform from which the train departs.
    pub departure_platform: Option<TrainTrip>,

    /// The station from which the train departs.
    pub departure_station: Option<TrainTrip>,

    /// The name of the train (e.g. The Orient Express).
    pub train_name: Option<TrainTrip>,

    /// The unique identifier for the train.
    pub train_number: Option<TrainTrip>,
}
