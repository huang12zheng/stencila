...
pub struct TrainTrip {
    ...
    pub arrival_platform_prop_enum: Option<Text>,

    /// The station where the train trip ends.
    pub arrival_station_prop_enum: Option<TrainStation>,

    /// The platform from which the train departs.
    pub departure_platform_prop_enum: Option<Text>,

    /// The station from which the train departs.
    pub departure_station_prop_enum: Option<TrainStation>,

    /// The name of the train (e.g. The Orient Express).
    pub train_name_prop_enum: Option<Text>,

    /// The unique identifier for the train.
    pub train_number_prop_enum: Option<Text>,
}
