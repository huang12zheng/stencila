...
/// * COMMENT: The act of transferring/moving (abstract or concrete) animate or inanimate objects from one place to another. * EXTEND FROM: https://schema.org/Action * LOOK ALSO: https://schema.org/BorrowAction, https://schema.org/DownloadAction, https://schema.org/GiveAction, https://schema.org/LendAction, https://schema.org/MoneyTransfer, https://schema.org/ReceiveAction, https://schema.org/ReturnAction, https://schema.org/SendAction, https://schema.org/TakeAction
...
pub struct TransferAction {
    ...
    #[serde(flatten)]
    pub options: Box<TransferActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TransferActionOptions {
