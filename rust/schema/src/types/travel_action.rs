...
/// * COMMENT: The act of traveling from a fromLocation to a destination by a specified mode of transport, optionally with participants. * EXTEND FROM: https://schema.org/MoveAction
...
pub struct TravelAction {
    ...
    #[serde(flatten)]
    pub options: Box<TravelActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TravelActionOptions {
