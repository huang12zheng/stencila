...
/// * COMMENT: An indication for treating an underlying condition, symptom, etc. * EXTEND FROM: https://schema.org/MedicalIndication
...
pub struct TreatmentIndication {
    ...
    #[serde(flatten)]
    pub options: Box<TreatmentIndicationOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TreatmentIndicationOptions {
