...
use super::part_of_season::partOfSeason;
...
use super::subtitle_language::subtitleLanguage;
use super::teaches::teaches;
use super::title_eidr::titleEIDR;
use super::trailer::trailer;
use super::translator::translator;
use super::typical_age_range::typicalAgeRange;

/// * COMMENT: A TV episode which can be part of a series or season. * EXTEND FROM: https://schema.org/Episode
...
pub struct TVEpisode {
    ...
    #[serde(flatten)]
    pub options: Box<TVEpisodeOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TVEpisodeOptions {
    ...
    pub episode_number: Option<Episode>,

    /// The composer of the soundtrack.
    pub music_by: Option<musicBy>,

    /// The season to which this episode belongs.
    pub part_of_season: Option<partOfSeason>,
    ...
    pub title_eidr: Option<titleEIDR>,
}
