...
/// * COMMENT: Season dedicated to TV broadcast and associated online delivery. * EXTEND FROM: https://schema.org/CreativeWork, https://schema.org/CreativeWorkSeason
...
pub struct TVSeason {
    ...
    #[serde(flatten)]
    pub options: Box<TVSeasonOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TVSeasonOptions {
