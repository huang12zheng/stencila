...
/// * COMMENT: CreativeWorkSeries dedicated to TV broadcast and associated online delivery. * EXTEND FROM: https://schema.org/CreativeWork, https://schema.org/CreativeWorkSeries
...
pub struct TVSeries {
    ...
    #[serde(flatten)]
    pub options: Box<TVSeriesOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TVSeriesOptions {
