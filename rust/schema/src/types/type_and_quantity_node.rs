...
/// * COMMENT: A structured value indicating the quantity, unit of measurement, and business function of goods included in a bundle offer. * EXTEND FROM: https://schema.org/StructuredValue
...
pub struct TypeAndQuantityNode {
    ...
    #[serde(flatten)]
    pub options: Box<TypeAndQuantityNodeOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct TypeAndQuantityNodeOptions {
    ...
    pub amount_of_this_good: Option<TypeAndQuantityNode>,
