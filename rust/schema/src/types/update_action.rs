...
/// * COMMENT: The act of managing by changing/editing the state of the object. * EXTEND FROM: https://schema.org/Action * LOOK ALSO: https://schema.org/AddAction, https://schema.org/DeleteAction, https://schema.org/ReplaceAction
...
pub struct UpdateAction {
    ...
    #[serde(flatten)]
    pub options: Box<UpdateActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct UpdateActionOptions {
