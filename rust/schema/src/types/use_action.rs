...
/// * COMMENT: The act of applying an object to its intended purpose. * EXTEND FROM: https://schema.org/ConsumeAction * LOOK ALSO: https://schema.org/WearAction
...
pub struct UseAction {
    ...
    #[serde(flatten)]
    pub options: Box<UseActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct UseActionOptions {
