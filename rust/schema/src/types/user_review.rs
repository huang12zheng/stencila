...
/// * MOD OF: https://pending.schema.org * COMMENT: A review created by an end-user (e.g. consumer, purchaser, attendee etc.), in contrast with <a class="localLink" href="/CriticReview">CriticReview</a>. * EXTEND FROM: https://schema.org/Review
...
pub struct UserReview {
    ...
    #[serde(flatten)]
    pub options: Box<UserReviewOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct UserReviewOptions {
