...
use super::contains_season::containsSeason;
...
use super::number_of_episodes::numberOfEpisodes;
use super::number_of_players::numberOfPlayers;
use super::number_of_seasons::numberOfSeasons;
...
/// * COMMENT: A video game series. * EXTEND FROM: https://schema.org/CreativeWorkSeries
...
pub struct VideoGameSeries {
    ...
    #[serde(flatten)]
    pub options: Box<VideoGameSeriesOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct VideoGameSeriesOptions {
    ...
    pub contains_season: Option<containsSeason>,
    ...
    pub number_of_episodes: Option<numberOfEpisodes>,

    /// Indicate how many people can play this game (minimum, maximum, or range).
    pub number_of_players: Option<numberOfPlayers>,

    /// The number of seasons in this series.
    pub number_of_seasons: Option<numberOfSeasons>,
