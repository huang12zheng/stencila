...
pub struct VideoGameSeries {
    ...
    pub issn_prop_enum: Option<Text>,
    ...
    pub contains_season_prop_enum: Option<CreativeWorkSeason>,

    /// A director of e.g. TV, radio, movie, video gaming etc. content, or of an event. Directors can be associated with individual items or with a series, episode, clip.
    pub director_prop_enum: Option<Person>,

    /// An episode of a TV, radio or game media within a series or season.
    pub episode_prop_enum: Option<Episode>,
    ...
    pub number_of_episodes_prop_enum: Option<Integer>,

    /// Indicate how many people can play this game (minimum, maximum, or range).
    pub number_of_players_prop_enum: Option<QuantitativeValue>,

    /// The number of seasons in this series.
    pub number_of_seasons_prop_enum: Option<Integer>,
