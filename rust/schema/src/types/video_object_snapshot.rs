...
use super::embedded_text_caption::embeddedTextCaption;
...
/// * MOD OF: https://pending.schema.org * COMMENT: A specific and exact (byte-for-byte) version of a <a class="localLink" href="/VideoObject">VideoObject</a>. Two byte-for-byte identical files, for the purposes of this type, considered identical. If they have different embedded metadata the files will differ. Different external facts about the files, e.g. creator or dateCreated that aren't represented in their actual content, do not affect this notion of identity. * EXTEND FROM: https://schema.org/VideoObject
...
pub struct VideoObjectSnapshot {
    ...
    #[serde(flatten)]
    pub options: Box<VideoObjectSnapshotOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct VideoObjectSnapshotOptions {
    ...
    pub embedded_text_caption: Option<embeddedTextCaption>,
    ...
    pub video_frame_size: Option<VideoObject>,

    /// The quality of the video.
    pub video_quality: Option<VideoObject>,
}

impl VideoObjectSnapshot {
    pub fn new() -> Self {
        Self {
            ..Default::default()
        }
