...
/// * COMMENT: A work of art that is primarily visual in character. * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/CoverArt
...
pub struct VisualArtwork {
    ...
    #[serde(flatten)]
    pub options: Box<VisualArtworkOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct VisualArtworkOptions {
