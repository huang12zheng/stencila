...
/// * COMMENT: The act of expressing a preference from a fixed/finite/structured set of choices/options. * EXTEND FROM: https://schema.org/ChooseAction
...
pub struct VoteAction {
    ...
    #[serde(flatten)]
    pub options: Box<VoteActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct VoteActionOptions {
