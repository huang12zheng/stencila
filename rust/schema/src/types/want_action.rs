...
/// * COMMENT: The act of expressing a desire about the object. An agent wants an object. * EXTEND FROM: https://schema.org/ReactAction
...
pub struct WantAction {
    ...
    #[serde(flatten)]
    pub options: Box<WantActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct WantActionOptions {
