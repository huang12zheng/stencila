...
/// * COMMENT: The act of consuming dynamic/moving visual content. * EXTEND FROM: https://schema.org/ConsumeAction
...
pub struct WatchAction {
    ...
    #[serde(flatten)]
    pub options: Box<WatchActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct WatchActionOptions {
