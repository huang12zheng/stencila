...
/// * MOD OF: https://pending.schema.org * COMMENT: An application programming interface accessible over Web/Internet technologies. * EXTEND FROM: https://schema.org/Service
...
pub struct WebAPIOptions {
    ...
    pub documentation: Option<WebAPI>,
}
