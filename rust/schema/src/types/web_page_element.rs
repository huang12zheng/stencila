...
/// * LOOK ALSO:
/// https://schema.org/SiteNavigationElement, https://schema.org/Table, https://schema.org/WPAdBlock, https://schema.org/WPFooter, https://schema.org/WPHeader, https://schema.org/WPSideBar
...
pub struct WebPageElement {
    ...
    pub css_selector_prop_enum: Option<CssSelectorType>,
    ...
    pub xpath_prop_enum: Option<XPathType>,
}
