...
/// * COMMENT: A web page element, like a table or an image. * EXTEND FROM: https://schema.org/CreativeWork * LOOK ALSO: https://schema.org/SiteNavigationElement, https://schema.org/Table, https://schema.org/WPAdBlock, https://schema.org/WPFooter, https://schema.org/WPHeader, https://schema.org/WPSideBar
...
pub struct WebPageElement {
    ...
    #[serde(flatten)]
    pub options: Box<WebPageElementOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct WebPageElementOptions {
