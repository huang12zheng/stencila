...
/// * COMMENT: A WebSite is a set of related web pages and other items typically served from a single web domain and accessible via URLs. * EXTEND FROM: https://schema.org/CreativeWork
...
pub struct WebSite {
    ...
    #[serde(flatten)]
    pub options: Box<WebSiteOptions>,
}
