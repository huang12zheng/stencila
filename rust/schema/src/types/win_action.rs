...
/// * COMMENT: The act of achieving victory in a competitive activity. * EXTEND FROM: https://schema.org/AchieveAction
...
pub struct WinAction {
    ...
    #[serde(flatten)]
    pub options: Box<WinActionOptions>,
}

#[skip_serializing_none]
#[derive(Debug, Defaults, Clone, PartialEq, Serialize, Deserialize, Strip, Read, Write, ToHtml)]
#[serde(rename_all = "camelCase", crate = "common::serde")]
pub struct WinActionOptions {
